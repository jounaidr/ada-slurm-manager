...
T = TypeVar("T", bound="SlurmV0041PostJobSubmitResponse200Result")


@_attrs_define
class SlurmV0041PostJobSubmitResponse200Result:
    """Job submission
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_submit_response_200_result = cls(
            job_id=job_id,
            step_id=step_id,
        ...
        slurm_v0041_post_job_submit_response_200_result.additional_properties = d
        return slurm_v0041_post_job_submit_response_200_result
