...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiInstancesResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiInstancesResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiInstancesResp.from_dict(response.json())
...
def sync(
    *,
    ...
    time_end: str | Unset = UNSET,
    time_start: str | Unset = UNSET,
) -> V0042OpenapiInstancesResp | None:
    """Get instance info
