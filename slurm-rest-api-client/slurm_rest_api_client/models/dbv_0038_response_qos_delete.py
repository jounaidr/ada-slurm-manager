...
T = TypeVar("T", bound="Dbv0038ResponseQosDelete")
...
class Dbv0038ResponseQosDelete:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_response_qos_delete = cls(
            meta=meta,
            errors=errors,
        )

        dbv_0038_response_qos_delete.additional_properties = d
        return dbv_0038_response_qos_delete
