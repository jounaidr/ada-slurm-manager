...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespQosItemLimitsFactor")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespQosItemLimitsFactor:
    """LimitFactor
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_qos_item_limits_factor = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_qos_item_limits_factor.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_qos_item_limits_factor
