...
T = TypeVar("T", bound="SlurmV0041GetLicensesResponseDefaultLastUpdate")


@_attrs_define
class SlurmV0041GetLicensesResponseDefaultLastUpdate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_licenses_response_default_last_update = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_get_licenses_response_default_last_update.additional_properties = d
        return slurm_v0041_get_licenses_response_default_last_update
