...
if TYPE_CHECKING:
    from ..models.v0044_kill_jobs_resp_job import V0044KillJobsRespJob
...
T = TypeVar("T", bound="V0044OpenapiKillJobsResp")


@_attrs_define
class V0044OpenapiKillJobsResp:
    """
    Attributes:
        status (list[V0044KillJobsRespJob]): List of jobs signal responses
        meta (V0044OpenapiMeta | Unset):
        errors (list[V0044OpenapiError] | Unset):
        warnings (list[V0044OpenapiWarning] | Unset):
    """

    status: list[V0044KillJobsRespJob]
    ...
    def to_dict(self) -> dict[str, Any]:
        status = []
        for componentsschemasv0_0_44_kill_jobs_resp_msg_item_data in self.status:
            componentsschemasv0_0_44_kill_jobs_resp_msg_item = (
                componentsschemasv0_0_44_kill_jobs_resp_msg_item_data.to_dict()
            )
            status.append(componentsschemasv0_0_44_kill_jobs_resp_msg_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_44_kill_jobs_resp_msg_item_data in _status:
            componentsschemasv0_0_44_kill_jobs_resp_msg_item = V0044KillJobsRespJob.from_dict(
                componentsschemasv0_0_44_kill_jobs_resp_msg_item_data
            )
        ...
        v0044_openapi_kill_jobs_resp = cls(
            status=status,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_kill_jobs_resp.additional_properties = d
        return v0044_openapi_kill_jobs_resp
