...
T = TypeVar("T", bound="Dbv0038ResponseAccountDelete")
...
class Dbv0038ResponseAccountDelete:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_response_account_delete = cls(
            meta=meta,
            errors=errors,
        )

        dbv_0038_response_account_delete.additional_properties = d
        return dbv_0038_response_account_delete
