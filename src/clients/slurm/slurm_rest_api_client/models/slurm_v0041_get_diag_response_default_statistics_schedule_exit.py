...
T = TypeVar("T", bound="SlurmV0041GetDiagResponseDefaultStatisticsScheduleExit")


@_attrs_define
class SlurmV0041GetDiagResponseDefaultStatisticsScheduleExit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_diag_response_default_statistics_schedule_exit = cls(
        ...
        slurm_v0041_get_diag_response_default_statistics_schedule_exit.additional_properties = d
        return slurm_v0041_get_diag_response_default_statistics_schedule_exit
