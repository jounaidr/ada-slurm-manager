...
from ..models.v0044_job_desc_msg_cpu_binding_flags_item import V0044JobDescMsgCpuBindingFlagsItem
from ..models.v0044_job_desc_msg_flags_item import V0044JobDescMsgFlagsItem
from ..models.v0044_job_desc_msg_kill_warning_flags_item import V0044JobDescMsgKillWarningFlagsItem
from ..models.v0044_job_desc_msg_mail_type_item import V0044JobDescMsgMailTypeItem
from ..models.v0044_job_desc_msg_memory_binding_type_item import V0044JobDescMsgMemoryBindingTypeItem
from ..models.v0044_job_desc_msg_open_mode_item import V0044JobDescMsgOpenModeItem
from ..models.v0044_job_desc_msg_profile_item import V0044JobDescMsgProfileItem
from ..models.v0044_job_desc_msg_shared_item import V0044JobDescMsgSharedItem
from ..models.v0044_job_desc_msg_x11_item import V0044JobDescMsgX11Item
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_cron_entry import V0044CronEntry
    from ..models.v0044_job_desc_msg_rlimits import V0044JobDescMsgRlimits
...
T = TypeVar("T", bound="V0044JobDescMsg")


@_attrs_define
class V0044JobDescMsg:
    """
    Attributes:
        ...
        begin_time (V0044Uint64NoValStruct | Unset):
        flags (list[V0044JobDescMsgFlagsItem] | Unset): Job flags
        ...
        cpu_binding_flags (list[V0044JobDescMsgCpuBindingFlagsItem] | Unset): Flags for CPU binding
        ...
        crontab (V0044CronEntry | Unset):
        deadline (int | Unset): Latest time that the job may start (UNIX timestamp) (UNIX timestamp or time string
        ...
        end_time (int | Unset): Expected end time (UNIX timestamp) (UNIX timestamp or time string recognized by Slurm
            (e.g., '[MM/DD[/YY]-]HH:MM[:SS]'))
        environment (list[str] | Unset):
        rlimits (V0044JobDescMsgRlimits | Unset):
        ...
        mail_type (list[V0044JobDescMsgMailTypeItem] | Unset): Mail event type(s)
        ...
        memory_binding_type (list[V0044JobDescMsgMemoryBindingTypeItem] | Unset): Method for binding tasks to memory
        ...
        open_mode (list[V0044JobDescMsgOpenModeItem] | Unset): Open mode used for stdout and stderr files
        ...
        distribution_plane_size (V0044Uint16NoValStruct | Unset):
        ...
        profile (list[V0044JobDescMsgProfileItem] | Unset): Profile used by the acct_gather_profile plugin
        ...
        script (str | Unset): Job batch script contents; only the first component in a HetJob is populated or honored
        shared (list[V0044JobDescMsgSharedItem] | Unset): How the job can share resources with other jobs, if at all
        ...
        kill_warning_flags (list[V0044JobDescMsgKillWarningFlagsItem] | Unset): Flags related to job signals
        kill_warning_signal (str | Unset): Signal to send when approaching end time (e.g. "10" or "USR1")
        kill_warning_delay (V0044Uint16NoValStruct | Unset):
        ...
        required_switches (V0044Uint32NoValStruct | Unset):
        segment_size (V0044Uint16NoValStruct | Unset):
        ...
        x11 (list[V0044JobDescMsgX11Item] | Unset): X11 forwarding options
    ...
    begin_time: V0044Uint64NoValStruct | Unset = UNSET
    flags: list[V0044JobDescMsgFlagsItem] | Unset = UNSET
    ...
    cpu_binding_flags: list[V0044JobDescMsgCpuBindingFlagsItem] | Unset = UNSET
    cpu_frequency: str | Unset = UNSET
    cpus_per_tres: str | Unset = UNSET
    crontab: V0044CronEntry | Unset = UNSET
    ...
    rlimits: V0044JobDescMsgRlimits | Unset = UNSET
    ...
    mail_type: list[V0044JobDescMsgMailTypeItem] | Unset = UNSET
    mail_user: str | Unset = UNSET
    mcs_label: str | Unset = UNSET
    memory_binding: str | Unset = UNSET
    memory_binding_type: list[V0044JobDescMsgMemoryBindingTypeItem] | Unset = UNSET
    ...
    shared: list[V0044JobDescMsgSharedItem] | Unset = UNSET
    ...
    kill_warning_flags: list[V0044JobDescMsgKillWarningFlagsItem] | Unset = UNSET
    kill_warning_signal: str | Unset = UNSET
    kill_warning_delay: V0044Uint16NoValStruct | Unset = UNSET
    ...
    required_switches: V0044Uint32NoValStruct | Unset = UNSET
    segment_size: V0044Uint16NoValStruct | Unset = UNSET
    ...
    x11: list[V0044JobDescMsgX11Item] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_begin_time, Unset):
            ...
            begin_time = V0044Uint64NoValStruct.from_dict(_begin_time)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044JobDescMsgFlagsItem(flags_item_data)
        ...
        if _cpu_binding_flags is not UNSET:
            ...
            for cpu_binding_flags_item_data in _cpu_binding_flags:
                cpu_binding_flags_item = V0044JobDescMsgCpuBindingFlagsItem(cpu_binding_flags_item_data)
        ...
        if isinstance(_crontab, Unset):
            ...
            crontab = V0044CronEntry.from_dict(_crontab)
        ...
        if isinstance(_rlimits, Unset):
            ...
            rlimits = V0044JobDescMsgRlimits.from_dict(_rlimits)
        ...
        if _mail_type is not UNSET:
            ...
            for mail_type_item_data in _mail_type:
                mail_type_item = V0044JobDescMsgMailTypeItem(mail_type_item_data)
        ...
        if _memory_binding_type is not UNSET:
            ...
            for memory_binding_type_item_data in _memory_binding_type:
                memory_binding_type_item = V0044JobDescMsgMemoryBindingTypeItem(memory_binding_type_item_data)
        ...
        if _open_mode is not UNSET:
            ...
            for open_mode_item_data in _open_mode:
                open_mode_item = V0044JobDescMsgOpenModeItem(open_mode_item_data)
        ...
        if isinstance(_distribution_plane_size, Unset):
            ...
            distribution_plane_size = V0044Uint16NoValStruct.from_dict(_distribution_plane_size)
        ...
        if _profile is not UNSET:
            ...
            for profile_item_data in _profile:
                profile_item = V0044JobDescMsgProfileItem(profile_item_data)
        ...
        if _shared is not UNSET:
            ...
            for shared_item_data in _shared:
                shared_item = V0044JobDescMsgSharedItem(shared_item_data)
        ...
        if _kill_warning_flags is not UNSET:
            ...
            for kill_warning_flags_item_data in _kill_warning_flags:
                kill_warning_flags_item = V0044JobDescMsgKillWarningFlagsItem(kill_warning_flags_item_data)
        ...
        if isinstance(_kill_warning_delay, Unset):
            ...
            kill_warning_delay = V0044Uint16NoValStruct.from_dict(_kill_warning_delay)
        ...
        if isinstance(_required_switches, Unset):
            ...
            required_switches = V0044Uint32NoValStruct.from_dict(_required_switches)
        ...
        if isinstance(_segment_size, Unset):
            ...
            segment_size = V0044Uint16NoValStruct.from_dict(_segment_size)
        ...
        if _x11 is not UNSET:
            ...
            for x11_item_data in _x11:
                x11_item = V0044JobDescMsgX11Item(x11_item_data)
        ...
        v0044_job_desc_msg.additional_properties = d
        return v0044_job_desc_msg
