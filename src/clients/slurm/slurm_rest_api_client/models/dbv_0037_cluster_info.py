...
if TYPE_CHECKING:
    from ..models.dbv_0037_cluster_info_associations import Dbv0037ClusterInfoAssociations
    from ..models.dbv_0037_cluster_info_controller import Dbv0037ClusterInfoController
    from ..models.dbv_0037_response_tres import Dbv0037ResponseTres


T = TypeVar("T", bound="Dbv0037ClusterInfo")
...
class Dbv0037ClusterInfo:
    """
    Attributes:
        controller (Dbv0037ClusterInfoController | Unset): Information about controller
        ...
        associations (Dbv0037ClusterInfoAssociations | Unset): Information about associations
        rpc_version (int | Unset): Number rpc version
        tres (list[Dbv0037ResponseTres] | Unset): List of TRES in cluster
    """

    controller: Dbv0037ClusterInfoController | Unset = UNSET
    flags: list[str] | Unset = UNSET
    name: str | Unset = UNSET
    nodes: str | Unset = UNSET
    select_plugin: str | Unset = UNSET
    associations: Dbv0037ClusterInfoAssociations | Unset = UNSET
    rpc_version: int | Unset = UNSET
    tres: list[Dbv0037ResponseTres] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        controller: Dbv0037ClusterInfoController | Unset
        if isinstance(_controller, Unset):
            controller = UNSET
        else:
            controller = Dbv0037ClusterInfoController.from_dict(_controller)
        ...
        associations: Dbv0037ClusterInfoAssociations | Unset
        if isinstance(_associations, Unset):
            associations = UNSET
        else:
            associations = Dbv0037ClusterInfoAssociations.from_dict(_associations)
        ...
        if _tres is not UNSET:
            ...
            for tres_item_data in _tres:
                tres_item = Dbv0037ResponseTres.from_dict(tres_item_data)

                tres.append(tres_item)

        dbv_0037_cluster_info = cls(
        ...
        dbv_0037_cluster_info.additional_properties = d
        return dbv_0037_cluster_info
