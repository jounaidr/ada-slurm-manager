...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespQosItemUsageThreshold")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespQosItemUsageThreshold:
    """UsageThreshold
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_qos_item_usage_threshold = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_qos_item_usage_threshold.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_qos_item_usage_threshold
