...
) -> Dbv0038AssociationsInfo | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038AssociationsInfo.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038AssociationsInfo | list[Dbv0038Error]]:
    return Response(
...
def sync(
    *,
    ...
    user: str | Unset = UNSET,
    partition: str | Unset = UNSET,
) -> Dbv0038AssociationsInfo | list[Dbv0038Error] | None:
    """Get association info
