...
from ...models.dbv_0038_response_cluster_delete import Dbv0038ResponseClusterDelete
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/slurmdb/v0.0.38/cluster/{cluster_name}".format(
...
) -> Dbv0038ResponseClusterDelete | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038ResponseClusterDelete.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038ResponseClusterDelete | list[Dbv0038Error]]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> Dbv0038ResponseClusterDelete | list[Dbv0038Error] | None:
    """Delete cluster
