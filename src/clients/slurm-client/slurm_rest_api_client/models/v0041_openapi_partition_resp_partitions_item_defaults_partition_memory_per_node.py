...
T = TypeVar("T", bound="V0041OpenapiPartitionRespPartitionsItemDefaultsPartitionMemoryPerNode")


@_attrs_define
class V0041OpenapiPartitionRespPartitionsItemDefaultsPartitionMemoryPerNode:
    """DefMemPerNode
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_partition_resp_partitions_item_defaults_partition_memory_per_node = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_partition_resp_partitions_item_defaults_partition_memory_per_node.additional_properties = d
        return v0041_openapi_partition_resp_partitions_item_defaults_partition_memory_per_node
