...
T = TypeVar("T", bound="V0039License")
...
class V0039License:
    """
    Attributes:
        license_name (str | Unset):
        total (int | Unset):
        used (int | Unset):
        free (int | Unset):
        remote (bool | Unset):
        reserved (int | Unset):
        last_consumed (int | Unset):
        last_deficit (int | Unset):
        last_update (int | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0039_license.additional_properties = d
        return v0039_license
