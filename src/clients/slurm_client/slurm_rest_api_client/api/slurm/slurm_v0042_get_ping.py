...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiPingArrayResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiPingArrayResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiPingArrayResp.from_dict(response.json())
...
def sync(
    *,
    client: AuthenticatedClient | Client,
) -> V0042OpenapiPingArrayResp | None:
    """ping test
