...
T = TypeVar("T", bound="V0044ControllerPing")


@_attrs_define
class V0044ControllerPing:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_controller_ping.additional_properties = d
        return v0044_controller_ping
