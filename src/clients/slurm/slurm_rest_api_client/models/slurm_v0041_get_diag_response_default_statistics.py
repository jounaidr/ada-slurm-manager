...
if TYPE_CHECKING:
    from ..models.slurm_v0041_get_diag_response_default_statistics_bf_exit import (
        SlurmV0041GetDiagResponseDefaultStatisticsBfExit,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_bf_when_last_cycle import (
        SlurmV0041GetDiagResponseDefaultStatisticsBfWhenLastCycle,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_job_states_ts import (
        SlurmV0041GetDiagResponseDefaultStatisticsJobStatesTs,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_pending_rpcs_by_hostlist_item import (
        SlurmV0041GetDiagResponseDefaultStatisticsPendingRpcsByHostlistItem,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_pending_rpcs_item import (
        SlurmV0041GetDiagResponseDefaultStatisticsPendingRpcsItem,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_req_time import (
        SlurmV0041GetDiagResponseDefaultStatisticsReqTime,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_req_time_start import (
        SlurmV0041GetDiagResponseDefaultStatisticsReqTimeStart,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_rpcs_by_message_type_item import (
        SlurmV0041GetDiagResponseDefaultStatisticsRpcsByMessageTypeItem,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_rpcs_by_user_item import (
        SlurmV0041GetDiagResponseDefaultStatisticsRpcsByUserItem,
    )
    from ..models.slurm_v0041_get_diag_response_default_statistics_schedule_exit import (
        SlurmV0041GetDiagResponseDefaultStatisticsScheduleExit,
    )


T = TypeVar("T", bound="SlurmV0041GetDiagResponseDefaultStatistics")


@_attrs_define
class SlurmV0041GetDiagResponseDefaultStatistics:
    """statistics

    Attributes:
        parts_packed (int | Unset): Zero if only RPC statistic included
        req_time (SlurmV0041GetDiagResponseDefaultStatisticsReqTime | Unset): When the request was made (UNIX timestamp)
        req_time_start (SlurmV0041GetDiagResponseDefaultStatisticsReqTimeStart | Unset): When the data in the report
        ...
        schedule_exit (SlurmV0041GetDiagResponseDefaultStatisticsScheduleExit | Unset): Reasons for which the scheduling
        ...
        job_states_ts (SlurmV0041GetDiagResponseDefaultStatisticsJobStatesTs | Unset): When the job state counts were
        ...
        bf_exit (SlurmV0041GetDiagResponseDefaultStatisticsBfExit | Unset): Reasons for which the backfill scheduling
            cycle exited since last reset
        ...
        bf_when_last_cycle (SlurmV0041GetDiagResponseDefaultStatisticsBfWhenLastCycle | Unset): When the last backfill
            scheduling cycle happened (UNIX timestamp)
        bf_active (bool | Unset): Backfill scheduler currently running
        rpcs_by_message_type (list[SlurmV0041GetDiagResponseDefaultStatisticsRpcsByMessageTypeItem] | Unset): Most
            frequently issued remote procedure calls (RPCs)
        rpcs_by_user (list[SlurmV0041GetDiagResponseDefaultStatisticsRpcsByUserItem] | Unset): RPCs issued by user ID
        pending_rpcs (list[SlurmV0041GetDiagResponseDefaultStatisticsPendingRpcsItem] | Unset): Pending RPC statistics
        pending_rpcs_by_hostlist (list[SlurmV0041GetDiagResponseDefaultStatisticsPendingRpcsByHostlistItem] | Unset):
            Pending RPCs hostlists
    """

    parts_packed: int | Unset = UNSET
    req_time: SlurmV0041GetDiagResponseDefaultStatisticsReqTime | Unset = UNSET
    req_time_start: SlurmV0041GetDiagResponseDefaultStatisticsReqTimeStart | Unset = UNSET
    ...
    schedule_exit: SlurmV0041GetDiagResponseDefaultStatisticsScheduleExit | Unset = UNSET
    ...
    job_states_ts: SlurmV0041GetDiagResponseDefaultStatisticsJobStatesTs | Unset = UNSET
    ...
    bf_exit: SlurmV0041GetDiagResponseDefaultStatisticsBfExit | Unset = UNSET
    ...
    bf_when_last_cycle: SlurmV0041GetDiagResponseDefaultStatisticsBfWhenLastCycle | Unset = UNSET
    bf_active: bool | Unset = UNSET
    rpcs_by_message_type: list[SlurmV0041GetDiagResponseDefaultStatisticsRpcsByMessageTypeItem] | Unset = UNSET
    rpcs_by_user: list[SlurmV0041GetDiagResponseDefaultStatisticsRpcsByUserItem] | Unset = UNSET
    pending_rpcs: list[SlurmV0041GetDiagResponseDefaultStatisticsPendingRpcsItem] | Unset = UNSET
    pending_rpcs_by_hostlist: list[SlurmV0041GetDiagResponseDefaultStatisticsPendingRpcsByHostlistItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        req_time: SlurmV0041GetDiagResponseDefaultStatisticsReqTime | Unset
        if isinstance(_req_time, Unset):
            req_time = UNSET
        else:
            req_time = SlurmV0041GetDiagResponseDefaultStatisticsReqTime.from_dict(_req_time)

        _req_time_start = d.pop("req_time_start", UNSET)
        req_time_start: SlurmV0041GetDiagResponseDefaultStatisticsReqTimeStart | Unset
        if isinstance(_req_time_start, Unset):
            req_time_start = UNSET
        else:
            req_time_start = SlurmV0041GetDiagResponseDefaultStatisticsReqTimeStart.from_dict(_req_time_start)
        ...
        schedule_exit: SlurmV0041GetDiagResponseDefaultStatisticsScheduleExit | Unset
        if isinstance(_schedule_exit, Unset):
            schedule_exit = UNSET
        else:
            schedule_exit = SlurmV0041GetDiagResponseDefaultStatisticsScheduleExit.from_dict(_schedule_exit)
        ...
        job_states_ts: SlurmV0041GetDiagResponseDefaultStatisticsJobStatesTs | Unset
        if isinstance(_job_states_ts, Unset):
            job_states_ts = UNSET
        else:
            job_states_ts = SlurmV0041GetDiagResponseDefaultStatisticsJobStatesTs.from_dict(_job_states_ts)
        ...
        bf_exit: SlurmV0041GetDiagResponseDefaultStatisticsBfExit | Unset
        if isinstance(_bf_exit, Unset):
            bf_exit = UNSET
        else:
            bf_exit = SlurmV0041GetDiagResponseDefaultStatisticsBfExit.from_dict(_bf_exit)
        ...
        bf_when_last_cycle: SlurmV0041GetDiagResponseDefaultStatisticsBfWhenLastCycle | Unset
        if isinstance(_bf_when_last_cycle, Unset):
            bf_when_last_cycle = UNSET
        else:
            bf_when_last_cycle = SlurmV0041GetDiagResponseDefaultStatisticsBfWhenLastCycle.from_dict(
                _bf_when_last_cycle
            )
        ...
        if _rpcs_by_message_type is not UNSET:
            ...
            for rpcs_by_message_type_item_data in _rpcs_by_message_type:
                rpcs_by_message_type_item = SlurmV0041GetDiagResponseDefaultStatisticsRpcsByMessageTypeItem.from_dict(
        ...
        if _rpcs_by_user is not UNSET:
            ...
            for rpcs_by_user_item_data in _rpcs_by_user:
                rpcs_by_user_item = SlurmV0041GetDiagResponseDefaultStatisticsRpcsByUserItem.from_dict(
        ...
        if _pending_rpcs is not UNSET:
            ...
            for pending_rpcs_item_data in _pending_rpcs:
                pending_rpcs_item = SlurmV0041GetDiagResponseDefaultStatisticsPendingRpcsItem.from_dict(
        ...
        if _pending_rpcs_by_hostlist is not UNSET:
            ...
            for pending_rpcs_by_hostlist_item_data in _pending_rpcs_by_hostlist:
                pending_rpcs_by_hostlist_item = (
                    SlurmV0041GetDiagResponseDefaultStatisticsPendingRpcsByHostlistItem.from_dict(
        ...
        slurm_v0041_get_diag_response_default_statistics = cls(
        ...
        slurm_v0041_get_diag_response_default_statistics.additional_properties = d
        return slurm_v0041_get_diag_response_default_statistics
