...
from ..models.v0041_openapi_nodes_resp_nodes_item_next_state_after_reboot_item import (
    V0041OpenapiNodesRespNodesItemNextStateAfterRebootItem,
)
from ..models.v0041_openapi_nodes_resp_nodes_item_state_item import V0041OpenapiNodesRespNodesItemStateItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0041_openapi_nodes_resp_nodes_item_boot_time import V0041OpenapiNodesRespNodesItemBootTime
    from ..models.v0041_openapi_nodes_resp_nodes_item_energy import V0041OpenapiNodesRespNodesItemEnergy
    from ..models.v0041_openapi_nodes_resp_nodes_item_external_sensors import (
        V0041OpenapiNodesRespNodesItemExternalSensors,
    )
    from ..models.v0041_openapi_nodes_resp_nodes_item_free_mem import V0041OpenapiNodesRespNodesItemFreeMem
    from ..models.v0041_openapi_nodes_resp_nodes_item_last_busy import V0041OpenapiNodesRespNodesItemLastBusy
    from ..models.v0041_openapi_nodes_resp_nodes_item_power import V0041OpenapiNodesRespNodesItemPower
    from ..models.v0041_openapi_nodes_resp_nodes_item_reason_changed_at import (
        V0041OpenapiNodesRespNodesItemReasonChangedAt,
    )
    from ..models.v0041_openapi_nodes_resp_nodes_item_resume_after import V0041OpenapiNodesRespNodesItemResumeAfter
    from ..models.v0041_openapi_nodes_resp_nodes_item_slurmd_start_time import (
        V0041OpenapiNodesRespNodesItemSlurmdStartTime,
    )


T = TypeVar("T", bound="V0041OpenapiNodesRespNodesItem")


@_attrs_define
class V0041OpenapiNodesRespNodesItem:
    """
    Attributes:
        ...
        boot_time (V0041OpenapiNodesRespNodesItemBootTime | Unset): Time when the node booted (UNIX timestamp)
        ...
        free_mem (V0041OpenapiNodesRespNodesItemFreeMem | Unset): Total memory in MB currently free as reported by the
            OS
        ...
        specialized_cpus (str | Unset): Abstract CPU IDs on this node reserved for exclusive use by slurmd and
            slurmstepd
        energy (V0041OpenapiNodesRespNodesItemEnergy | Unset): Energy usage data
        external_sensors (V0041OpenapiNodesRespNodesItemExternalSensors | Unset):
        extra (str | Unset): Arbitrary string used for node filtering if extra constraints are enabled
        power (V0041OpenapiNodesRespNodesItemPower | Unset):
        features (list[str] | Unset): Available features
        active_features (list[str] | Unset): Currently active features
        ...
        last_busy (V0041OpenapiNodesRespNodesItemLastBusy | Unset): Time when the node was last busy (UNIX timestamp)
        ...
        next_state_after_reboot (list[V0041OpenapiNodesRespNodesItemNextStateAfterRebootItem] | Unset): The state the
            node will be assigned after rebooting
        address (str | Unset): NodeAddr, used to establish a communication path
        hostname (str | Unset): NodeHostname
        state (list[V0041OpenapiNodesRespNodesItemStateItem] | Unset): Node state(s) applicable to this node
        ...
        partitions (list[str] | Unset): Partitions containing this node
        ...
        reason_changed_at (V0041OpenapiNodesRespNodesItemReasonChangedAt | Unset): When the reason changed (UNIX
            timestamp)
        reason_set_by_user (str | Unset): User who set the reason
        resume_after (V0041OpenapiNodesRespNodesItemResumeAfter | Unset): Number of seconds after the node's state is
            updated to "DOWN" or "DRAIN" before scheduling a node state resume
        ...
        slurmd_start_time (V0041OpenapiNodesRespNodesItemSlurmdStartTime | Unset): Time when the slurmd started (UNIX
            timestamp)
    ...
    boot_time: V0041OpenapiNodesRespNodesItemBootTime | Unset = UNSET
    ...
    free_mem: V0041OpenapiNodesRespNodesItemFreeMem | Unset = UNSET
    cpus: int | Unset = UNSET
    effective_cpus: int | Unset = UNSET
    specialized_cpus: str | Unset = UNSET
    energy: V0041OpenapiNodesRespNodesItemEnergy | Unset = UNSET
    external_sensors: V0041OpenapiNodesRespNodesItemExternalSensors | Unset = UNSET
    extra: str | Unset = UNSET
    power: V0041OpenapiNodesRespNodesItemPower | Unset = UNSET
    ...
    last_busy: V0041OpenapiNodesRespNodesItemLastBusy | Unset = UNSET
    mcs_label: str | Unset = UNSET
    specialized_memory: int | Unset = UNSET
    name: str | Unset = UNSET
    next_state_after_reboot: list[V0041OpenapiNodesRespNodesItemNextStateAfterRebootItem] | Unset = UNSET
    address: str | Unset = UNSET
    hostname: str | Unset = UNSET
    state: list[V0041OpenapiNodesRespNodesItemStateItem] | Unset = UNSET
    ...
    reason_changed_at: V0041OpenapiNodesRespNodesItemReasonChangedAt | Unset = UNSET
    reason_set_by_user: str | Unset = UNSET
    resume_after: V0041OpenapiNodesRespNodesItemResumeAfter | Unset = UNSET
    ...
    slurmd_start_time: V0041OpenapiNodesRespNodesItemSlurmdStartTime | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        boot_time: V0041OpenapiNodesRespNodesItemBootTime | Unset
        if isinstance(_boot_time, Unset):
            boot_time = UNSET
        else:
            boot_time = V0041OpenapiNodesRespNodesItemBootTime.from_dict(_boot_time)
        ...
        free_mem: V0041OpenapiNodesRespNodesItemFreeMem | Unset
        if isinstance(_free_mem, Unset):
            free_mem = UNSET
        else:
            free_mem = V0041OpenapiNodesRespNodesItemFreeMem.from_dict(_free_mem)
        ...
        energy: V0041OpenapiNodesRespNodesItemEnergy | Unset
        if isinstance(_energy, Unset):
            energy = UNSET
        else:
            energy = V0041OpenapiNodesRespNodesItemEnergy.from_dict(_energy)
        ...
        if isinstance(_external_sensors, Unset):
            ...
            external_sensors = V0041OpenapiNodesRespNodesItemExternalSensors.from_dict(_external_sensors)
        ...
        if isinstance(_power, Unset):
            ...
            power = V0041OpenapiNodesRespNodesItemPower.from_dict(_power)
        ...
        last_busy: V0041OpenapiNodesRespNodesItemLastBusy | Unset
        if isinstance(_last_busy, Unset):
            last_busy = UNSET
        else:
            last_busy = V0041OpenapiNodesRespNodesItemLastBusy.from_dict(_last_busy)
        ...
        if _next_state_after_reboot is not UNSET:
            ...
            for next_state_after_reboot_item_data in _next_state_after_reboot:
                next_state_after_reboot_item = V0041OpenapiNodesRespNodesItemNextStateAfterRebootItem(
                    next_state_after_reboot_item_data
                )
        ...
        if _state is not UNSET:
            ...
            for state_item_data in _state:
                state_item = V0041OpenapiNodesRespNodesItemStateItem(state_item_data)
        ...
        reason_changed_at: V0041OpenapiNodesRespNodesItemReasonChangedAt | Unset
        if isinstance(_reason_changed_at, Unset):
            reason_changed_at = UNSET
        else:
            reason_changed_at = V0041OpenapiNodesRespNodesItemReasonChangedAt.from_dict(_reason_changed_at)

        reason_set_by_user = d.pop("reason_set_by_user", UNSET)

        _resume_after = d.pop("resume_after", UNSET)
        resume_after: V0041OpenapiNodesRespNodesItemResumeAfter | Unset
        if isinstance(_resume_after, Unset):
            resume_after = UNSET
        else:
            resume_after = V0041OpenapiNodesRespNodesItemResumeAfter.from_dict(_resume_after)
        ...
        slurmd_start_time: V0041OpenapiNodesRespNodesItemSlurmdStartTime | Unset
        if isinstance(_slurmd_start_time, Unset):
            slurmd_start_time = UNSET
        else:
            slurmd_start_time = V0041OpenapiNodesRespNodesItemSlurmdStartTime.from_dict(_slurmd_start_time)
        ...
        v0041_openapi_nodes_resp_nodes_item = cls(
        ...
        v0041_openapi_nodes_resp_nodes_item.additional_properties = d
        return v0041_openapi_nodes_resp_nodes_item
