...
class V0043JobInfo:
    ...
    Attributes:
        ...
        accrue_time (V0043Uint64NoValStruct | Unset):
        ...
        array_job_id (V0043Uint32NoValStruct | Unset):
        array_task_id (V0043Uint32NoValStruct | Unset):
        array_max_tasks (V0043Uint32NoValStruct | Unset):
        ...
        flags (list[V0043JobInfoFlagsItem] | Unset): Job flags
        ...
        cores_per_socket (V0043Uint16NoValStruct | Unset):
        billable_tres (V0043Float64NoValStruct | Unset):
        cpus_per_task (V0043Uint16NoValStruct | Unset):
        cpu_frequency_minimum (V0043Uint32NoValStruct | Unset):
        cpu_frequency_maximum (V0043Uint32NoValStruct | Unset):
        cpu_frequency_governor (V0043Uint32NoValStruct | Unset):
        ...
        deadline (V0043Uint64NoValStruct | Unset):
        delay_boot (V0043Uint32NoValStruct | Unset):
        dependency (str | Unset): Other jobs that must meet certain criteria before this job can start
        derived_exit_code (V0043ProcessExitCodeVerbose | Unset):
        eligible_time (V0043Uint64NoValStruct | Unset):
        end_time (V0043Uint64NoValStruct | Unset):
        excluded_nodes (str | Unset): Comma-separated list of nodes that may not be used
        exit_code (V0043ProcessExitCodeVerbose | Unset):
        ...
        het_job_id (V0043Uint32NoValStruct | Unset):
        het_job_id_set (str | Unset): Job ID range for all heterogeneous job components
        het_job_offset (V0043Uint32NoValStruct | Unset):
        job_id (int | Unset): Job ID
        job_resources (V0043JobRes | Unset):
        job_size_str (list[str] | Unset):
        job_state (list[V0043JobInfoJobStateItem] | Unset): Current state
        last_sched_evaluation (V0043Uint64NoValStruct | Unset):
        licenses (str | Unset): License(s) required by the job
        licenses_allocated (str | Unset): License(s) allocated to the job
        mail_type (list[V0043JobInfoMailTypeItem] | Unset): Mail event type(s)
        mail_user (str | Unset): User to receive email notifications
        max_cpus (V0043Uint32NoValStruct | Unset):
        max_nodes (V0043Uint32NoValStruct | Unset):
        ...
        tasks_per_core (V0043Uint16NoValStruct | Unset):
        tasks_per_tres (V0043Uint16NoValStruct | Unset):
        tasks_per_node (V0043Uint16NoValStruct | Unset):
        tasks_per_socket (V0043Uint16NoValStruct | Unset):
        tasks_per_board (V0043Uint16NoValStruct | Unset):
        cpus (V0043Uint32NoValStruct | Unset):
        node_count (V0043Uint32NoValStruct | Unset):
        tasks (V0043Uint32NoValStruct | Unset):
        partition (str | Unset): Partition assigned to the job
        prefer (str | Unset): Feature(s) the job requested but that are not required
        memory_per_cpu (V0043Uint64NoValStruct | Unset):
        memory_per_node (V0043Uint64NoValStruct | Unset):
        minimum_cpus_per_node (V0043Uint16NoValStruct | Unset):
        minimum_tmp_disk_per_node (V0043Uint32NoValStruct | Unset):
        power (V0043JobInfoPower | Unset):
        preempt_time (V0043Uint64NoValStruct | Unset):
        preemptable_time (V0043Uint64NoValStruct | Unset):
        pre_sus_time (V0043Uint64NoValStruct | Unset):
        hold (bool | Unset): Hold (true) or release (false) job (Job held)
        priority (V0043Uint32NoValStruct | Unset):
        priority_by_partition (list[V0043PartPrio] | Unset):
        profile (list[V0043JobInfoProfileItem] | Unset): Profile used by the acct_gather_profile plugin
        ...
        resize_time (V0043Uint64NoValStruct | Unset):
        ...
        shared (list[V0043JobInfoSharedItem] | Unset): How the job can share resources with other jobs, if at all
        sockets_per_board (int | Unset): Number of sockets per board required
        sockets_per_node (V0043Uint16NoValStruct | Unset):
        ...
        submit_time (V0043Uint64NoValStruct | Unset):
        suspend_time (V0043Uint64NoValStruct | Unset):
        system_comment (str | Unset): Arbitrary comment from slurmctld
        time_limit (V0043Uint32NoValStruct | Unset):
        time_minimum (V0043Uint32NoValStruct | Unset):
        threads_per_core (V0043Uint16NoValStruct | Unset):
    ...
    accrue_time: V0043Uint64NoValStruct | Unset = UNSET
    admin_comment: str | Unset = UNSET
    allocating_node: str | Unset = UNSET
    array_job_id: V0043Uint32NoValStruct | Unset = UNSET
    array_task_id: V0043Uint32NoValStruct | Unset = UNSET
    array_max_tasks: V0043Uint32NoValStruct | Unset = UNSET
    ...
    flags: list[V0043JobInfoFlagsItem] | Unset = UNSET
    ...
    cores_per_socket: V0043Uint16NoValStruct | Unset = UNSET
    billable_tres: V0043Float64NoValStruct | Unset = UNSET
    cpus_per_task: V0043Uint16NoValStruct | Unset = UNSET
    cpu_frequency_minimum: V0043Uint32NoValStruct | Unset = UNSET
    cpu_frequency_maximum: V0043Uint32NoValStruct | Unset = UNSET
    cpu_frequency_governor: V0043Uint32NoValStruct | Unset = UNSET
    cpus_per_tres: str | Unset = UNSET
    cron: str | Unset = UNSET
    deadline: V0043Uint64NoValStruct | Unset = UNSET
    delay_boot: V0043Uint32NoValStruct | Unset = UNSET
    dependency: str | Unset = UNSET
    derived_exit_code: V0043ProcessExitCodeVerbose | Unset = UNSET
    eligible_time: V0043Uint64NoValStruct | Unset = UNSET
    end_time: V0043Uint64NoValStruct | Unset = UNSET
    excluded_nodes: str | Unset = UNSET
    exit_code: V0043ProcessExitCodeVerbose | Unset = UNSET
    ...
    het_job_id: V0043Uint32NoValStruct | Unset = UNSET
    het_job_id_set: str | Unset = UNSET
    het_job_offset: V0043Uint32NoValStruct | Unset = UNSET
    job_id: int | Unset = UNSET
    job_resources: V0043JobRes | Unset = UNSET
    job_size_str: list[str] | Unset = UNSET
    job_state: list[V0043JobInfoJobStateItem] | Unset = UNSET
    last_sched_evaluation: V0043Uint64NoValStruct | Unset = UNSET
    licenses: str | Unset = UNSET
    licenses_allocated: str | Unset = UNSET
    mail_type: list[V0043JobInfoMailTypeItem] | Unset = UNSET
    mail_user: str | Unset = UNSET
    max_cpus: V0043Uint32NoValStruct | Unset = UNSET
    max_nodes: V0043Uint32NoValStruct | Unset = UNSET
    ...
    tasks_per_core: V0043Uint16NoValStruct | Unset = UNSET
    tasks_per_tres: V0043Uint16NoValStruct | Unset = UNSET
    tasks_per_node: V0043Uint16NoValStruct | Unset = UNSET
    tasks_per_socket: V0043Uint16NoValStruct | Unset = UNSET
    tasks_per_board: V0043Uint16NoValStruct | Unset = UNSET
    cpus: V0043Uint32NoValStruct | Unset = UNSET
    node_count: V0043Uint32NoValStruct | Unset = UNSET
    tasks: V0043Uint32NoValStruct | Unset = UNSET
    partition: str | Unset = UNSET
    prefer: str | Unset = UNSET
    memory_per_cpu: V0043Uint64NoValStruct | Unset = UNSET
    memory_per_node: V0043Uint64NoValStruct | Unset = UNSET
    minimum_cpus_per_node: V0043Uint16NoValStruct | Unset = UNSET
    minimum_tmp_disk_per_node: V0043Uint32NoValStruct | Unset = UNSET
    power: V0043JobInfoPower | Unset = UNSET
    preempt_time: V0043Uint64NoValStruct | Unset = UNSET
    preemptable_time: V0043Uint64NoValStruct | Unset = UNSET
    pre_sus_time: V0043Uint64NoValStruct | Unset = UNSET
    hold: bool | Unset = UNSET
    priority: V0043Uint32NoValStruct | Unset = UNSET
    priority_by_partition: list[V0043PartPrio] | Unset = UNSET
    profile: list[V0043JobInfoProfileItem] | Unset = UNSET
    qos: str | Unset = UNSET
    reboot: bool | Unset = UNSET
    required_nodes: str | Unset = UNSET
    required_switches: int | Unset = UNSET
    requeue: bool | Unset = UNSET
    resize_time: V0043Uint64NoValStruct | Unset = UNSET
    ...
    shared: list[V0043JobInfoSharedItem] | Unset = UNSET
    sockets_per_board: int | Unset = UNSET
    sockets_per_node: V0043Uint16NoValStruct | Unset = UNSET
    ...
    submit_time: V0043Uint64NoValStruct | Unset = UNSET
    suspend_time: V0043Uint64NoValStruct | Unset = UNSET
    system_comment: str | Unset = UNSET
    time_limit: V0043Uint32NoValStruct | Unset = UNSET
    time_minimum: V0043Uint32NoValStruct | Unset = UNSET
    threads_per_core: V0043Uint16NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _priority_by_partition is not UNSET:
            priority_by_partition = []
            for componentsschemasv0_0_43_priority_by_partition_item_data in _priority_by_partition:
