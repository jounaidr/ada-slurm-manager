...
T = TypeVar("T", bound="V0044SlurmdbdPing")


@_attrs_define
class V0044SlurmdbdPing:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_slurmdbd_ping.additional_properties = d
        return v0044_slurmdbd_ping
