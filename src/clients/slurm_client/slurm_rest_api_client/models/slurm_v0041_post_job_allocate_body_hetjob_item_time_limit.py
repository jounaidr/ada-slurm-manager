...
T = TypeVar("T", bound="SlurmV0041PostJobAllocateBodyHetjobItemTimeLimit")


@_attrs_define
class SlurmV0041PostJobAllocateBodyHetjobItemTimeLimit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_allocate_body_hetjob_item_time_limit = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_allocate_body_hetjob_item_time_limit.additional_properties = d
        return slurm_v0041_post_job_allocate_body_hetjob_item_time_limit
