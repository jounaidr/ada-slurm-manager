...
T = TypeVar("T", bound="V0041OpenapiNodesRespNodesItemReasonChangedAt")


@_attrs_define
class V0041OpenapiNodesRespNodesItemReasonChangedAt:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_nodes_resp_nodes_item_reason_changed_at = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_nodes_resp_nodes_item_reason_changed_at.additional_properties = d
        return v0041_openapi_nodes_resp_nodes_item_reason_changed_at
