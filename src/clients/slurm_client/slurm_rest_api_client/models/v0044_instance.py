...
if TYPE_CHECKING:
    from ..models.v0044_instance_time import V0044InstanceTime


T = TypeVar("T", bound="V0044Instance")
...
class V0044Instance:
    ...
    time: V0044InstanceTime | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_time, Unset):
            ...
            time = V0044InstanceTime.from_dict(_time)
        ...
        v0044_instance.additional_properties = d
        return v0044_instance
