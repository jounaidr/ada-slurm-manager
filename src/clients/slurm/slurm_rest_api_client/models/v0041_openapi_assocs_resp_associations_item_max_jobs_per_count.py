...
T = TypeVar("T", bound="V0041OpenapiAssocsRespAssociationsItemMaxJobsPerCount")


@_attrs_define
class V0041OpenapiAssocsRespAssociationsItemMaxJobsPerCount:
    """GrpJobs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_assocs_resp_associations_item_max_jobs_per_count = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_assocs_resp_associations_item_max_jobs_per_count.additional_properties = d
        return v0041_openapi_assocs_resp_associations_item_max_jobs_per_count
