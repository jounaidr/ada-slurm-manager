...
if TYPE_CHECKING:
    from ..models.v0041_openapi_instances_resp_instances_item_time import V0041OpenapiInstancesRespInstancesItemTime


T = TypeVar("T", bound="V0041OpenapiInstancesRespInstancesItem")


@_attrs_define
class V0041OpenapiInstancesRespInstancesItem:
    """
    Attributes:
        ...
        time (V0041OpenapiInstancesRespInstancesItemTime | Unset):
    """
    ...
    time: V0041OpenapiInstancesRespInstancesItemTime | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_time, Unset):
            ...
            time = V0041OpenapiInstancesRespInstancesItemTime.from_dict(_time)

        v0041_openapi_instances_resp_instances_item = cls(
            cluster=cluster,
            extra=extra,
        ...
        v0041_openapi_instances_resp_instances_item.additional_properties = d
        return v0041_openapi_instances_resp_instances_item
