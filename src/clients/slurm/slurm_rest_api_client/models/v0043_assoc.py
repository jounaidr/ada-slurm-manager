...
class V0043Assoc:
    ...
    Attributes:
        user (str): User name
        accounting (list[V0043Accounting] | Unset):
        account (str | Unset): Account name
        cluster (str | Unset): Cluster name
        comment (str | Unset): Arbitrary comment
        default (V0043AssocDefault | Unset):
        flags (list[V0043AssocFlagsItem] | Unset): Flags on the association
        max_ (V0043AssocMax | Unset):
    ...
    user: str
    accounting: list[V0043Accounting] | Unset = UNSET
    account: str | Unset = UNSET
    cluster: str | Unset = UNSET
    comment: str | Unset = UNSET
    default: V0043AssocDefault | Unset = UNSET
    flags: list[V0043AssocFlagsItem] | Unset = UNSET
    max_: V0043AssocMax | Unset = UNSET
    id: int | Unset = UNSET
    is_default: bool | Unset = UNSET
    lineage: str | Unset = UNSET
    min_: V0043AssocMin | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _accounting is not UNSET:
            accounting = []
            for componentsschemasv0_0_43_accounting_list_item_data in _accounting:
