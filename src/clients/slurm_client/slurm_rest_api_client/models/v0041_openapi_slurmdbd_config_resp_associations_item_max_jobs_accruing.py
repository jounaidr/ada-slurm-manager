...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespAssociationsItemMaxJobsAccruing")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespAssociationsItemMaxJobsAccruing:
    """MaxJobsAccrue
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_accruing = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_accruing.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_accruing
