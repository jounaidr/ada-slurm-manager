...
T = TypeVar("T", bound="Dbv0037QosLimitsMinTresPer")


@_attrs_define
class Dbv0037QosLimitsMinTresPer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0037_qos_limits_min_tres_per = cls(
            job=job,
        )

        dbv_0037_qos_limits_min_tres_per.additional_properties = d
        return dbv_0037_qos_limits_min_tres_per
