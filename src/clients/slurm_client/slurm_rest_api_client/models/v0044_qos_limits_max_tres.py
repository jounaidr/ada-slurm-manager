...
if TYPE_CHECKING:
    from ..models.v0044_qos_limits_max_tres_minutes import V0044QosLimitsMaxTresMinutes
    from ..models.v0044_qos_limits_max_tres_per import V0044QosLimitsMaxTresPer
    from ..models.v0044_tres import V0044Tres


T = TypeVar("T", bound="V0044QosLimitsMaxTres")


@_attrs_define
class V0044QosLimitsMaxTres:
    """
    Attributes:
        total (list[V0044Tres] | Unset):
        minutes (V0044QosLimitsMaxTresMinutes | Unset):
        per (V0044QosLimitsMaxTresPer | Unset):
    """

    total: list[V0044Tres] | Unset = UNSET
    minutes: V0044QosLimitsMaxTresMinutes | Unset = UNSET
    per: V0044QosLimitsMaxTresPer | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_minutes, Unset):
            ...
            minutes = V0044QosLimitsMaxTresMinutes.from_dict(_minutes)
        ...
        if isinstance(_per, Unset):
            ...
            per = V0044QosLimitsMaxTresPer.from_dict(_per)

        v0044_qos_limits_max_tres = cls(
            total=total,
            minutes=minutes,
            per=per,
        )

        v0044_qos_limits_max_tres.additional_properties = d
        return v0044_qos_limits_max_tres
