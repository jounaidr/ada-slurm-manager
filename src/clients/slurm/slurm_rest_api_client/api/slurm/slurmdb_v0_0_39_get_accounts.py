...
from ...models.slurmdb_v0039_get_accounts_with_deleted import SlurmdbV0039GetAccountsWithDeleted
...
def _get_kwargs(
    *,
    with_deleted: SlurmdbV0039GetAccountsWithDeleted | Unset = SlurmdbV0039GetAccountsWithDeleted.FALSE,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        with_deleted (SlurmdbV0039GetAccountsWithDeleted | Unset):  Default:
            SlurmdbV0039GetAccountsWithDeleted.FALSE.
