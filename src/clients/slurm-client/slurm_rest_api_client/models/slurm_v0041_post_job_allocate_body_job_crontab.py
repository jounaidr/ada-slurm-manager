...
from ..models.slurm_v0041_post_job_allocate_body_job_crontab_flags_item import (
    SlurmV0041PostJobAllocateBodyJobCrontabFlagsItem,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.slurm_v0041_post_job_allocate_body_job_crontab_line import SlurmV0041PostJobAllocateBodyJobCrontabLine


T = TypeVar("T", bound="SlurmV0041PostJobAllocateBodyJobCrontab")


@_attrs_define
class SlurmV0041PostJobAllocateBodyJobCrontab:
    """Specification for scrontab job

    Attributes:
        flags (list[SlurmV0041PostJobAllocateBodyJobCrontabFlagsItem] | Unset): Flags
        ...
        line (SlurmV0041PostJobAllocateBodyJobCrontabLine | Unset):
    """

    flags: list[SlurmV0041PostJobAllocateBodyJobCrontabFlagsItem] | Unset = UNSET
    ...
    line: SlurmV0041PostJobAllocateBodyJobCrontabLine | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.slurm_v0041_post_job_allocate_body_job_crontab_line import (
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = SlurmV0041PostJobAllocateBodyJobCrontabFlagsItem(flags_item_data)
        ...
        if isinstance(_line, Unset):
            ...
            line = SlurmV0041PostJobAllocateBodyJobCrontabLine.from_dict(_line)

        slurm_v0041_post_job_allocate_body_job_crontab = cls(
            flags=flags,
            minute=minute,
            hour=hour,
        ...
        slurm_v0041_post_job_allocate_body_job_crontab.additional_properties = d
        return slurm_v0041_post_job_allocate_body_job_crontab
