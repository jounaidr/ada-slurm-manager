...
from ..models.v0044_job_flags_item import V0044JobFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_assoc_short import V0044AssocShort
    from ..models.v0044_job_array import V0044JobArray
    from ..models.v0044_job_comment import V0044JobComment
    from ..models.v0044_job_het import V0044JobHet
    from ..models.v0044_job_mcs import V0044JobMcs
    from ..models.v0044_job_required import V0044JobRequired
    from ..models.v0044_job_reservation import V0044JobReservation
    from ..models.v0044_job_state import V0044JobState
    from ..models.v0044_job_time import V0044JobTime
    from ..models.v0044_job_tres import V0044JobTres
    from ..models.v0044_process_exit_code_verbose import V0044ProcessExitCodeVerbose
    from ..models.v0044_step import V0044Step
    from ..models.v0044_uint_32_no_val_struct import V0044Uint32NoValStruct
    from ..models.v0044_wckey_tag_struct import V0044WckeyTagStruct


T = TypeVar("T", bound="V0044Job")
...
class V0044Job:
    ...
    Attributes:
        ...
        comment (V0044JobComment | Unset):
        allocation_nodes (int | Unset): List of nodes allocated to the job
        array (V0044JobArray | Unset):
        association (V0044AssocShort | Unset):
        ...
        required (V0044JobRequired | Unset):
        ...
        reservation (V0044JobReservation | Unset):
    ...
    required: V0044JobRequired | Unset = UNSET
    kill_request_user: str | Unset = UNSET
    restart_cnt: int | Unset = UNSET
    reservation: V0044JobReservation | Unset = UNSET
    ...
    state: V0044JobState | Unset = UNSET
    steps: list[V0044Step] | Unset = UNSET
    submit_line: str | Unset = UNSET
    tres: V0044JobTres | Unset = UNSET
    used_gres: str | Unset = UNSET
    user: str | Unset = UNSET
    wckey: V0044WckeyTagStruct | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.steps, Unset):
            steps = []
            for componentsschemasv0_0_44_step_list_item_data in self.steps:
                componentsschemasv0_0_44_step_list_item = componentsschemasv0_0_44_step_list_item_data.to_dict()
                steps.append(componentsschemasv0_0_44_step_list_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comment, Unset):
            ...
            comment = V0044JobComment.from_dict(_comment)
        ...
        if isinstance(_array, Unset):
            ...
            array = V0044JobArray.from_dict(_array)
        ...
        if isinstance(_association, Unset):
            ...
            association = V0044AssocShort.from_dict(_association)
        ...
        if isinstance(_time, Unset):
            ...
            time = V0044JobTime.from_dict(_time)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044JobFlagsItem(flags_item_data)
        ...
        if isinstance(_het, Unset):
            ...
            het = V0044JobHet.from_dict(_het)
        ...
        if isinstance(_mcs, Unset):
            ...
            mcs = V0044JobMcs.from_dict(_mcs)
        ...
        if isinstance(_required, Unset):
            ...
            required = V0044JobRequired.from_dict(_required)
        ...
        if isinstance(_reservation, Unset):
            ...
            reservation = V0044JobReservation.from_dict(_reservation)
        ...
        if isinstance(_state, Unset):
            ...
            state = V0044JobState.from_dict(_state)

        _steps = d.pop("steps", UNSET)
        steps: list[V0044Step] | Unset = UNSET
        if _steps is not UNSET:
            steps = []
            for componentsschemasv0_0_44_step_list_item_data in _steps:
                componentsschemasv0_0_44_step_list_item = V0044Step.from_dict(
                    componentsschemasv0_0_44_step_list_item_data
                )
        ...
        if isinstance(_tres, Unset):
            ...
            tres = V0044JobTres.from_dict(_tres)
        ...
        if isinstance(_wckey, Unset):
            ...
            wckey = V0044WckeyTagStruct.from_dict(_wckey)
        ...
        v0044_job.additional_properties = d
        return v0044_job
