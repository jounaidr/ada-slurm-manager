...
from ...models.dbv_0038_response_account_delete import Dbv0038ResponseAccountDelete
...
) -> Dbv0038ResponseAccountDelete | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038ResponseAccountDelete.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038ResponseAccountDelete | list[Dbv0038Error]]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> Dbv0038ResponseAccountDelete | list[Dbv0038Error] | None:
    """Delete account
