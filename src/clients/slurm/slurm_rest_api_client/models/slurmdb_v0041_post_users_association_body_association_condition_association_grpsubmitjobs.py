...
T = TypeVar("T", bound="SlurmdbV0041PostUsersAssociationBodyAssociationConditionAssociationGrpsubmitjobs")


@_attrs_define
class SlurmdbV0041PostUsersAssociationBodyAssociationConditionAssociationGrpsubmitjobs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_post_users_association_body_association_condition_association_grpsubmitjobs = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurmdb_v0041_post_users_association_body_association_condition_association_grpsubmitjobs.additional_properties = d
        return slurmdb_v0041_post_users_association_body_association_condition_association_grpsubmitjobs
