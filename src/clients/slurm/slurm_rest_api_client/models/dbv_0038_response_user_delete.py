...
T = TypeVar("T", bound="Dbv0038ResponseUserDelete")
...
class Dbv0038ResponseUserDelete:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_response_user_delete = cls(
            meta=meta,
            errors=errors,
        )

        dbv_0038_response_user_delete.additional_properties = d
        return dbv_0038_response_user_delete
