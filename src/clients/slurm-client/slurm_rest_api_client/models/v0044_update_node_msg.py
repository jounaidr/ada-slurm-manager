...
from ..models.v0044_update_node_msg_state_item import V0044UpdateNodeMsgStateItem
...
T = TypeVar("T", bound="V0044UpdateNodeMsg")


@_attrs_define
class V0044UpdateNodeMsg:
    """
    Attributes:
        ...
        features_act (list[str] | Unset):
        gres (str | Unset): Generic resources
        address (list[str] | Unset):
        hostname (list[str] | Unset):
        name (list[str] | Unset):
        state (list[V0044UpdateNodeMsgStateItem] | Unset): New state to assign to the node
        ...
        resume_after (V0044Uint32NoValStruct | Unset):
        topology_str (str | Unset): Topology
        weight (V0044Uint32NoValStruct | Unset):
    """
    ...
    state: list[V0044UpdateNodeMsgStateItem] | Unset = UNSET
    reason: str | Unset = UNSET
    reason_uid: str | Unset = UNSET
    resume_after: V0044Uint32NoValStruct | Unset = UNSET
    topology_str: str | Unset = UNSET
    weight: V0044Uint32NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _state is not UNSET:
            ...
            for state_item_data in _state:
                state_item = V0044UpdateNodeMsgStateItem(state_item_data)
        ...
        if isinstance(_resume_after, Unset):
            ...
            resume_after = V0044Uint32NoValStruct.from_dict(_resume_after)
        ...
        if isinstance(_weight, Unset):
            ...
            weight = V0044Uint32NoValStruct.from_dict(_weight)

        v0044_update_node_msg = cls(
            comment=comment,
            cpu_bind=cpu_bind,
            extra=extra,
            features=features,
        ...
        v0044_update_node_msg.additional_properties = d
        return v0044_update_node_msg
