...
class V0042QosLimitsMaxTres:
    ...
    Attributes:
        ...
        minutes (V0042QosLimitsMaxTresMinutes | Unset):
        per (V0042QosLimitsMaxTresPer | Unset):
    """

    total: list[V0042Tres] | Unset = UNSET
    minutes: V0042QosLimitsMaxTresMinutes | Unset = UNSET
    per: V0042QosLimitsMaxTresPer | Unset = UNSET
