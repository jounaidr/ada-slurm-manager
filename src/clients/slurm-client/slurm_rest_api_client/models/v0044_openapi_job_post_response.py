...
if TYPE_CHECKING:
    from ..models.v0044_job_array_response_msg_entry import V0044JobArrayResponseMsgEntry
...
T = TypeVar("T", bound="V0044OpenapiJobPostResponse")


@_attrs_define
class V0044OpenapiJobPostResponse:
    """
    Attributes:
        results (list[V0044JobArrayResponseMsgEntry] | Unset):
        meta (V0044OpenapiMeta | Unset):
        errors (list[V0044OpenapiError] | Unset):
        warnings (list[V0044OpenapiWarning] | Unset):
    """

    results: list[V0044JobArrayResponseMsgEntry] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.results, Unset):
            results = []
            for componentsschemasv0_0_44_job_array_response_array_item_data in self.results:
                componentsschemasv0_0_44_job_array_response_array_item = (
                    componentsschemasv0_0_44_job_array_response_array_item_data.to_dict()
                )
                results.append(componentsschemasv0_0_44_job_array_response_array_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            results = []
            for componentsschemasv0_0_44_job_array_response_array_item_data in _results:
                componentsschemasv0_0_44_job_array_response_array_item = V0044JobArrayResponseMsgEntry.from_dict(
                    componentsschemasv0_0_44_job_array_response_array_item_data
                )
        ...
        v0044_openapi_job_post_response = cls(
            results=results,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_job_post_response.additional_properties = d
        return v0044_openapi_job_post_response
