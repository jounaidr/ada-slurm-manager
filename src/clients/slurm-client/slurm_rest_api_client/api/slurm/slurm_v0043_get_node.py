...
def _get_kwargs(
    ...
    *,
    ...
    flags: SlurmV0043GetNodeFlags | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/slurm/v0.0.43/node/{node_name}".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0043OpenapiNodesResp:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        flags (SlurmV0043GetNodeFlags | Unset):
