...
def _get_kwargs(
    *,
    body: V0042JobAllocReq | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiJobAllocResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiJobAllocResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiJobAllocResp.from_dict(response.json())
