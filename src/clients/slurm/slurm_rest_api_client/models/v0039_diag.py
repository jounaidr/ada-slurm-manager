...
if TYPE_CHECKING:
    ...
    from ..models.v0039_stats_msg import V0039StatsMsg
    from ..models.v0039_warning import V0039Warning


T = TypeVar("T", bound="V0039Diag")
...
class V0039Diag:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_statistics, Unset):
            ...
            statistics = V0039StatsMsg.from_dict(_statistics)
        ...
        v0039_diag.additional_properties = d
        return v0039_diag
