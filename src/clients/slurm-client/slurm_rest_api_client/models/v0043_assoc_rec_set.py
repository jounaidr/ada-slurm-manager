...
class V0043AssocRecSet:
    ...
    Attributes:
        ...
        grpjobs (V0043Uint32NoValStruct | Unset):
        grpjobsaccrue (V0043Uint32NoValStruct | Unset):
        grpsubmitjobs (V0043Uint32NoValStruct | Unset):
        grptres (list[V0043Tres] | Unset):
        grptresmins (list[V0043Tres] | Unset):
        grptresrunmins (list[V0043Tres] | Unset):
        grpwall (V0043Uint32NoValStruct | Unset):
        maxjobs (V0043Uint32NoValStruct | Unset):
        maxjobsaccrue (V0043Uint32NoValStruct | Unset):
        maxsubmitjobs (V0043Uint32NoValStruct | Unset):
        maxtresminsperjob (list[V0043Tres] | Unset):
        maxtresrunmins (list[V0043Tres] | Unset):
        maxtresperjob (list[V0043Tres] | Unset):
        maxtrespernode (list[V0043Tres] | Unset):
        maxwalldurationperjob (V0043Uint32NoValStruct | Unset):
        minpriothresh (V0043Uint32NoValStruct | Unset):
    ...
    grpjobs: V0043Uint32NoValStruct | Unset = UNSET
    grpjobsaccrue: V0043Uint32NoValStruct | Unset = UNSET
    grpsubmitjobs: V0043Uint32NoValStruct | Unset = UNSET
    grptres: list[V0043Tres] | Unset = UNSET
    grptresmins: list[V0043Tres] | Unset = UNSET
    grptresrunmins: list[V0043Tres] | Unset = UNSET
    grpwall: V0043Uint32NoValStruct | Unset = UNSET
    maxjobs: V0043Uint32NoValStruct | Unset = UNSET
    maxjobsaccrue: V0043Uint32NoValStruct | Unset = UNSET
    maxsubmitjobs: V0043Uint32NoValStruct | Unset = UNSET
    maxtresminsperjob: list[V0043Tres] | Unset = UNSET
    maxtresrunmins: list[V0043Tres] | Unset = UNSET
    maxtresperjob: list[V0043Tres] | Unset = UNSET
    maxtrespernode: list[V0043Tres] | Unset = UNSET
    maxwalldurationperjob: V0043Uint32NoValStruct | Unset = UNSET
    minpriothresh: V0043Uint32NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _grptres is not UNSET:
            grptres = []
            for componentsschemasv0_0_43_tres_list_item_data in _grptres:
        ...
        if _grptresmins is not UNSET:
            grptresmins = []
            for componentsschemasv0_0_43_tres_list_item_data in _grptresmins:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
        ...
        if _grptresrunmins is not UNSET:
            grptresrunmins = []
            for componentsschemasv0_0_43_tres_list_item_data in _grptresrunmins:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
        ...
        if _maxtresminsperjob is not UNSET:
            maxtresminsperjob = []
            for componentsschemasv0_0_43_tres_list_item_data in _maxtresminsperjob:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
        ...
        if _maxtresrunmins is not UNSET:
            maxtresrunmins = []
            for componentsschemasv0_0_43_tres_list_item_data in _maxtresrunmins:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
        ...
        if _maxtresperjob is not UNSET:
            maxtresperjob = []
            for componentsschemasv0_0_43_tres_list_item_data in _maxtresperjob:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
        ...
        if _maxtrespernode is not UNSET:
            maxtrespernode = []
            for componentsschemasv0_0_43_tres_list_item_data in _maxtrespernode:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
