...
class V0042StatsMsg:
    ...
    Attributes:
        ...
        req_time (V0042Uint64NoValStruct | Unset):
        req_time_start (V0042Uint64NoValStruct | Unset):
        ...
        schedule_exit (V0042ScheduleExitFields | Unset):
        ...
        job_states_ts (V0042Uint64NoValStruct | Unset):
        ...
        bf_exit (V0042BfExitFields | Unset):
        ...
        bf_when_last_cycle (V0042Uint64NoValStruct | Unset):
        bf_active (bool | Unset): Backfill scheduler currently running
        rpcs_by_message_type (list[V0042StatsMsgRpcType] | Unset): RPCs by type
        rpcs_by_user (list[V0042StatsMsgRpcUser] | Unset): RPCs by user
        pending_rpcs (list[V0042StatsMsgRpcQueue] | Unset): Pending RPCs
        pending_rpcs_by_hostlist (list[V0042StatsMsgRpcDump] | Unset): Pending RPCs by hostlist
    """

    parts_packed: int | Unset = UNSET
    req_time: V0042Uint64NoValStruct | Unset = UNSET
    req_time_start: V0042Uint64NoValStruct | Unset = UNSET
    ...
    schedule_exit: V0042ScheduleExitFields | Unset = UNSET
    ...
    job_states_ts: V0042Uint64NoValStruct | Unset = UNSET
    ...
    bf_exit: V0042BfExitFields | Unset = UNSET
    ...
    bf_when_last_cycle: V0042Uint64NoValStruct | Unset = UNSET
    bf_active: bool | Unset = UNSET
    rpcs_by_message_type: list[V0042StatsMsgRpcType] | Unset = UNSET
    rpcs_by_user: list[V0042StatsMsgRpcUser] | Unset = UNSET
    pending_rpcs: list[V0042StatsMsgRpcQueue] | Unset = UNSET
    pending_rpcs_by_hostlist: list[V0042StatsMsgRpcDump] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _rpcs_by_message_type is not UNSET:
            rpcs_by_message_type = []
            for componentsschemasv0_0_42_stats_msg_rpcs_by_type_item_data in _rpcs_by_message_type:
        ...
        if _rpcs_by_user is not UNSET:
            rpcs_by_user = []
            for componentsschemasv0_0_42_stats_msg_rpcs_by_user_item_data in _rpcs_by_user:
        ...
        if _pending_rpcs is not UNSET:
            pending_rpcs = []
            for componentsschemasv0_0_42_stats_msg_rpcs_queue_item_data in _pending_rpcs:
        ...
        if _pending_rpcs_by_hostlist is not UNSET:
            pending_rpcs_by_hostlist = []
            for componentsschemasv0_0_42_stats_msg_rpcs_dump_item_data in _pending_rpcs_by_hostlist:
