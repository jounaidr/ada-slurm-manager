...
T = TypeVar("T", bound="SlurmdbV0041DeleteAccountResponseDefaultErrorsItem")


@_attrs_define
class SlurmdbV0041DeleteAccountResponseDefaultErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_delete_account_response_default_errors_item = cls(
        ...
        slurmdb_v0041_delete_account_response_default_errors_item.additional_properties = d
        return slurmdb_v0041_delete_account_response_default_errors_item
