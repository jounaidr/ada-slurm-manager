...
T = TypeVar("T", bound="Dbv0038JobRequired")


@_attrs_define
class Dbv0038JobRequired:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_job_required = cls(
            cp_us=cp_us,
            memory=memory,
        )

        dbv_0038_job_required.additional_properties = d
        return dbv_0038_job_required
