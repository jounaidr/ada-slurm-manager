...
class V0043JobDescMsg:
    ...
    Attributes:
        ...
        begin_time (V0043Uint64NoValStruct | Unset):
        flags (list[V0043JobDescMsgFlagsItem] | Unset): Job flags
        ...
        cpu_binding_flags (list[V0043JobDescMsgCpuBindingFlagsItem] | Unset): Flags for CPU binding
        ...
        rlimits (V0043JobDescMsgRlimits | Unset):
        ...
        mail_type (list[V0043JobDescMsgMailTypeItem] | Unset): Mail event type(s)
        ...
        memory_binding_type (list[V0043JobDescMsgMemoryBindingTypeItem] | Unset): Method for binding tasks to memory
        ...
        open_mode (list[V0043JobDescMsgOpenModeItem] | Unset): Open mode used for stdout and stderr files
        ...
        distribution_plane_size (V0043Uint16NoValStruct | Unset):
        ...
        profile (list[V0043JobDescMsgProfileItem] | Unset): Profile used by the acct_gather_profile plugin
        ...
        shared (list[V0043JobDescMsgSharedItem] | Unset): How the job can share resources with other jobs, if at all
        ...
        kill_warning_flags (list[V0043JobDescMsgKillWarningFlagsItem] | Unset): Flags related to job signals
        kill_warning_signal (str | Unset): Signal to send when approaching end time (e.g. "10" or "USR1")
        kill_warning_delay (V0043Uint16NoValStruct | Unset):
        ...
        required_switches (V0043Uint32NoValStruct | Unset):
        segment_size (V0043Uint16NoValStruct | Unset):
        ...
        x11 (list[V0043JobDescMsgX11Item] | Unset): X11 forwarding options
    ...
    begin_time: V0043Uint64NoValStruct | Unset = UNSET
    flags: list[V0043JobDescMsgFlagsItem] | Unset = UNSET
    ...
    cpu_binding_flags: list[V0043JobDescMsgCpuBindingFlagsItem] | Unset = UNSET
    cpu_frequency: str | Unset = UNSET
    cpus_per_tres: str | Unset = UNSET
    crontab: V0043CronEntry | Unset = UNSET
    ...
    rlimits: V0043JobDescMsgRlimits | Unset = UNSET
    ...
    mail_type: list[V0043JobDescMsgMailTypeItem] | Unset = UNSET
    mail_user: str | Unset = UNSET
    mcs_label: str | Unset = UNSET
    memory_binding: str | Unset = UNSET
    memory_binding_type: list[V0043JobDescMsgMemoryBindingTypeItem] | Unset = UNSET
    ...
    shared: list[V0043JobDescMsgSharedItem] | Unset = UNSET
    ...
    kill_warning_flags: list[V0043JobDescMsgKillWarningFlagsItem] | Unset = UNSET
    kill_warning_signal: str | Unset = UNSET
    kill_warning_delay: V0043Uint16NoValStruct | Unset = UNSET
    ...
    required_switches: V0043Uint32NoValStruct | Unset = UNSET
    segment_size: V0043Uint16NoValStruct | Unset = UNSET
    ...
    x11: list[V0043JobDescMsgX11Item] | Unset = UNSET
