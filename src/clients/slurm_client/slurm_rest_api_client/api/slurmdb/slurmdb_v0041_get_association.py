...
from ...models.v0041_openapi_assocs_resp import V0041OpenapiAssocsResp
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0041OpenapiAssocsResp:
    if response.status_code == 200:
        response_200 = V0041OpenapiAssocsResp.from_dict(response.json())

        return response_200

    response_default = V0041OpenapiAssocsResp.from_dict(response.json())
...
) -> Response[V0041OpenapiAssocsResp]:
    return Response(
