...
T = TypeVar("T", bound="V0044BfExitFields")


@_attrs_define
class V0044BfExitFields:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_bf_exit_fields.additional_properties = d
        return v0044_bf_exit_fields
