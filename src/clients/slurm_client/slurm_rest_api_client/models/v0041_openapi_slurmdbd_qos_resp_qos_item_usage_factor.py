...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdQosRespQosItemUsageFactor")


@_attrs_define
class V0041OpenapiSlurmdbdQosRespQosItemUsageFactor:
    """UsageFactor
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_qos_resp_qos_item_usage_factor = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_qos_resp_qos_item_usage_factor.additional_properties = d
        return v0041_openapi_slurmdbd_qos_resp_qos_item_usage_factor
