...
T = TypeVar("T", bound="V0041OpenapiNodesRespNodesItemEnergyCurrentWatts")


@_attrs_define
class V0041OpenapiNodesRespNodesItemEnergyCurrentWatts:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_nodes_resp_nodes_item_energy_current_watts = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_nodes_resp_nodes_item_energy_current_watts.additional_properties = d
        return v0041_openapi_nodes_resp_nodes_item_energy_current_watts
