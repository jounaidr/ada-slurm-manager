...
T = TypeVar("T", bound="V0041OpenapiPartitionRespPartitionsItemNodes")


@_attrs_define
class V0041OpenapiPartitionRespPartitionsItemNodes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_partition_resp_partitions_item_nodes = cls(
            allowed_allocation=allowed_allocation,
            configured=configured,
            total=total,
        )

        v0041_openapi_partition_resp_partitions_item_nodes.additional_properties = d
        return v0041_openapi_partition_resp_partitions_item_nodes
