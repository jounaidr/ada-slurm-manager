...
T = TypeVar("T", bound="V0044JobDescMsgRlimits")


@_attrs_define
class V0044JobDescMsgRlimits:
    """
    Attributes:
        cpu (V0044Uint64NoValStruct | Unset):
        fsize (V0044Uint64NoValStruct | Unset):
        data (V0044Uint64NoValStruct | Unset):
        stack (V0044Uint64NoValStruct | Unset):
        core (V0044Uint64NoValStruct | Unset):
        rss (V0044Uint64NoValStruct | Unset):
        nproc (V0044Uint64NoValStruct | Unset):
        nofile (V0044Uint64NoValStruct | Unset):
        memlock (V0044Uint64NoValStruct | Unset):
        as_ (V0044Uint64NoValStruct | Unset):
    """

    cpu: V0044Uint64NoValStruct | Unset = UNSET
    fsize: V0044Uint64NoValStruct | Unset = UNSET
    data: V0044Uint64NoValStruct | Unset = UNSET
    stack: V0044Uint64NoValStruct | Unset = UNSET
    core: V0044Uint64NoValStruct | Unset = UNSET
    rss: V0044Uint64NoValStruct | Unset = UNSET
    nproc: V0044Uint64NoValStruct | Unset = UNSET
    nofile: V0044Uint64NoValStruct | Unset = UNSET
    memlock: V0044Uint64NoValStruct | Unset = UNSET
    as_: V0044Uint64NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cpu, Unset):
            ...
            cpu = V0044Uint64NoValStruct.from_dict(_cpu)
        ...
        if isinstance(_fsize, Unset):
            ...
            fsize = V0044Uint64NoValStruct.from_dict(_fsize)
        ...
        if isinstance(_data, Unset):
            ...
            data = V0044Uint64NoValStruct.from_dict(_data)
        ...
        if isinstance(_stack, Unset):
            ...
            stack = V0044Uint64NoValStruct.from_dict(_stack)
        ...
        if isinstance(_core, Unset):
            ...
            core = V0044Uint64NoValStruct.from_dict(_core)
        ...
        if isinstance(_rss, Unset):
            ...
            rss = V0044Uint64NoValStruct.from_dict(_rss)
        ...
        if isinstance(_nproc, Unset):
            ...
            nproc = V0044Uint64NoValStruct.from_dict(_nproc)
        ...
        if isinstance(_nofile, Unset):
            ...
            nofile = V0044Uint64NoValStruct.from_dict(_nofile)
        ...
        if isinstance(_memlock, Unset):
            ...
            memlock = V0044Uint64NoValStruct.from_dict(_memlock)
        ...
        if isinstance(_as_, Unset):
            ...
            as_ = V0044Uint64NoValStruct.from_dict(_as_)

        v0044_job_desc_msg_rlimits = cls(
            cpu=cpu,
            fsize=fsize,
            data=data,
            stack=stack,
        ...
        v0044_job_desc_msg_rlimits.additional_properties = d
        return v0044_job_desc_msg_rlimits
