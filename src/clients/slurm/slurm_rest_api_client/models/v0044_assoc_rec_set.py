...
T = TypeVar("T", bound="V0044AssocRecSet")


@_attrs_define
class V0044AssocRecSet:
    """
    Attributes:
        comment (str | Unset): Arbitrary comment
        defaultqos (str | Unset): Default QOS
        grpjobs (V0044Uint32NoValStruct | Unset):
        grpjobsaccrue (V0044Uint32NoValStruct | Unset):
        grpsubmitjobs (V0044Uint32NoValStruct | Unset):
        grptres (list[V0044Tres] | Unset):
        grptresmins (list[V0044Tres] | Unset):
        grptresrunmins (list[V0044Tres] | Unset):
        grpwall (V0044Uint32NoValStruct | Unset):
        maxjobs (V0044Uint32NoValStruct | Unset):
        maxjobsaccrue (V0044Uint32NoValStruct | Unset):
        maxsubmitjobs (V0044Uint32NoValStruct | Unset):
        maxtresminsperjob (list[V0044Tres] | Unset):
        maxtresrunmins (list[V0044Tres] | Unset):
        maxtresperjob (list[V0044Tres] | Unset):
        maxtrespernode (list[V0044Tres] | Unset):
        maxwalldurationperjob (V0044Uint32NoValStruct | Unset):
        minpriothresh (V0044Uint32NoValStruct | Unset):
    ...
    grpjobs: V0044Uint32NoValStruct | Unset = UNSET
    grpjobsaccrue: V0044Uint32NoValStruct | Unset = UNSET
    grpsubmitjobs: V0044Uint32NoValStruct | Unset = UNSET
    grptres: list[V0044Tres] | Unset = UNSET
    grptresmins: list[V0044Tres] | Unset = UNSET
    grptresrunmins: list[V0044Tres] | Unset = UNSET
    grpwall: V0044Uint32NoValStruct | Unset = UNSET
    maxjobs: V0044Uint32NoValStruct | Unset = UNSET
    maxjobsaccrue: V0044Uint32NoValStruct | Unset = UNSET
    maxsubmitjobs: V0044Uint32NoValStruct | Unset = UNSET
    maxtresminsperjob: list[V0044Tres] | Unset = UNSET
    maxtresrunmins: list[V0044Tres] | Unset = UNSET
    maxtresperjob: list[V0044Tres] | Unset = UNSET
    maxtrespernode: list[V0044Tres] | Unset = UNSET
    maxwalldurationperjob: V0044Uint32NoValStruct | Unset = UNSET
    minpriothresh: V0044Uint32NoValStruct | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.grptres, Unset):
            grptres = []
            for componentsschemasv0_0_44_tres_list_item_data in self.grptres:
                componentsschemasv0_0_44_tres_list_item = componentsschemasv0_0_44_tres_list_item_data.to_dict()
                grptres.append(componentsschemasv0_0_44_tres_list_item)

        grptresmins: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.grptresmins, Unset):
            grptresmins = []
            for componentsschemasv0_0_44_tres_list_item_data in self.grptresmins:
                componentsschemasv0_0_44_tres_list_item = componentsschemasv0_0_44_tres_list_item_data.to_dict()
                grptresmins.append(componentsschemasv0_0_44_tres_list_item)

        grptresrunmins: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.grptresrunmins, Unset):
            grptresrunmins = []
            for componentsschemasv0_0_44_tres_list_item_data in self.grptresrunmins:
                componentsschemasv0_0_44_tres_list_item = componentsschemasv0_0_44_tres_list_item_data.to_dict()
                grptresrunmins.append(componentsschemasv0_0_44_tres_list_item)
        ...
        if not isinstance(self.maxtresminsperjob, Unset):
            maxtresminsperjob = []
            for componentsschemasv0_0_44_tres_list_item_data in self.maxtresminsperjob:
                componentsschemasv0_0_44_tres_list_item = componentsschemasv0_0_44_tres_list_item_data.to_dict()
                maxtresminsperjob.append(componentsschemasv0_0_44_tres_list_item)

        maxtresrunmins: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.maxtresrunmins, Unset):
            maxtresrunmins = []
            for componentsschemasv0_0_44_tres_list_item_data in self.maxtresrunmins:
                componentsschemasv0_0_44_tres_list_item = componentsschemasv0_0_44_tres_list_item_data.to_dict()
                maxtresrunmins.append(componentsschemasv0_0_44_tres_list_item)

        maxtresperjob: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.maxtresperjob, Unset):
            maxtresperjob = []
            for componentsschemasv0_0_44_tres_list_item_data in self.maxtresperjob:
                componentsschemasv0_0_44_tres_list_item = componentsschemasv0_0_44_tres_list_item_data.to_dict()
                maxtresperjob.append(componentsschemasv0_0_44_tres_list_item)

        maxtrespernode: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.maxtrespernode, Unset):
            maxtrespernode = []
            for componentsschemasv0_0_44_tres_list_item_data in self.maxtrespernode:
                componentsschemasv0_0_44_tres_list_item = componentsschemasv0_0_44_tres_list_item_data.to_dict()
                maxtrespernode.append(componentsschemasv0_0_44_tres_list_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_grpjobs, Unset):
            ...
            grpjobs = V0044Uint32NoValStruct.from_dict(_grpjobs)
        ...
        if isinstance(_grpjobsaccrue, Unset):
            ...
            grpjobsaccrue = V0044Uint32NoValStruct.from_dict(_grpjobsaccrue)
        ...
        if isinstance(_grpsubmitjobs, Unset):
            ...
            grpsubmitjobs = V0044Uint32NoValStruct.from_dict(_grpsubmitjobs)

        _grptres = d.pop("grptres", UNSET)
        grptres: list[V0044Tres] | Unset = UNSET
        if _grptres is not UNSET:
            grptres = []
            for componentsschemasv0_0_44_tres_list_item_data in _grptres:
        ...
        if _grptresmins is not UNSET:
            grptresmins = []
            for componentsschemasv0_0_44_tres_list_item_data in _grptresmins:
                componentsschemasv0_0_44_tres_list_item = V0044Tres.from_dict(
                    componentsschemasv0_0_44_tres_list_item_data
                )
        ...
        if _grptresrunmins is not UNSET:
            grptresrunmins = []
            for componentsschemasv0_0_44_tres_list_item_data in _grptresrunmins:
                componentsschemasv0_0_44_tres_list_item = V0044Tres.from_dict(
                    componentsschemasv0_0_44_tres_list_item_data
                )
        ...
        if isinstance(_grpwall, Unset):
            ...
            grpwall = V0044Uint32NoValStruct.from_dict(_grpwall)
        ...
        if isinstance(_maxjobs, Unset):
            ...
            maxjobs = V0044Uint32NoValStruct.from_dict(_maxjobs)
        ...
        if isinstance(_maxjobsaccrue, Unset):
            ...
            maxjobsaccrue = V0044Uint32NoValStruct.from_dict(_maxjobsaccrue)
        ...
        if isinstance(_maxsubmitjobs, Unset):
            ...
            maxsubmitjobs = V0044Uint32NoValStruct.from_dict(_maxsubmitjobs)

        _maxtresminsperjob = d.pop("maxtresminsperjob", UNSET)
        maxtresminsperjob: list[V0044Tres] | Unset = UNSET
        if _maxtresminsperjob is not UNSET:
            maxtresminsperjob = []
            for componentsschemasv0_0_44_tres_list_item_data in _maxtresminsperjob:
                componentsschemasv0_0_44_tres_list_item = V0044Tres.from_dict(
                    componentsschemasv0_0_44_tres_list_item_data
                )
        ...
        if _maxtresrunmins is not UNSET:
            maxtresrunmins = []
            for componentsschemasv0_0_44_tres_list_item_data in _maxtresrunmins:
                componentsschemasv0_0_44_tres_list_item = V0044Tres.from_dict(
                    componentsschemasv0_0_44_tres_list_item_data
                )
        ...
        if _maxtresperjob is not UNSET:
            maxtresperjob = []
            for componentsschemasv0_0_44_tres_list_item_data in _maxtresperjob:
                componentsschemasv0_0_44_tres_list_item = V0044Tres.from_dict(
                    componentsschemasv0_0_44_tres_list_item_data
                )
        ...
        if _maxtrespernode is not UNSET:
            maxtrespernode = []
            for componentsschemasv0_0_44_tres_list_item_data in _maxtrespernode:
                componentsschemasv0_0_44_tres_list_item = V0044Tres.from_dict(
                    componentsschemasv0_0_44_tres_list_item_data
                )
        ...
        if isinstance(_maxwalldurationperjob, Unset):
            ...
            maxwalldurationperjob = V0044Uint32NoValStruct.from_dict(_maxwalldurationperjob)
        ...
        if isinstance(_minpriothresh, Unset):
            ...
            minpriothresh = V0044Uint32NoValStruct.from_dict(_minpriothresh)
        ...
        v0044_assoc_rec_set.additional_properties = d
        return v0044_assoc_rec_set
