...
from ...models.v0044_openapi_assocs_removed_resp import V0044OpenapiAssocsRemovedResp
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/slurmdb/v0.0.44/associations/",
        "params": params,
    }
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0044OpenapiAssocsRemovedResp:
    if response.status_code == 200:
        response_200 = V0044OpenapiAssocsRemovedResp.from_dict(response.json())

        return response_200

    response_default = V0044OpenapiAssocsRemovedResp.from_dict(response.json())
...
) -> Response[V0044OpenapiAssocsRemovedResp]:
    return Response(
...
def sync(
    *,
    ...
    usage_start: str | Unset = UNSET,
    user: str | Unset = UNSET,
) -> V0044OpenapiAssocsRemovedResp | None:
    """Delete associations
