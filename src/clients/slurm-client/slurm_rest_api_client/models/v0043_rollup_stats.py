...
class V0043RollupStats:
    """
    Attributes:
        hourly (V0043RollupStatsHourly | Unset):
        daily (V0043RollupStatsDaily | Unset):
        monthly (V0043RollupStatsMonthly | Unset):
    """

    hourly: V0043RollupStatsHourly | Unset = UNSET
    daily: V0043RollupStatsDaily | Unset = UNSET
    monthly: V0043RollupStatsMonthly | Unset = UNSET
