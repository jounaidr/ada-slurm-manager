...
class V0042Assoc:
    ...
    Attributes:
        ...
        default (V0042AssocDefault | Unset):
        flags (list[V0042AssocFlagsItem] | Unset):
        max_ (V0042AssocMax | Unset):
    ...
    default: V0042AssocDefault | Unset = UNSET
    flags: list[V0042AssocFlagsItem] | Unset = UNSET
    max_: V0042AssocMax | Unset = UNSET
    id: int | Unset = UNSET
    is_default: bool | Unset = UNSET
    lineage: str | Unset = UNSET
    min_: V0042AssocMin | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _flags is not UNSET:
            flags = []
            for componentsschemasv0_0_42_assoc_flags_item_data in _flags:
