...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespAssociationsItemMaxPerAccountWallClock")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespAssociationsItemMaxPerAccountWallClock:
    """GrpWall
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_associations_item_max_per_account_wall_clock = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_associations_item_max_per_account_wall_clock.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_associations_item_max_per_account_wall_clock
