...
T = TypeVar("T", bound="V0044OpenapiClustersRemovedResp")


@_attrs_define
class V0044OpenapiClustersRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_clusters_removed_resp = cls(
            deleted_clusters=deleted_clusters,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_clusters_removed_resp.additional_properties = d
        return v0044_openapi_clusters_removed_resp
