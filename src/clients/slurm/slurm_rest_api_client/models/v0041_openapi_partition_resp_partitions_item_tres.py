...
T = TypeVar("T", bound="V0041OpenapiPartitionRespPartitionsItemTres")


@_attrs_define
class V0041OpenapiPartitionRespPartitionsItemTres:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_partition_resp_partitions_item_tres = cls(
            billing_weights=billing_weights,
            configured=configured,
        )

        v0041_openapi_partition_resp_partitions_item_tres.additional_properties = d
        return v0041_openapi_partition_resp_partitions_item_tres
