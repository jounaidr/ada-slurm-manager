...
T = TypeVar("T", bound="SlurmdbV0041DeleteAccountResponseDefaultMetaPlugin")


@_attrs_define
class SlurmdbV0041DeleteAccountResponseDefaultMetaPlugin:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_delete_account_response_default_meta_plugin = cls(
            type_=type_,
            name=name,
        ...
        slurmdb_v0041_delete_account_response_default_meta_plugin.additional_properties = d
        return slurmdb_v0041_delete_account_response_default_meta_plugin
