...
class V0043JobTime:
    ...
    Attributes:
        ...
        eligible (int | Unset): Time when the job became eligible to run (UNIX timestamp) (UNIX timestamp or time string
            ...
            '[MM/DD[/YY]-]HH:MM[:SS]'))
        planned (V0043Uint64NoValStruct | Unset):
        ...
        system (V0043JobTimeSystem | Unset):
        limit (V0043Uint32NoValStruct | Unset):
        total (V0043JobTimeTotal | Unset):
        user (V0043JobTimeUser | Unset):
    """

    elapsed: int | Unset = UNSET
    eligible: int | Unset = UNSET
    end: int | Unset = UNSET
    planned: V0043Uint64NoValStruct | Unset = UNSET
    start: int | Unset = UNSET
    submission: int | Unset = UNSET
    suspended: int | Unset = UNSET
    system: V0043JobTimeSystem | Unset = UNSET
    limit: V0043Uint32NoValStruct | Unset = UNSET
    total: V0043JobTimeTotal | Unset = UNSET
    user: V0043JobTimeUser | Unset = UNSET
