...
if TYPE_CHECKING:
    ...
    from ..models.v0044_stats_msg import V0044StatsMsg


T = TypeVar("T", bound="V0044OpenapiDiagResp")


@_attrs_define
class V0044OpenapiDiagResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        statistics = V0044StatsMsg.from_dict(d.pop("statistics"))
        ...
        v0044_openapi_diag_resp.additional_properties = d
        return v0044_openapi_diag_resp
