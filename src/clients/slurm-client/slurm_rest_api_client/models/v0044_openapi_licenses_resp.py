...
if TYPE_CHECKING:
    from ..models.v0044_license import V0044License
...
T = TypeVar("T", bound="V0044OpenapiLicensesResp")


@_attrs_define
class V0044OpenapiLicensesResp:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        licenses = []
        for componentsschemasv0_0_44_licenses_item_data in self.licenses:
            componentsschemasv0_0_44_licenses_item = componentsschemasv0_0_44_licenses_item_data.to_dict()
            licenses.append(componentsschemasv0_0_44_licenses_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_44_licenses_item_data in _licenses:
            componentsschemasv0_0_44_licenses_item = V0044License.from_dict(componentsschemasv0_0_44_licenses_item_data)
        ...
        v0044_openapi_licenses_resp = cls(
            licenses=licenses,
            last_update=last_update,
            meta=meta,
            errors=errors,
        ...
        v0044_openapi_licenses_resp.additional_properties = d
        return v0044_openapi_licenses_resp
