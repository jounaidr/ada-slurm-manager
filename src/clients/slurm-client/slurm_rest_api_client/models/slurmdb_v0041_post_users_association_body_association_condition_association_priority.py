...
T = TypeVar("T", bound="SlurmdbV0041PostUsersAssociationBodyAssociationConditionAssociationPriority")


@_attrs_define
class SlurmdbV0041PostUsersAssociationBodyAssociationConditionAssociationPriority:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_post_users_association_body_association_condition_association_priority = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurmdb_v0041_post_users_association_body_association_condition_association_priority.additional_properties = d
        return slurmdb_v0041_post_users_association_body_association_condition_association_priority
