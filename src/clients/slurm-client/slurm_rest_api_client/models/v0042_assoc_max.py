...
class V0042AssocMax:
    """
    Attributes:
        jobs (V0042AssocMaxJobs | Unset):
        tres (V0042AssocMaxTres | Unset):
        per (V0042AssocMaxPer | Unset):
    """

    jobs: V0042AssocMaxJobs | Unset = UNSET
    tres: V0042AssocMaxTres | Unset = UNSET
    per: V0042AssocMaxPer | Unset = UNSET
