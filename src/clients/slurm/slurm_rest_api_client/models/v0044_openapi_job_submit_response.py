...
T = TypeVar("T", bound="V0044OpenapiJobSubmitResponse")


@_attrs_define
class V0044OpenapiJobSubmitResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_job_submit_response = cls(
            job_id=job_id,
            step_id=step_id,
        ...
        v0044_openapi_job_submit_response.additional_properties = d
        return v0044_openapi_job_submit_response
