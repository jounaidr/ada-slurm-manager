...
T = TypeVar("T", bound="V0044OpenapiHostnamesReqResp")


@_attrs_define
class V0044OpenapiHostnamesReqResp:
    """
    Attributes:
        hostnames (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_hostnames_req_resp = cls(
            hostnames=hostnames,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_hostnames_req_resp.additional_properties = d
        return v0044_openapi_hostnames_req_resp
