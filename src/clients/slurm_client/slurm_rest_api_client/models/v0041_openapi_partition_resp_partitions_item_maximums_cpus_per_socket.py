...
T = TypeVar("T", bound="V0041OpenapiPartitionRespPartitionsItemMaximumsCpusPerSocket")


@_attrs_define
class V0041OpenapiPartitionRespPartitionsItemMaximumsCpusPerSocket:
    """MaxCPUsPerSocket
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_partition_resp_partitions_item_maximums_cpus_per_socket = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_partition_resp_partitions_item_maximums_cpus_per_socket.additional_properties = d
        return v0041_openapi_partition_resp_partitions_item_maximums_cpus_per_socket
