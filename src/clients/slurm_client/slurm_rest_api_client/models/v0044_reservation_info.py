...
from ..models.v0044_reservation_info_flags_item import V0044ReservationInfoFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_reservation_core_spec import V0044ReservationCoreSpec
    from ..models.v0044_reservation_info_purge_completed import V0044ReservationInfoPurgeCompleted
...
T = TypeVar("T", bound="V0044ReservationInfo")


@_attrs_define
class V0044ReservationInfo:
    """
    Attributes:
        ...
        core_specializations (list[V0044ReservationCoreSpec] | Unset):
        ...
        flags (list[V0044ReservationInfoFlagsItem] | Unset): Flags associated with this reservation
        ...
        purge_completed (V0044ReservationInfoPurgeCompleted | Unset):
        start_time (V0044Uint64NoValStruct | Unset):
        watts (V0044Uint32NoValStruct | Unset):
    ...
    core_specializations: list[V0044ReservationCoreSpec] | Unset = UNSET
    end_time: V0044Uint64NoValStruct | Unset = UNSET
    features: str | Unset = UNSET
    flags: list[V0044ReservationInfoFlagsItem] | Unset = UNSET
    ...
    purge_completed: V0044ReservationInfoPurgeCompleted | Unset = UNSET
    start_time: V0044Uint64NoValStruct | Unset = UNSET
    watts: V0044Uint32NoValStruct | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.core_specializations, Unset):
            ...
            for componentsschemasv0_0_44_reservation_info_core_spec_item_data in self.core_specializations:
                componentsschemasv0_0_44_reservation_info_core_spec_item = (
                    componentsschemasv0_0_44_reservation_info_core_spec_item_data.to_dict()
                )
                core_specializations.append(componentsschemasv0_0_44_reservation_info_core_spec_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _core_specializations is not UNSET:
            core_specializations = []
            for componentsschemasv0_0_44_reservation_info_core_spec_item_data in _core_specializations:
                componentsschemasv0_0_44_reservation_info_core_spec_item = V0044ReservationCoreSpec.from_dict(
                    componentsschemasv0_0_44_reservation_info_core_spec_item_data
                )
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044ReservationInfoFlagsItem(flags_item_data)
        ...
        if isinstance(_purge_completed, Unset):
            ...
            purge_completed = V0044ReservationInfoPurgeCompleted.from_dict(_purge_completed)
        ...
        if isinstance(_watts, Unset):
            ...
            watts = V0044Uint32NoValStruct.from_dict(_watts)

        tres = d.pop("tres", UNSET)

        users = d.pop("users", UNSET)

        v0044_reservation_info = cls(
            accounts=accounts,
        ...
        v0044_reservation_info.additional_properties = d
        return v0044_reservation_info
