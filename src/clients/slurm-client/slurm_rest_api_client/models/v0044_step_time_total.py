...
T = TypeVar("T", bound="V0044StepTimeTotal")


@_attrs_define
class V0044StepTimeTotal:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_step_time_total = cls(
            seconds=seconds,
            microseconds=microseconds,
        )

        v0044_step_time_total.additional_properties = d
        return v0044_step_time_total
