...
if TYPE_CHECKING:
    from ..models.v0044_partition_info_maximums_oversubscribe import V0044PartitionInfoMaximumsOversubscribe
...
T = TypeVar("T", bound="V0044PartitionInfoMaximums")


@_attrs_define
class V0044PartitionInfoMaximums:
    """
    Attributes:
        cpus_per_node (V0044Uint32NoValStruct | Unset):
        cpus_per_socket (V0044Uint32NoValStruct | Unset):
        memory_per_cpu (int | Unset): Raw value for MaxMemPerCPU or MaxMemPerNode
        partition_memory_per_cpu (V0044Uint64NoValStruct | Unset):
        partition_memory_per_node (V0044Uint64NoValStruct | Unset):
        nodes (V0044Uint32NoValStruct | Unset):
        shares (int | Unset): OverSubscribe - Controls the ability of the partition to execute more than one job at a
            time on each resource
        oversubscribe (V0044PartitionInfoMaximumsOversubscribe | Unset):
        time (V0044Uint32NoValStruct | Unset):
        over_time_limit (V0044Uint16NoValStruct | Unset):
    """

    cpus_per_node: V0044Uint32NoValStruct | Unset = UNSET
    cpus_per_socket: V0044Uint32NoValStruct | Unset = UNSET
    ...
    nodes: V0044Uint32NoValStruct | Unset = UNSET
    shares: int | Unset = UNSET
    oversubscribe: V0044PartitionInfoMaximumsOversubscribe | Unset = UNSET
    time: V0044Uint32NoValStruct | Unset = UNSET
    over_time_limit: V0044Uint16NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_cpus_per_node, Unset):
            ...
            cpus_per_node = V0044Uint32NoValStruct.from_dict(_cpus_per_node)
        ...
        if isinstance(_cpus_per_socket, Unset):
            ...
            cpus_per_socket = V0044Uint32NoValStruct.from_dict(_cpus_per_socket)
        ...
        if isinstance(_nodes, Unset):
            ...
            nodes = V0044Uint32NoValStruct.from_dict(_nodes)
        ...
        if isinstance(_oversubscribe, Unset):
            ...
            oversubscribe = V0044PartitionInfoMaximumsOversubscribe.from_dict(_oversubscribe)
        ...
        if isinstance(_over_time_limit, Unset):
            ...
            over_time_limit = V0044Uint16NoValStruct.from_dict(_over_time_limit)

        v0044_partition_info_maximums = cls(
        ...
        v0044_partition_info_maximums.additional_properties = d
        return v0044_partition_info_maximums
