...
T = TypeVar("T", bound="V0044AssocMaxJobsPer")


@_attrs_define
class V0044AssocMaxJobsPer:
    """
    Attributes:
        count (V0044Uint32NoValStruct | Unset):
        accruing (V0044Uint32NoValStruct | Unset):
        submitted (V0044Uint32NoValStruct | Unset):
        wall_clock (V0044Uint32NoValStruct | Unset):
    """

    count: V0044Uint32NoValStruct | Unset = UNSET
    accruing: V0044Uint32NoValStruct | Unset = UNSET
    submitted: V0044Uint32NoValStruct | Unset = UNSET
    wall_clock: V0044Uint32NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_submitted, Unset):
            ...
            submitted = V0044Uint32NoValStruct.from_dict(_submitted)
        ...
        if isinstance(_wall_clock, Unset):
            ...
            wall_clock = V0044Uint32NoValStruct.from_dict(_wall_clock)

        v0044_assoc_max_jobs_per = cls(
            count=count,
            accruing=accruing,
            submitted=submitted,
        ...
        v0044_assoc_max_jobs_per.additional_properties = d
        return v0044_assoc_max_jobs_per
