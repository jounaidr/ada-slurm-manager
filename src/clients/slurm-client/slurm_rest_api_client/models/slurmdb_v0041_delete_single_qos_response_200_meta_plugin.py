...
T = TypeVar("T", bound="SlurmdbV0041DeleteSingleQosResponse200MetaPlugin")


@_attrs_define
class SlurmdbV0041DeleteSingleQosResponse200MetaPlugin:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_delete_single_qos_response_200_meta_plugin = cls(
            type_=type_,
            name=name,
        ...
        slurmdb_v0041_delete_single_qos_response_200_meta_plugin.additional_properties = d
        return slurmdb_v0041_delete_single_qos_response_200_meta_plugin
