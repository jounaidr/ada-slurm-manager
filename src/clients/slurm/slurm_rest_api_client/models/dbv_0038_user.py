...
if TYPE_CHECKING:
    ...
    from ..models.dbv_0038_coordinator_info import Dbv0038CoordinatorInfo
    from ..models.dbv_0038_user_default import Dbv0038UserDefault


T = TypeVar("T", bound="Dbv0038User")
...
class Dbv0038User:
    ...
    Attributes:
        ...
        associations (list[Dbv0038AssociationShortInfo] | Unset): Assigned associations
        coordinators (list[Dbv0038CoordinatorInfo] | Unset): List of assigned coordinators
        default (Dbv0038UserDefault | Unset): Default settings
        flags (list[str] | Unset): List of properties of user
        name (str | Unset): User name
    """

    administrator_level: str | Unset = UNSET
    associations: list[Dbv0038AssociationShortInfo] | Unset = UNSET
    coordinators: list[Dbv0038CoordinatorInfo] | Unset = UNSET
    default: Dbv0038UserDefault | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _associations is not UNSET:
            ...
            for associations_item_data in _associations:
                associations_item = Dbv0038AssociationShortInfo.from_dict(associations_item_data)
        ...
        if _coordinators is not UNSET:
            ...
            for coordinators_item_data in _coordinators:
                coordinators_item = Dbv0038CoordinatorInfo.from_dict(coordinators_item_data)

                coordinators.append(coordinators_item)

        _default = d.pop("default", UNSET)
        default: Dbv0038UserDefault | Unset
        if isinstance(_default, Unset):
            default = UNSET
        else:
            default = Dbv0038UserDefault.from_dict(_default)
        ...
        dbv_0038_user.additional_properties = d
        return dbv_0038_user
