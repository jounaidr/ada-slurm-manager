...
T = TypeVar("T", bound="Dbv0037DiagStatisticsRollupsItem")


@_attrs_define
class Dbv0037DiagStatisticsRollupsItem:
    """Rollup statistics
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0037_diag_statistics_rollups_item = cls(
            type_=type_,
            last_run=last_run,
        ...
        dbv_0037_diag_statistics_rollups_item.additional_properties = d
        return dbv_0037_diag_statistics_rollups_item
