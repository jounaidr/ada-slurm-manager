...
T = TypeVar("T", bound="V0044OpenapiAccountsResp")


@_attrs_define
class V0044OpenapiAccountsResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_accounts_resp = cls(
            accounts=accounts,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_accounts_resp.additional_properties = d
        return v0044_openapi_accounts_resp
