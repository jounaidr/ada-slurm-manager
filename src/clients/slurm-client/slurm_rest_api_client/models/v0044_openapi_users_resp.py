...
T = TypeVar("T", bound="V0044OpenapiUsersResp")


@_attrs_define
class V0044OpenapiUsersResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_44_user_list_item_data in _users:
            componentsschemasv0_0_44_user_list_item = V0044User.from_dict(componentsschemasv0_0_44_user_list_item_data)
        ...
        v0044_openapi_users_resp.additional_properties = d
        return v0044_openapi_users_resp
