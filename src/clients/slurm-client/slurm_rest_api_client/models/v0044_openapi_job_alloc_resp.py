...
T = TypeVar("T", bound="V0044OpenapiJobAllocResp")


@_attrs_define
class V0044OpenapiJobAllocResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_job_alloc_resp = cls(
            job_id=job_id,
        ...
        v0044_openapi_job_alloc_resp.additional_properties = d
        return v0044_openapi_job_alloc_resp
