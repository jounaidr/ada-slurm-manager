...
from ..models.v0044_node_cert_flags_item import V0044NodeCertFlagsItem
from ..models.v0044_node_next_state_after_reboot_item import V0044NodeNextStateAfterRebootItem
from ..models.v0044_node_state_item import V0044NodeStateItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_acct_gather_energy import V0044AcctGatherEnergy
    from ..models.v0044_node_external_sensors import V0044NodeExternalSensors
    from ..models.v0044_node_power import V0044NodePower
    from ..models.v0044_uint_64_no_val_struct import V0044Uint64NoValStruct


T = TypeVar("T", bound="V0044Node")
...
class V0044Node:
    ...
    Attributes:
        ...
        boot_time (V0044Uint64NoValStruct | Unset):
        tls_cert_last_renewal (V0044Uint64NoValStruct | Unset):
        cert_flags (list[V0044NodeCertFlagsItem] | Unset): Certmgr status flags
        ...
        free_mem (V0044Uint64NoValStruct | Unset):
        ...
        specialized_cpus (str | Unset): Abstract CPU IDs on this node reserved for exclusive use by slurmd and
            slurmstepd
        energy (V0044AcctGatherEnergy | Unset):
        external_sensors (V0044NodeExternalSensors | Unset):
        extra (str | Unset): Arbitrary string used for node filtering if extra constraints are enabled
        power (V0044NodePower | Unset):
        ...
        last_busy (V0044Uint64NoValStruct | Unset):
        ...
        next_state_after_reboot (list[V0044NodeNextStateAfterRebootItem] | Unset): The state the node will be assigned
            after rebooting
        address (str | Unset): NodeAddr, used to establish a communication path
        hostname (str | Unset): NodeHostname
        state (list[V0044NodeStateItem] | Unset): Node state(s) applicable to this node
        ...
        reason_changed_at (V0044Uint64NoValStruct | Unset):
        reason_set_by_user (str | Unset): User who set the reason
        resume_after (V0044Uint64NoValStruct | Unset):
        ...
        slurmd_start_time (V0044Uint64NoValStruct | Unset):
    ...
    boot_time: V0044Uint64NoValStruct | Unset = UNSET
    tls_cert_last_renewal: V0044Uint64NoValStruct | Unset = UNSET
    cert_flags: list[V0044NodeCertFlagsItem] | Unset = UNSET
    ...
    free_mem: V0044Uint64NoValStruct | Unset = UNSET
    cpus: int | Unset = UNSET
    effective_cpus: int | Unset = UNSET
    specialized_cpus: str | Unset = UNSET
    energy: V0044AcctGatherEnergy | Unset = UNSET
    external_sensors: V0044NodeExternalSensors | Unset = UNSET
    extra: str | Unset = UNSET
    power: V0044NodePower | Unset = UNSET
    ...
    last_busy: V0044Uint64NoValStruct | Unset = UNSET
    mcs_label: str | Unset = UNSET
    specialized_memory: int | Unset = UNSET
    name: str | Unset = UNSET
    next_state_after_reboot: list[V0044NodeNextStateAfterRebootItem] | Unset = UNSET
    address: str | Unset = UNSET
    hostname: str | Unset = UNSET
    state: list[V0044NodeStateItem] | Unset = UNSET
    ...
    reason_changed_at: V0044Uint64NoValStruct | Unset = UNSET
    reason_set_by_user: str | Unset = UNSET
    resume_after: V0044Uint64NoValStruct | Unset = UNSET
    ...
    slurmd_start_time: V0044Uint64NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_boot_time, Unset):
            ...
            boot_time = V0044Uint64NoValStruct.from_dict(_boot_time)
        ...
        if isinstance(_tls_cert_last_renewal, Unset):
            ...
            tls_cert_last_renewal = V0044Uint64NoValStruct.from_dict(_tls_cert_last_renewal)
        ...
        if _cert_flags is not UNSET:
            ...
            for cert_flags_item_data in _cert_flags:
                cert_flags_item = V0044NodeCertFlagsItem(cert_flags_item_data)
        ...
        if isinstance(_free_mem, Unset):
            ...
            free_mem = V0044Uint64NoValStruct.from_dict(_free_mem)
        ...
        if isinstance(_energy, Unset):
            ...
            energy = V0044AcctGatherEnergy.from_dict(_energy)
        ...
        if isinstance(_external_sensors, Unset):
            ...
            external_sensors = V0044NodeExternalSensors.from_dict(_external_sensors)
        ...
        if isinstance(_power, Unset):
            ...
            power = V0044NodePower.from_dict(_power)
        ...
        if isinstance(_last_busy, Unset):
            ...
            last_busy = V0044Uint64NoValStruct.from_dict(_last_busy)
        ...
        if _next_state_after_reboot is not UNSET:
            ...
            for next_state_after_reboot_item_data in _next_state_after_reboot:
                next_state_after_reboot_item = V0044NodeNextStateAfterRebootItem(next_state_after_reboot_item_data)
        ...
        if _state is not UNSET:
            ...
            for state_item_data in _state:
                state_item = V0044NodeStateItem(state_item_data)
        ...
        if isinstance(_reason_changed_at, Unset):
            ...
            reason_changed_at = V0044Uint64NoValStruct.from_dict(_reason_changed_at)
        ...
        if isinstance(_resume_after, Unset):
            ...
            resume_after = V0044Uint64NoValStruct.from_dict(_resume_after)
        ...
        if isinstance(_slurmd_start_time, Unset):
            ...
            slurmd_start_time = V0044Uint64NoValStruct.from_dict(_slurmd_start_time)
        ...
        v0044_node.additional_properties = d
        return v0044_node
