...
T = TypeVar("T", bound="Dbv0037JobTres")


@_attrs_define
class Dbv0037JobTres:
    """TRES settings

    Attributes:
        allocated (list[Dbv0037TresListItem] | Unset): TRES list of attributes
        requested (list[Dbv0037TresListItem] | Unset): TRES list of attributes
    """

    allocated: list[Dbv0037TresListItem] | Unset = UNSET
    requested: list[Dbv0037TresListItem] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.requested, Unset):
            requested = []
            for componentsschemasdbv0_0_37_tres_list_item_data in self.requested:
                componentsschemasdbv0_0_37_tres_list_item = componentsschemasdbv0_0_37_tres_list_item_data.to_dict()
                requested.append(componentsschemasdbv0_0_37_tres_list_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _requested is not UNSET:
            requested = []
            for componentsschemasdbv0_0_37_tres_list_item_data in _requested:
                componentsschemasdbv0_0_37_tres_list_item = Dbv0037TresListItem.from_dict(
                    componentsschemasdbv0_0_37_tres_list_item_data
                )
        ...
        dbv_0037_job_tres = cls(
            allocated=allocated,
            requested=requested,
        )

        dbv_0037_job_tres.additional_properties = d
        return dbv_0037_job_tres
