...
T = TypeVar("T", bound="V0041OpenapiReservationRespReservationsItemPurgeCompletedTime")


@_attrs_define
class V0041OpenapiReservationRespReservationsItemPurgeCompletedTime:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_reservation_resp_reservations_item_purge_completed_time = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_reservation_resp_reservations_item_purge_completed_time.additional_properties = d
        return v0041_openapi_reservation_resp_reservations_item_purge_completed_time
