...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespQosItemLimitsMaxJobsPerUser")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespQosItemLimitsMaxJobsPerUser:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_qos_item_limits_max_jobs_per_user = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_qos_item_limits_max_jobs_per_user.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_qos_item_limits_max_jobs_per_user
