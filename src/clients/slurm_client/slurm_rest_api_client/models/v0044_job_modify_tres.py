...
T = TypeVar("T", bound="V0044JobModifyTres")


@_attrs_define
class V0044JobModifyTres:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_job_modify_tres = cls(
            allocated=allocated,
        )

        v0044_job_modify_tres.additional_properties = d
        return v0044_job_modify_tres
