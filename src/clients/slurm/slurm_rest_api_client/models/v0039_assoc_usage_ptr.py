...
T = TypeVar("T", bound="V0039AssocUsagePtr")


@_attrs_define
class V0039AssocUsagePtr:
    """
    Attributes:
        accrue_job_count (int | Unset):
        group_used_wallclock (float | Unset):
        fairshare_factor (float | Unset):
        fairshare_shares (int | Unset):
        normalized_priority (float | Unset):
        normalized_shares (float | Unset):
        effective_normalized_usage (float | Unset):
        normalized_usage (float | Unset):
        raw_usage (float | Unset):
        active_jobs (int | Unset):
        job_count (int | Unset):
        fairshare_level (float | Unset):
    """
    ...
    normalized_priority: float | Unset = UNSET
    normalized_shares: float | Unset = UNSET
    effective_normalized_usage: float | Unset = UNSET
    normalized_usage: float | Unset = UNSET
    raw_usage: float | Unset = UNSET
    active_jobs: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if normalized_usage is not UNSET:
            field_dict["normalized_usage"] = normalized_usage
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        normalized_usage = d.pop("normalized_usage", UNSET)
        ...
        v0039_assoc_usage_ptr.additional_properties = d
        return v0039_assoc_usage_ptr
