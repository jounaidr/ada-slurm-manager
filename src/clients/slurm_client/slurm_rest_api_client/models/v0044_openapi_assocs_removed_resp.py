...
T = TypeVar("T", bound="V0044OpenapiAssocsRemovedResp")


@_attrs_define
class V0044OpenapiAssocsRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_assocs_removed_resp = cls(
            removed_associations=removed_associations,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_assocs_removed_resp.additional_properties = d
        return v0044_openapi_assocs_removed_resp
