...
T = TypeVar("T", bound="Dbv0038ResponseClusterAdd")
...
class Dbv0038ResponseClusterAdd:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_response_cluster_add = cls(
            meta=meta,
            errors=errors,
        )

        dbv_0038_response_cluster_add.additional_properties = d
        return dbv_0038_response_cluster_add
