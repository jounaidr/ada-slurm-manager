...
from ..models.v0044_kill_jobs_msg_flags_item import V0044KillJobsMsgFlagsItem
from ..models.v0044_kill_jobs_msg_job_state_item import V0044KillJobsMsgJobStateItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="V0044KillJobsMsg")


@_attrs_define
class V0044KillJobsMsg:
    """
    Attributes:
        account (str | Unset): Filter jobs to a specific account
        flags (list[V0044KillJobsMsgFlagsItem] | Unset): Filter jobs according to flags
        ...
        job_state (list[V0044KillJobsMsgJobStateItem] | Unset): Filter jobs to a specific state
    ...
    flags: list[V0044KillJobsMsgFlagsItem] | Unset = UNSET
    ...
    job_state: list[V0044KillJobsMsgJobStateItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044KillJobsMsgFlagsItem(flags_item_data)
        ...
        if _job_state is not UNSET:
            ...
            for job_state_item_data in _job_state:
                job_state_item = V0044KillJobsMsgJobStateItem(job_state_item_data)
        ...
        v0044_kill_jobs_msg.additional_properties = d
        return v0044_kill_jobs_msg
