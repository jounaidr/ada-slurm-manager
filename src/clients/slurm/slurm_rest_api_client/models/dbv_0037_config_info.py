...
if TYPE_CHECKING:
    ...
    from ..models.dbv_0037_association import Dbv0037Association
...
T = TypeVar("T", bound="Dbv0037ConfigInfo")
...
class Dbv0037ConfigInfo:
    ...
    Attributes:
        ...
        accounts (list[Dbv0037Account] | Unset): Array of accounts
        associations (list[Dbv0037Association] | Unset): Array of associations
        users (list[Dbv0037User] | Unset): Array of users
        qos (list[Dbv0037Qos] | Unset): Array of qos
        wckeys (list[Dbv0037Wckey] | Unset): Array of wckeys
    """
    ...
    associations: list[Dbv0037Association] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _associations is not UNSET:
            ...
            for associations_item_data in _associations:
                associations_item = Dbv0037Association.from_dict(associations_item_data)
        ...
        dbv_0037_config_info.additional_properties = d
        return dbv_0037_config_info
