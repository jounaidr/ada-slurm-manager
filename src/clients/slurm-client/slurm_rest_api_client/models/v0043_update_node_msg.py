...
class V0043UpdateNodeMsg:
    ...
    Attributes:
        ...
        name (list[str] | Unset):
        state (list[V0043UpdateNodeMsgStateItem] | Unset): New state to assign to the node
        ...
        resume_after (V0043Uint32NoValStruct | Unset):
        topology_str (str | Unset): Topology
        weight (V0043Uint32NoValStruct | Unset):
    """
    ...
    state: list[V0043UpdateNodeMsgStateItem] | Unset = UNSET
    reason: str | Unset = UNSET
    reason_uid: str | Unset = UNSET
    resume_after: V0043Uint32NoValStruct | Unset = UNSET
    topology_str: str | Unset = UNSET
    weight: V0043Uint32NoValStruct | Unset = UNSET
