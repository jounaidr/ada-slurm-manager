...
T = TypeVar("T", bound="V0044OpenapiMetaSlurmVersion")


@_attrs_define
class V0044OpenapiMetaSlurmVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_meta_slurm_version = cls(
            major=major,
            micro=micro,
            minor=minor,
        )

        v0044_openapi_meta_slurm_version.additional_properties = d
        return v0044_openapi_meta_slurm_version
