...
from ...models.v0038_nodes_response import V0038NodesResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/slurm/v0.0.38/node/{node_name}".format(
...
) -> V0038NodesResponse | list[V0038Error]:
    if response.status_code == 200:
        response_200 = V0038NodesResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[V0038NodesResponse | list[V0038Error]]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> V0038NodesResponse | list[V0038Error] | None:
    """get node info
