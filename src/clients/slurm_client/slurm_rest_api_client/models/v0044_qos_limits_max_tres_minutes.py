...
if TYPE_CHECKING:
    from ..models.v0044_qos_limits_max_tres_minutes_per import V0044QosLimitsMaxTresMinutesPer
    from ..models.v0044_tres import V0044Tres


T = TypeVar("T", bound="V0044QosLimitsMaxTresMinutes")


@_attrs_define
class V0044QosLimitsMaxTresMinutes:
    """
    Attributes:
        total (list[V0044Tres] | Unset):
        per (V0044QosLimitsMaxTresMinutesPer | Unset):
    """

    total: list[V0044Tres] | Unset = UNSET
    per: V0044QosLimitsMaxTresMinutesPer | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_per, Unset):
            ...
            per = V0044QosLimitsMaxTresMinutesPer.from_dict(_per)

        v0044_qos_limits_max_tres_minutes = cls(
            total=total,
            per=per,
        )

        v0044_qos_limits_max_tres_minutes.additional_properties = d
        return v0044_qos_limits_max_tres_minutes
