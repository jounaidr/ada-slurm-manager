...
T = TypeVar("T", bound="V0044OpenapiAssocsResp")


@_attrs_define
class V0044OpenapiAssocsResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_assocs_resp.additional_properties = d
        return v0044_openapi_assocs_resp
