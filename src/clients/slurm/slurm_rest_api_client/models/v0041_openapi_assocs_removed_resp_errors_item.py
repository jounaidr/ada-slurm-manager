...
T = TypeVar("T", bound="V0041OpenapiAssocsRemovedRespErrorsItem")


@_attrs_define
class V0041OpenapiAssocsRemovedRespErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_assocs_removed_resp_errors_item = cls(
        ...
        v0041_openapi_assocs_removed_resp_errors_item.additional_properties = d
        return v0041_openapi_assocs_removed_resp_errors_item
