...
class V0043QosLimitsMin:
    """
    Attributes:
        priority_threshold (V0043Uint32NoValStruct | Unset):
        tres (V0043QosLimitsMinTres | Unset):
    """

    priority_threshold: V0043Uint32NoValStruct | Unset = UNSET
    tres: V0043QosLimitsMinTres | Unset = UNSET
