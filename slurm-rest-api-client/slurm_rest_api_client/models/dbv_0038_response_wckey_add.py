...
T = TypeVar("T", bound="Dbv0038ResponseWckeyAdd")
...
class Dbv0038ResponseWckeyAdd:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_response_wckey_add = cls(
            meta=meta,
            errors=errors,
        )

        dbv_0038_response_wckey_add.additional_properties = d
        return dbv_0038_response_wckey_add
