...
from ...models.slurm_v0044_get_nodes_flags import SlurmV0044GetNodesFlags
...
def _get_kwargs(
    *,
    ...
    flags: SlurmV0044GetNodesFlags | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (SlurmV0044GetNodesFlags | Unset):
