...
T = TypeVar("T", bound="SlurmV0041GetLicensesResponseDefaultErrorsItem")


@_attrs_define
class SlurmV0041GetLicensesResponseDefaultErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_licenses_response_default_errors_item = cls(
        ...
        slurm_v0041_get_licenses_response_default_errors_item.additional_properties = d
        return slurm_v0041_get_licenses_response_default_errors_item
