...
class V0043StepStatistics:
    """
    Attributes:
        cpu (V0043StepStatisticsCPU | Unset):
        energy (V0043StepStatisticsEnergy | Unset):
    """

    cpu: V0043StepStatisticsCPU | Unset = UNSET
    energy: V0043StepStatisticsEnergy | Unset = UNSET
