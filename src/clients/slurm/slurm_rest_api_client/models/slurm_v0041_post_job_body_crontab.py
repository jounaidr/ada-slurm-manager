...
from ..models.slurm_v0041_post_job_body_crontab_flags_item import SlurmV0041PostJobBodyCrontabFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.slurm_v0041_post_job_body_crontab_line import SlurmV0041PostJobBodyCrontabLine


T = TypeVar("T", bound="SlurmV0041PostJobBodyCrontab")


@_attrs_define
class SlurmV0041PostJobBodyCrontab:
    """Specification for scrontab job

    Attributes:
        flags (list[SlurmV0041PostJobBodyCrontabFlagsItem] | Unset): Flags
        ...
        line (SlurmV0041PostJobBodyCrontabLine | Unset):
    """

    flags: list[SlurmV0041PostJobBodyCrontabFlagsItem] | Unset = UNSET
    ...
    line: SlurmV0041PostJobBodyCrontabLine | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = SlurmV0041PostJobBodyCrontabFlagsItem(flags_item_data)
        ...
        if isinstance(_line, Unset):
            ...
            line = SlurmV0041PostJobBodyCrontabLine.from_dict(_line)

        slurm_v0041_post_job_body_crontab = cls(
            flags=flags,
            minute=minute,
            hour=hour,
        ...
        slurm_v0041_post_job_body_crontab.additional_properties = d
        return slurm_v0041_post_job_body_crontab
