...
class V0043StepTres:
    """
    Attributes:
        requested (V0043StepTresRequested | Unset):
        consumed (V0043StepTresConsumed | Unset):
        allocated (list[V0043Tres] | Unset):
    """

    requested: V0043StepTresRequested | Unset = UNSET
    consumed: V0043StepTresConsumed | Unset = UNSET
    allocated: list[V0043Tres] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _allocated is not UNSET:
            allocated = []
            for componentsschemasv0_0_43_tres_list_item_data in _allocated:
