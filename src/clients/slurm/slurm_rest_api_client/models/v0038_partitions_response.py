...
if TYPE_CHECKING:
    ...
    from ..models.v0038_partition import V0038Partition


T = TypeVar("T", bound="V0038PartitionsResponse")
...
class V0038PartitionsResponse:
    ...
    Attributes:
        ...
        partitions (list[V0038Partition] | Unset): partition info
    """

    meta: V0038Meta | Unset = UNSET
    errors: list[V0038Error] | Unset = UNSET
    partitions: list[V0038Partition] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _partitions is not UNSET:
            ...
            for partitions_item_data in _partitions:
                partitions_item = V0038Partition.from_dict(partitions_item_data)

                partitions.append(partitions_item)

        v0038_partitions_response = cls(
            meta=meta,
            errors=errors,
            partitions=partitions,
        )

        v0038_partitions_response.additional_properties = d
        return v0038_partitions_response
