...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespQosItemLimitsMinPriorityThreshold")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespQosItemLimitsMinPriorityThreshold:
    """MinPrioThreshold
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_qos_item_limits_min_priority_threshold = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_qos_item_limits_min_priority_threshold.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_qos_item_limits_min_priority_threshold
