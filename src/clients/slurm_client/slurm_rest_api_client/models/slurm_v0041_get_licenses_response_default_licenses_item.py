...
T = TypeVar("T", bound="SlurmV0041GetLicensesResponseDefaultLicensesItem")


@_attrs_define
class SlurmV0041GetLicensesResponseDefaultLicensesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_licenses_response_default_licenses_item = cls(
        ...
        slurm_v0041_get_licenses_response_default_licenses_item.additional_properties = d
        return slurm_v0041_get_licenses_response_default_licenses_item
