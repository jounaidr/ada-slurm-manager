...
T = TypeVar("T", bound="Dbv0037AssociationMin")


@_attrs_define
class Dbv0037AssociationMin:
    """Min settings
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0037_association_min = cls(
            priority_threshold=priority_threshold,
        )

        dbv_0037_association_min.additional_properties = d
        return dbv_0037_association_min
