...
T = TypeVar("T", bound="V0041OpenapiAssocsRespAssociationsItemMaxJobsActive")


@_attrs_define
class V0041OpenapiAssocsRespAssociationsItemMaxJobsActive:
    """MaxJobs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_assocs_resp_associations_item_max_jobs_active = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_assocs_resp_associations_item_max_jobs_active.additional_properties = d
        return v0041_openapi_assocs_resp_associations_item_max_jobs_active
