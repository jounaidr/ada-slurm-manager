...
T = TypeVar("T", bound="SlurmdbV0041PostUsersAssociationBodyErrorsItem")


@_attrs_define
class SlurmdbV0041PostUsersAssociationBodyErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_post_users_association_body_errors_item = cls(
        ...
        slurmdb_v0041_post_users_association_body_errors_item.additional_properties = d
        return slurmdb_v0041_post_users_association_body_errors_item
