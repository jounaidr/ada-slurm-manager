...
T = TypeVar("T", bound="Dbv0038UpdateAccount")
...
class Dbv0038UpdateAccount:
    """
    Attributes:
        accounts (list[Dbv0038Account] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_update_account = cls(
            accounts=accounts,
        )

        dbv_0038_update_account.additional_properties = d
        return dbv_0038_update_account
