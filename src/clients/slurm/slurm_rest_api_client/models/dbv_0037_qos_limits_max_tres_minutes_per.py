...
T = TypeVar("T", bound="Dbv0037QosLimitsMaxTresMinutesPer")


@_attrs_define
class Dbv0037QosLimitsMaxTresMinutesPer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0037_qos_limits_max_tres_minutes_per = cls(
            job=job,
            account=account,
            user=user,
        )

        dbv_0037_qos_limits_max_tres_minutes_per.additional_properties = d
        return dbv_0037_qos_limits_max_tres_minutes_per
