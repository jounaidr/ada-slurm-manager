...
T = TypeVar("T", bound="SlurmV0041GetSharesResponse200ErrorsItem")


@_attrs_define
class SlurmV0041GetSharesResponse200ErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_shares_response_200_errors_item = cls(
        ...
        slurm_v0041_get_shares_response_200_errors_item.additional_properties = d
        return slurm_v0041_get_shares_response_200_errors_item
