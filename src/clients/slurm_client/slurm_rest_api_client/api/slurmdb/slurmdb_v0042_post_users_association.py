...
def _get_kwargs(
    *,
    body: V0042OpenapiUsersAddCondResp | Unset = UNSET,
    update_time: str | Unset = UNSET,
    flags: SlurmdbV0042PostUsersAssociationFlags | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    response_default = V0042OpenapiUsersAddCondRespStr.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (SlurmdbV0042PostUsersAssociationFlags | Unset):
        body (V0042OpenapiUsersAddCondResp | Unset):
...
def sync(
    *,
    ...
    update_time: str | Unset = UNSET,
    flags: SlurmdbV0042PostUsersAssociationFlags | Unset = UNSET,
) -> V0042OpenapiUsersAddCondRespStr | None:
    """Add users with conditional association
