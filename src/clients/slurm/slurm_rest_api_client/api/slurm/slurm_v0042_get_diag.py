...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiDiagResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiDiagResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiDiagResp.from_dict(response.json())
