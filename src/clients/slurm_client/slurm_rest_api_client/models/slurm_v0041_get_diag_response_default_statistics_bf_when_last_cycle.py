...
T = TypeVar("T", bound="SlurmV0041GetDiagResponseDefaultStatisticsBfWhenLastCycle")


@_attrs_define
class SlurmV0041GetDiagResponseDefaultStatisticsBfWhenLastCycle:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_diag_response_default_statistics_bf_when_last_cycle = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_get_diag_response_default_statistics_bf_when_last_cycle.additional_properties = d
        return slurm_v0041_get_diag_response_default_statistics_bf_when_last_cycle
