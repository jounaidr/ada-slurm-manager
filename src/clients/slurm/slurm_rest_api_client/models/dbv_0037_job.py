...
if TYPE_CHECKING:
    ...
    from ..models.dbv_0037_job_array import Dbv0037JobArray
    from ..models.dbv_0037_job_comment import Dbv0037JobComment
    from ..models.dbv_0037_job_exit_code import Dbv0037JobExitCode
    from ..models.dbv_0037_job_het import Dbv0037JobHet
    from ..models.dbv_0037_job_mcs import Dbv0037JobMcs
    from ..models.dbv_0037_job_required import Dbv0037JobRequired
    from ..models.dbv_0037_job_reservation import Dbv0037JobReservation
    from ..models.dbv_0037_job_state import Dbv0037JobState
    from ..models.dbv_0037_job_step import Dbv0037JobStep
    from ..models.dbv_0037_job_time import Dbv0037JobTime
    from ..models.dbv_0037_job_tres import Dbv0037JobTres
    from ..models.dbv_0037_job_wckey import Dbv0037JobWckey


T = TypeVar("T", bound="Dbv0037Job")
...
class Dbv0037Job:
    ...
    Attributes:
        ...
        comment (Dbv0037JobComment | Unset): Job comments by type
        allocation_nodes (str | Unset): Nodes allocated to job
        array (Dbv0037JobArray | Unset): Array properties (optional)
        time (Dbv0037JobTime | Unset): Time properties
        association (Dbv0037AssociationShortInfo | Unset):
        cluster (str | Unset): Assigned cluster
        constraints (str | Unset): Constraints on job
        derived_exit_code (Dbv0037JobExitCode | Unset):
        exit_code (Dbv0037JobExitCode | Unset):
        flags (list[str] | Unset): List of properties of job
        group (str | Unset): User's group to run job
        het (Dbv0037JobHet | Unset): Heterogeneous Job details (optional)
        job_id (int | Unset): Job id
        name (str | Unset): Assigned job name
        mcs (Dbv0037JobMcs | Unset): Multi-Category Security
        ...
        required (Dbv0037JobRequired | Unset): Job run requirements
        kill_request_user (str | Unset): User who requested job killed
        reservation (Dbv0037JobReservation | Unset): Reservation usage details
        state (Dbv0037JobState | Unset): State properties of job
        steps (list[Dbv0037JobStep] | Unset): Job step description
        tres (Dbv0037JobTres | Unset): TRES settings
        user (str | Unset): Job user
        wckey (Dbv0037JobWckey | Unset): Job assigned wckey details
        working_directory (str | Unset): Directory where job was initially started
    """

    account: str | Unset = UNSET
    comment: Dbv0037JobComment | Unset = UNSET
    allocation_nodes: str | Unset = UNSET
    array: Dbv0037JobArray | Unset = UNSET
    time: Dbv0037JobTime | Unset = UNSET
    association: Dbv0037AssociationShortInfo | Unset = UNSET
    cluster: str | Unset = UNSET
    constraints: str | Unset = UNSET
    derived_exit_code: Dbv0037JobExitCode | Unset = UNSET
    exit_code: Dbv0037JobExitCode | Unset = UNSET
    flags: list[str] | Unset = UNSET
    group: str | Unset = UNSET
    het: Dbv0037JobHet | Unset = UNSET
    job_id: int | Unset = UNSET
    name: str | Unset = UNSET
    mcs: Dbv0037JobMcs | Unset = UNSET
    nodes: str | Unset = UNSET
    partition: str | Unset = UNSET
    priority: int | Unset = UNSET
    qos: str | Unset = UNSET
    required: Dbv0037JobRequired | Unset = UNSET
    kill_request_user: str | Unset = UNSET
    reservation: Dbv0037JobReservation | Unset = UNSET
    state: Dbv0037JobState | Unset = UNSET
    steps: list[Dbv0037JobStep] | Unset = UNSET
    tres: Dbv0037JobTres | Unset = UNSET
    user: str | Unset = UNSET
    wckey: Dbv0037JobWckey | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        comment: Dbv0037JobComment | Unset
        if isinstance(_comment, Unset):
            comment = UNSET
        else:
            comment = Dbv0037JobComment.from_dict(_comment)

        allocation_nodes = d.pop("allocation_nodes", UNSET)

        _array = d.pop("array", UNSET)
        array: Dbv0037JobArray | Unset
        if isinstance(_array, Unset):
            array = UNSET
        else:
            array = Dbv0037JobArray.from_dict(_array)

        _time = d.pop("time", UNSET)
        time: Dbv0037JobTime | Unset
        if isinstance(_time, Unset):
            time = UNSET
        else:
            time = Dbv0037JobTime.from_dict(_time)
        ...
        if isinstance(_association, Unset):
            ...
            association = Dbv0037AssociationShortInfo.from_dict(_association)
        ...
        if isinstance(_derived_exit_code, Unset):
            ...
            derived_exit_code = Dbv0037JobExitCode.from_dict(_derived_exit_code)
        ...
        het: Dbv0037JobHet | Unset
        if isinstance(_het, Unset):
            het = UNSET
        else:
            het = Dbv0037JobHet.from_dict(_het)
        ...
        mcs: Dbv0037JobMcs | Unset
        if isinstance(_mcs, Unset):
            mcs = UNSET
        else:
            mcs = Dbv0037JobMcs.from_dict(_mcs)
        ...
        required: Dbv0037JobRequired | Unset
        if isinstance(_required, Unset):
            required = UNSET
        else:
            required = Dbv0037JobRequired.from_dict(_required)

        kill_request_user = d.pop("kill_request_user", UNSET)

        _reservation = d.pop("reservation", UNSET)
        reservation: Dbv0037JobReservation | Unset
        if isinstance(_reservation, Unset):
            reservation = UNSET
        else:
            reservation = Dbv0037JobReservation.from_dict(_reservation)

        _state = d.pop("state", UNSET)
        state: Dbv0037JobState | Unset
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = Dbv0037JobState.from_dict(_state)
        ...
        if _steps is not UNSET:
            ...
            for steps_item_data in _steps:
                steps_item = Dbv0037JobStep.from_dict(steps_item_data)

                steps.append(steps_item)

        _tres = d.pop("tres", UNSET)
        tres: Dbv0037JobTres | Unset
        if isinstance(_tres, Unset):
            tres = UNSET
        else:
            tres = Dbv0037JobTres.from_dict(_tres)

        user = d.pop("user", UNSET)

        _wckey = d.pop("wckey", UNSET)
        wckey: Dbv0037JobWckey | Unset
        if isinstance(_wckey, Unset):
            wckey = UNSET
        else:
            wckey = Dbv0037JobWckey.from_dict(_wckey)
        ...
        dbv_0037_job.additional_properties = d
        return dbv_0037_job
