...
T = TypeVar("T", bound="V0044StatsMsgRpcType")


@_attrs_define
class V0044StatsMsgRpcType:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        average_time = V0044Uint64NoValStruct.from_dict(d.pop("average_time"))

        v0044_stats_msg_rpc_type = cls(
            type_id=type_id,
            message_type=message_type,
            count=count,
            queued=queued,
        ...
        v0044_stats_msg_rpc_type.additional_properties = d
        return v0044_stats_msg_rpc_type
