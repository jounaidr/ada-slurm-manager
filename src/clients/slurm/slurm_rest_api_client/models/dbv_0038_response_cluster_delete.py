...
T = TypeVar("T", bound="Dbv0038ResponseClusterDelete")
...
class Dbv0038ResponseClusterDelete:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_response_cluster_delete = cls(
            meta=meta,
            errors=errors,
        )

        dbv_0038_response_cluster_delete.additional_properties = d
        return dbv_0038_response_cluster_delete
