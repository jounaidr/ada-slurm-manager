...
T = TypeVar("T", bound="V0044AcctGatherEnergy")


@_attrs_define
class V0044AcctGatherEnergy:
    """
    Attributes:
        ...
        current_watts (V0044Uint32NoValStruct | Unset):
        previous_consumed_energy (int | Unset): Previous value of consumed_energy
        last_collected (int | Unset): Time when energy data was last retrieved (UNIX timestamp) (UNIX timestamp or time
    ...
    current_watts: V0044Uint32NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_acct_gather_energy.additional_properties = d
        return v0044_acct_gather_energy
