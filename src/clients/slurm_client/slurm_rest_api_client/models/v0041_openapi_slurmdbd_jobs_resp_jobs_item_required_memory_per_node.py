...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItemRequiredMemoryPerNode")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItemRequiredMemoryPerNode:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item_required_memory_per_node = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_jobs_resp_jobs_item_required_memory_per_node.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item_required_memory_per_node
