...
T = TypeVar("T", bound="V0044StatsMsgRpcQueue")


@_attrs_define
class V0044StatsMsgRpcQueue:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_stats_msg_rpc_queue = cls(
            type_id=type_id,
            message_type=message_type,
            count=count,
        )

        v0044_stats_msg_rpc_queue.additional_properties = d
        return v0044_stats_msg_rpc_queue
