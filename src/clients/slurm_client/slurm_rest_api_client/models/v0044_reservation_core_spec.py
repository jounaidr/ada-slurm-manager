...
T = TypeVar("T", bound="V0044ReservationCoreSpec")


@_attrs_define
class V0044ReservationCoreSpec:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_reservation_core_spec = cls(
            node=node,
            core=core,
        )

        v0044_reservation_core_spec.additional_properties = d
        return v0044_reservation_core_spec
