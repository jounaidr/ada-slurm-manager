...
T = TypeVar("T", bound="Dbv0038JobTimeSystem")


@_attrs_define
class Dbv0038JobTimeSystem:
    """System time values
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_job_time_system = cls(
            seconds=seconds,
            microseconds=microseconds,
        )

        dbv_0038_job_time_system.additional_properties = d
        return dbv_0038_job_time_system
