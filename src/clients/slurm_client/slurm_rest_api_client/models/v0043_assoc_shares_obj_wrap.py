...
class V0043AssocSharesObjWrap:
    ...
    Attributes:
        ...
        shares_normalized (V0043Float64NoValStruct | Unset):
        shares (V0043Uint32NoValStruct | Unset):
        tres (V0043AssocSharesObjWrapTres | Unset):
        effective_usage (V0043Float64NoValStruct | Unset):
        usage_normalized (V0043Float64NoValStruct | Unset):
        usage (int | Unset): Measure of tresbillableunits usage
        fairshare (V0043AssocSharesObjWrapFairshare | Unset):
        type_ (list[V0043AssocSharesObjWrapTypeItem] | Unset): User or account association
    """
    ...
    shares_normalized: V0043Float64NoValStruct | Unset = UNSET
    shares: V0043Uint32NoValStruct | Unset = UNSET
    tres: V0043AssocSharesObjWrapTres | Unset = UNSET
    effective_usage: V0043Float64NoValStruct | Unset = UNSET
    usage_normalized: V0043Float64NoValStruct | Unset = UNSET
    usage: int | Unset = UNSET
    fairshare: V0043AssocSharesObjWrapFairshare | Unset = UNSET
    type_: list[V0043AssocSharesObjWrapTypeItem] | Unset = UNSET
