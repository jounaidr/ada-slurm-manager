...
) -> Dbv0038WckeyInfo | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038WckeyInfo.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038WckeyInfo | list[Dbv0038Error]]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> Dbv0038WckeyInfo | list[Dbv0038Error] | None:
    """Get wckey info
