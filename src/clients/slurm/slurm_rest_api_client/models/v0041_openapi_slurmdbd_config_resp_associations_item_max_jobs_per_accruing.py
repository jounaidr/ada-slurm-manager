...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespAssociationsItemMaxJobsPerAccruing")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespAssociationsItemMaxJobsPerAccruing:
    """GrpJobsAccrue
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_per_accruing = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_per_accruing.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_per_accruing
