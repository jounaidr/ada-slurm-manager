...
def _get_kwargs(
    *,
    body: V0042OpenapiSlurmdbdQosResp | Unset = UNSET,
    description: str | Unset = UNSET,
    include_deleted_qos: str | Unset = UNSET,
    id: str | Unset = UNSET,
    format_: str | Unset = UNSET,
    name: str | Unset = UNSET,
    preempt_mode: SlurmdbV0042PostQosPreemptMode | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiResp.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        format_ (str | Unset):
        name (str | Unset):
        preempt_mode (SlurmdbV0042PostQosPreemptMode | Unset):
        body (V0042OpenapiSlurmdbdQosResp | Unset):
