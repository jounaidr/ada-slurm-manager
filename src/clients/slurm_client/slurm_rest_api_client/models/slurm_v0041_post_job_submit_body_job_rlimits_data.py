...
T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJobRlimitsData")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJobRlimitsData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_submit_body_job_rlimits_data = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_submit_body_job_rlimits_data.additional_properties = d
        return slurm_v0041_post_job_submit_body_job_rlimits_data
