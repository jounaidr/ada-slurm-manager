...
T = TypeVar("T", bound="SlurmV0041PostJobAllocateBodyHetjobItemRlimitsRss")


@_attrs_define
class SlurmV0041PostJobAllocateBodyHetjobItemRlimitsRss:
    """Largest resident set size, in bytes. This affects swapping; processes that are exceeding their resident set size
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_allocate_body_hetjob_item_rlimits_rss = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_allocate_body_hetjob_item_rlimits_rss.additional_properties = d
        return slurm_v0041_post_job_allocate_body_hetjob_item_rlimits_rss
