...
T = TypeVar("T", bound="SlurmV0041GetDiagResponseDefaultStatisticsBfExit")


@_attrs_define
class SlurmV0041GetDiagResponseDefaultStatisticsBfExit:
    """Reasons for which the backfill scheduling cycle exited since last reset

    Attributes:
        end_job_queue (int | Unset): Reached end of queue
        bf_max_job_start (int | Unset): Reached number of jobs allowed to start
        bf_max_job_test (int | Unset): Reached number of jobs allowed to be tested
        bf_max_time (int | Unset): Reached maximum allowed scheduler time
        bf_node_space_size (int | Unset): Reached table size limit
        state_changed (int | Unset): System state changed
    """

    end_job_queue: int | Unset = UNSET
    bf_max_job_start: int | Unset = UNSET
    bf_max_job_test: int | Unset = UNSET
    bf_max_time: int | Unset = UNSET
    bf_node_space_size: int | Unset = UNSET
    state_changed: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_diag_response_default_statistics_bf_exit = cls(
        ...
        slurm_v0041_get_diag_response_default_statistics_bf_exit.additional_properties = d
        return slurm_v0041_get_diag_response_default_statistics_bf_exit
