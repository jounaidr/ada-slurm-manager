...
T = TypeVar("T", bound="SlurmV0041DeleteJobsResponse200StatusItemJobId")


@_attrs_define
class SlurmV0041DeleteJobsResponse200StatusItemJobId:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_delete_jobs_response_200_status_item_job_id = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_delete_jobs_response_200_status_item_job_id.additional_properties = d
        return slurm_v0041_delete_jobs_response_200_status_item_job_id
