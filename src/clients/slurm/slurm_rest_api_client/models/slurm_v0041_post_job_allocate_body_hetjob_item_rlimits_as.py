...
T = TypeVar("T", bound="SlurmV0041PostJobAllocateBodyHetjobItemRlimitsAs")


@_attrs_define
class SlurmV0041PostJobAllocateBodyHetjobItemRlimitsAs:
    """Address space limit.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_allocate_body_hetjob_item_rlimits_as = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_allocate_body_hetjob_item_rlimits_as.additional_properties = d
        return slurm_v0041_post_job_allocate_body_hetjob_item_rlimits_as
