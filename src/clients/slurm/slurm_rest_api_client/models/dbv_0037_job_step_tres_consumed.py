...
T = TypeVar("T", bound="Dbv0037JobStepTresConsumed")


@_attrs_define
class Dbv0037JobStepTresConsumed:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0037_job_step_tres_consumed = cls(
            average=average,
            max_=max_,
            min_=min_,
            total=total,
        ...
        dbv_0037_job_step_tres_consumed.additional_properties = d
        return dbv_0037_job_step_tres_consumed
