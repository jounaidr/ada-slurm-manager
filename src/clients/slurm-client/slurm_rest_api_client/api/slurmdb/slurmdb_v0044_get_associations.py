...
from ...models.v0044_openapi_assocs_resp import V0044OpenapiAssocsResp
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0044OpenapiAssocsResp:
    if response.status_code == 200:
        response_200 = V0044OpenapiAssocsResp.from_dict(response.json())

        return response_200

    response_default = V0044OpenapiAssocsResp.from_dict(response.json())
...
) -> Response[V0044OpenapiAssocsResp]:
    return Response(
