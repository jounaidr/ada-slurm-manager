...
T = TypeVar("T", bound="V0044OpenapiReservationModResp")


@_attrs_define
class V0044OpenapiReservationModResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_reservation_mod_resp = cls(
            reservations=reservations,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_reservation_mod_resp.additional_properties = d
        return v0044_openapi_reservation_mod_resp
