...
T = TypeVar("T", bound="SlurmV0041PostJobBodyRlimitsRss")


@_attrs_define
class SlurmV0041PostJobBodyRlimitsRss:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_body_rlimits_rss = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_body_rlimits_rss.additional_properties = d
        return slurm_v0041_post_job_body_rlimits_rss
