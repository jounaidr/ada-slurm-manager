...
T = TypeVar("T", bound="Dbv0038JobExitCodeSignal")


@_attrs_define
class Dbv0038JobExitCodeSignal:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_job_exit_code_signal = cls(
            signal_id=signal_id,
            name=name,
        )

        dbv_0038_job_exit_code_signal.additional_properties = d
        return dbv_0038_job_exit_code_signal
