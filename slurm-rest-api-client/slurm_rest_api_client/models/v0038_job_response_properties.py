...
if TYPE_CHECKING:
    from ..models.v0038_job_resources import V0038JobResources


T = TypeVar("T", bound="V0038JobResponseProperties")
...
class V0038JobResponseProperties:
    ...
    Attributes:
        ...
        array_job_id (int | Unset): job_id of a job array or 0 if N/A
        array_task_id (int | Unset): task_id of a job array
        array_max_tasks (int | Unset): Maximum number of running array tasks
        array_task_string (str | Unset): string expression of task IDs in this record
        association_id (int | Unset): association id for job
        ...
        billable_tres (float | Unset): billable TRES
        ...
        deadline (int | Unset): job start deadline
        delay_boot (int | Unset): command to be executed
        dependency (str | Unset): synchronize job execution with other jobs
        derived_exit_code (int | Unset): highest exit code of all job steps
        ...
        group_id (int | Unset): group job submitted as
        job_id (int | Unset): job ID
        job_resources (V0038JobResources | Unset):
        job_state (str | Unset): state of the job
        last_sched_evaluation (int | Unset): last time job was evaluated for scheduling
        licenses (str | Unset): licenses required by the job
        max_cpus (int | Unset): maximum number of cpus usable by job
        max_nodes (int | Unset): maximum number of nodes usable by job
        ...
        nice (int | Unset): requested priority change
        ...
        cpus (int | Unset): minimum number of cpus required by job
        node_count (int | Unset): minimum number of nodes required by job
        tasks (int | Unset): requested task count
        het_job_id (int | Unset): job ID of hetjob leader
        het_job_id_set (str | Unset): job IDs for all components
        het_job_offset (int | Unset): HetJob component offset from leader
        partition (str | Unset): name of assigned partition
        memory_per_node (int | Unset): minimum real memory per node
        memory_per_cpu (int | Unset): minimum real memory per cpu
        minimum_cpus_per_node (int | Unset): minimum # CPUs per node
        minimum_tmp_disk_per_node (int | Unset): minimum tmp disk per node
        preempt_time (int | Unset): preemption signal time
        pre_sus_time (int | Unset): time job ran prior to last suspend
        priority (int | Unset): relative priority of the job
        ...
        restart_cnt (int | Unset): count of job restarts
        ...
        sockets_per_board (int | Unset): sockets per board required by job
        sockets_per_node (int | Unset): sockets per node required by job
        ...
        time_limit (int | Unset): maximum run time in minutes
        time_minimum (int | Unset): minimum run time in minutes
        threads_per_core (int | Unset): threads per core required by job
        ...
        user_id (int | Unset): user id the job runs as
    ...
    array_job_id: int | Unset = UNSET
    array_task_id: int | Unset = UNSET
    array_max_tasks: int | Unset = UNSET
    ...
    billable_tres: float | Unset = UNSET
    ...
    derived_exit_code: int | Unset = UNSET
    ...
    job_resources: V0038JobResources | Unset = UNSET
    job_state: str | Unset = UNSET
    last_sched_evaluation: int | Unset = UNSET
    licenses: str | Unset = UNSET
    max_cpus: int | Unset = UNSET
    max_nodes: int | Unset = UNSET
    ...
    het_job_id: int | Unset = UNSET
    het_job_id_set: str | Unset = UNSET
    het_job_offset: int | Unset = UNSET
    ...
    minimum_tmp_disk_per_node: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_job_resources, Unset):
            ...
            job_resources = V0038JobResources.from_dict(_job_resources)
        ...
        v0038_job_response_properties = cls(
            account=account,
        ...
        v0038_job_response_properties.additional_properties = d
        return v0038_job_response_properties
