...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespErrorsItem")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_errors_item = cls(
        ...
        v0041_openapi_slurmdbd_config_resp_errors_item.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_errors_item
