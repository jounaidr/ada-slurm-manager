...
T = TypeVar("T", bound="V0044OpenapiError")


@_attrs_define
class V0044OpenapiError:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_error.additional_properties = d
        return v0044_openapi_error
