...
from ...models.dbv_0038_associations_info import Dbv0038AssociationsInfo
from ...models.dbv_0038_error import Dbv0038Error
from ...models.dbv_0038_response_associations import Dbv0038ResponseAssociations
...
) -> Dbv0038ResponseAssociations | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038ResponseAssociations.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038ResponseAssociations | list[Dbv0038Error]]:
    return Response(
...
def sync(
    *,
    client: AuthenticatedClient | Client,
    body: Dbv0038AssociationsInfo,
) -> Dbv0038ResponseAssociations | list[Dbv0038Error] | None:
    """Set associations info
