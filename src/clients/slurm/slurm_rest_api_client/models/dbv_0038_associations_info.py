...
T = TypeVar("T", bound="Dbv0038AssociationsInfo")
...
class Dbv0038AssociationsInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_associations_info = cls(
            meta=meta,
            errors=errors,
            associations=associations,
        )

        dbv_0038_associations_info.additional_properties = d
        return dbv_0038_associations_info
