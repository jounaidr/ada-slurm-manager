...
T = TypeVar("T", bound="V0044OpenapiClustersResp")


@_attrs_define
class V0044OpenapiClustersResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_clusters_resp = cls(
            clusters=clusters,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_clusters_resp.additional_properties = d
        return v0044_openapi_clusters_resp
