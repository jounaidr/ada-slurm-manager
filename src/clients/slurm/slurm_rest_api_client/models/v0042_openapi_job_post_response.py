...
class V0042OpenapiJobPostResponse:
    """
    Attributes:
        results (list[V0042JobArrayResponseMsgEntry] | Unset):
        meta (V0042OpenapiMeta | Unset):
        errors (list[V0042OpenapiError] | Unset):
        warnings (list[V0042OpenapiWarning] | Unset):
    """

    results: list[V0042JobArrayResponseMsgEntry] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _results is not UNSET:
            results = []
            for componentsschemasv0_0_42_job_array_response_array_item_data in _results:
