...
from ...models.dbv_0038_account_response import Dbv0038AccountResponse
...
) -> Dbv0038AccountResponse | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038AccountResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038AccountResponse | list[Dbv0038Error]]:
    return Response(
...
def sync(
    *,
    client: AuthenticatedClient | Client,
    body: Dbv0038UpdateAccount,
) -> Dbv0038AccountResponse | list[Dbv0038Error] | None:
    """Update accounts
