...
T = TypeVar("T", bound="SlurmV0041PostJobAllocateBodyJobRlimitsMemlock")


@_attrs_define
class SlurmV0041PostJobAllocateBodyJobRlimitsMemlock:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_allocate_body_job_rlimits_memlock = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_allocate_body_job_rlimits_memlock.additional_properties = d
        return slurm_v0041_post_job_allocate_body_job_rlimits_memlock
