...
if TYPE_CHECKING:
    ...
    from ..models.v0044_reservation_info import V0044ReservationInfo
    from ..models.v0044_uint_64_no_val_struct import V0044Uint64NoValStruct


T = TypeVar("T", bound="V0044OpenapiReservationResp")


@_attrs_define
class V0044OpenapiReservationResp:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        reservations = []
        for componentsschemasv0_0_44_reservation_info_msg_item_data in self.reservations:
            componentsschemasv0_0_44_reservation_info_msg_item = (
                componentsschemasv0_0_44_reservation_info_msg_item_data.to_dict()
            )
            reservations.append(componentsschemasv0_0_44_reservation_info_msg_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_44_reservation_info_msg_item_data in _reservations:
            componentsschemasv0_0_44_reservation_info_msg_item = V0044ReservationInfo.from_dict(
                componentsschemasv0_0_44_reservation_info_msg_item_data
            )
        ...
        v0044_openapi_reservation_resp = cls(
            reservations=reservations,
            last_update=last_update,
            meta=meta,
            errors=errors,
        ...
        v0044_openapi_reservation_resp.additional_properties = d
        return v0044_openapi_reservation_resp
