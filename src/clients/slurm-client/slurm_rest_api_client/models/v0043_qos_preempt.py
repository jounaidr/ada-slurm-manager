...
class V0043QosPreempt:
    ...
    Attributes:
        ...
        mode (list[V0043QosPreemptModeItem] | Unset): PreemptMode - Mechanism used to preempt jobs or enable gang
            scheduling
        exempt_time (V0043Uint32NoValStruct | Unset):
    """

    list_: list[str] | Unset = UNSET
    mode: list[V0043QosPreemptModeItem] | Unset = UNSET
    exempt_time: V0043Uint32NoValStruct | Unset = UNSET
