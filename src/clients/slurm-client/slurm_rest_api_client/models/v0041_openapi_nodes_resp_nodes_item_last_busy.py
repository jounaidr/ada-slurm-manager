...
T = TypeVar("T", bound="V0041OpenapiNodesRespNodesItemLastBusy")


@_attrs_define
class V0041OpenapiNodesRespNodesItemLastBusy:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_nodes_resp_nodes_item_last_busy = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_nodes_resp_nodes_item_last_busy.additional_properties = d
        return v0041_openapi_nodes_resp_nodes_item_last_busy
