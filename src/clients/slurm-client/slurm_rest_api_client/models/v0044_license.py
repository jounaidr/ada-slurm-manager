...
T = TypeVar("T", bound="V0044License")
...
class V0044License:
    ...
    Attributes:
        ...
        last_update (int | Unset): When the license information was last updated (UNIX Timestamp) (UNIX timestamp or
            time string recognized by Slurm (e.g., '[MM/DD[/YY]-]HH:MM[:SS]'))
        nodes (str | Unset): HRes nodes
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_license.additional_properties = d
        return v0044_license
