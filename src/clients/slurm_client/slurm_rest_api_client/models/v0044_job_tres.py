...
T = TypeVar("T", bound="V0044JobTres")
...
class V0044JobTres:
    ...
    Attributes:
        ...
        requested (list[V0044Tres] | Unset):
    """

    allocated: list[V0044Tres] | Unset = UNSET
    requested: list[V0044Tres] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.requested, Unset):
            requested = []
            for componentsschemasv0_0_44_tres_list_item_data in self.requested:
                componentsschemasv0_0_44_tres_list_item = componentsschemasv0_0_44_tres_list_item_data.to_dict()
                requested.append(componentsschemasv0_0_44_tres_list_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _requested is not UNSET:
            requested = []
            for componentsschemasv0_0_44_tres_list_item_data in _requested:
                componentsschemasv0_0_44_tres_list_item = V0044Tres.from_dict(
                    componentsschemasv0_0_44_tres_list_item_data
                )
        ...
        v0044_job_tres.additional_properties = d
        return v0044_job_tres
