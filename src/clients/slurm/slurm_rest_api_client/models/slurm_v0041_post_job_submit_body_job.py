...
from ..models.slurm_v0041_post_job_submit_body_job_cpu_binding_flags_item import (
    SlurmV0041PostJobSubmitBodyJobCpuBindingFlagsItem,
)
from ..models.slurm_v0041_post_job_submit_body_job_exclusive_item import SlurmV0041PostJobSubmitBodyJobExclusiveItem
from ..models.slurm_v0041_post_job_submit_body_job_flags_item import SlurmV0041PostJobSubmitBodyJobFlagsItem
from ..models.slurm_v0041_post_job_submit_body_job_kill_warning_flags_item import (
    SlurmV0041PostJobSubmitBodyJobKillWarningFlagsItem,
)
from ..models.slurm_v0041_post_job_submit_body_job_mail_type_item import SlurmV0041PostJobSubmitBodyJobMailTypeItem
from ..models.slurm_v0041_post_job_submit_body_job_memory_binding_type_item import (
    SlurmV0041PostJobSubmitBodyJobMemoryBindingTypeItem,
)
from ..models.slurm_v0041_post_job_submit_body_job_open_mode_item import SlurmV0041PostJobSubmitBodyJobOpenModeItem
from ..models.slurm_v0041_post_job_submit_body_job_profile_item import SlurmV0041PostJobSubmitBodyJobProfileItem
from ..models.slurm_v0041_post_job_submit_body_job_shared_item import SlurmV0041PostJobSubmitBodyJobSharedItem
from ..models.slurm_v0041_post_job_submit_body_job_x11_item import SlurmV0041PostJobSubmitBodyJobX11Item
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.slurm_v0041_post_job_submit_body_job_begin_time import SlurmV0041PostJobSubmitBodyJobBeginTime
    from ..models.slurm_v0041_post_job_submit_body_job_crontab import SlurmV0041PostJobSubmitBodyJobCrontab
    from ..models.slurm_v0041_post_job_submit_body_job_distribution_plane_size import (
        SlurmV0041PostJobSubmitBodyJobDistributionPlaneSize,
    )
    from ..models.slurm_v0041_post_job_submit_body_job_kill_warning_delay import (
        SlurmV0041PostJobSubmitBodyJobKillWarningDelay,
    )
    from ..models.slurm_v0041_post_job_submit_body_job_memory_per_cpu import SlurmV0041PostJobSubmitBodyJobMemoryPerCpu
    from ..models.slurm_v0041_post_job_submit_body_job_memory_per_node import (
        SlurmV0041PostJobSubmitBodyJobMemoryPerNode,
    )
    from ..models.slurm_v0041_post_job_submit_body_job_priority import SlurmV0041PostJobSubmitBodyJobPriority
    from ..models.slurm_v0041_post_job_submit_body_job_required_switches import (
        SlurmV0041PostJobSubmitBodyJobRequiredSwitches,
    )
    from ..models.slurm_v0041_post_job_submit_body_job_rlimits import SlurmV0041PostJobSubmitBodyJobRlimits
    from ..models.slurm_v0041_post_job_submit_body_job_segment_size import SlurmV0041PostJobSubmitBodyJobSegmentSize
    from ..models.slurm_v0041_post_job_submit_body_job_time_limit import SlurmV0041PostJobSubmitBodyJobTimeLimit
    from ..models.slurm_v0041_post_job_submit_body_job_time_minimum import SlurmV0041PostJobSubmitBodyJobTimeMinimum


T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJob")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJob:
    """Job description
    ...
    Attributes:
        ...
        begin_time (SlurmV0041PostJobSubmitBodyJobBeginTime | Unset): Defer the allocation of the job until the
            specified time (UNIX timestamp)
        flags (list[SlurmV0041PostJobSubmitBodyJobFlagsItem] | Unset): Job flags
        ...
        cpu_binding_flags (list[SlurmV0041PostJobSubmitBodyJobCpuBindingFlagsItem] | Unset): Flags for CPU binding
        ...
        crontab (SlurmV0041PostJobSubmitBodyJobCrontab | Unset): Specification for scrontab job
        ...
        rlimits (SlurmV0041PostJobSubmitBodyJobRlimits | Unset):
        ...
        mail_type (list[SlurmV0041PostJobSubmitBodyJobMailTypeItem] | Unset): Mail event type(s)
        ...
        memory_binding_type (list[SlurmV0041PostJobSubmitBodyJobMemoryBindingTypeItem] | Unset): Method for binding
            tasks to memory
        ...
        open_mode (list[SlurmV0041PostJobSubmitBodyJobOpenModeItem] | Unset): Open mode used for stdout and stderr files
        ...
        distribution_plane_size (SlurmV0041PostJobSubmitBodyJobDistributionPlaneSize | Unset): Plane size specification
            when distribution specifies plane
        ...
        priority (SlurmV0041PostJobSubmitBodyJobPriority | Unset): Request specific job priority
        profile (list[SlurmV0041PostJobSubmitBodyJobProfileItem] | Unset): Profile used by the acct_gather_profile
            plugin
        ...
        shared (list[SlurmV0041PostJobSubmitBodyJobSharedItem] | Unset): How the job can share resources with other
            jobs, if at all
        exclusive (list[SlurmV0041PostJobSubmitBodyJobExclusiveItem] | Unset):
        ...
        time_limit (SlurmV0041PostJobSubmitBodyJobTimeLimit | Unset): Maximum run time in minutes
        time_minimum (SlurmV0041PostJobSubmitBodyJobTimeMinimum | Unset): Minimum run time in minutes
        ...
        kill_warning_flags (list[SlurmV0041PostJobSubmitBodyJobKillWarningFlagsItem] | Unset): Flags related to job
            signals
        kill_warning_signal (str | Unset): Signal to send when approaching end time (e.g. "10" or "USR1")
        kill_warning_delay (SlurmV0041PostJobSubmitBodyJobKillWarningDelay | Unset): Number of seconds before end time
        ...
        memory_per_cpu (SlurmV0041PostJobSubmitBodyJobMemoryPerCpu | Unset): Minimum memory in megabytes per allocated
            CPU
        memory_per_node (SlurmV0041PostJobSubmitBodyJobMemoryPerNode | Unset): Minimum memory in megabytes per allocated
            CPU
        temporary_disk_per_node (int | Unset): Minimum tmp disk space required per node
        selinux_context (str | Unset): SELinux context
        required_switches (SlurmV0041PostJobSubmitBodyJobRequiredSwitches | Unset): Maximum number of switches
        segment_size (SlurmV0041PostJobSubmitBodyJobSegmentSize | Unset): Segment size for topology/block
        ...
        x11 (list[SlurmV0041PostJobSubmitBodyJobX11Item] | Unset): X11 forwarding options
    ...
    begin_time: SlurmV0041PostJobSubmitBodyJobBeginTime | Unset = UNSET
    flags: list[SlurmV0041PostJobSubmitBodyJobFlagsItem] | Unset = UNSET
    ...
    cpu_binding_flags: list[SlurmV0041PostJobSubmitBodyJobCpuBindingFlagsItem] | Unset = UNSET
    cpu_frequency: str | Unset = UNSET
    cpus_per_tres: str | Unset = UNSET
    crontab: SlurmV0041PostJobSubmitBodyJobCrontab | Unset = UNSET
    ...
    rlimits: SlurmV0041PostJobSubmitBodyJobRlimits | Unset = UNSET
    ...
    mail_type: list[SlurmV0041PostJobSubmitBodyJobMailTypeItem] | Unset = UNSET
    mail_user: str | Unset = UNSET
    mcs_label: str | Unset = UNSET
    memory_binding: str | Unset = UNSET
    memory_binding_type: list[SlurmV0041PostJobSubmitBodyJobMemoryBindingTypeItem] | Unset = UNSET
    memory_per_tres: str | Unset = UNSET
    name: str | Unset = UNSET
    network: str | Unset = UNSET
    nice: int | Unset = UNSET
    tasks: int | Unset = UNSET
    open_mode: list[SlurmV0041PostJobSubmitBodyJobOpenModeItem] | Unset = UNSET
    reserve_ports: int | Unset = UNSET
    overcommit: bool | Unset = UNSET
    partition: str | Unset = UNSET
    distribution_plane_size: SlurmV0041PostJobSubmitBodyJobDistributionPlaneSize | Unset = UNSET
    power_flags: list[Any] | Unset = UNSET
    prefer: str | Unset = UNSET
    hold: bool | Unset = UNSET
    priority: SlurmV0041PostJobSubmitBodyJobPriority | Unset = UNSET
    profile: list[SlurmV0041PostJobSubmitBodyJobProfileItem] | Unset = UNSET
    qos: str | Unset = UNSET
    ...
    shared: list[SlurmV0041PostJobSubmitBodyJobSharedItem] | Unset = UNSET
    exclusive: list[SlurmV0041PostJobSubmitBodyJobExclusiveItem] | Unset = UNSET
    ...
    time_limit: SlurmV0041PostJobSubmitBodyJobTimeLimit | Unset = UNSET
    time_minimum: SlurmV0041PostJobSubmitBodyJobTimeMinimum | Unset = UNSET
    ...
    kill_warning_flags: list[SlurmV0041PostJobSubmitBodyJobKillWarningFlagsItem] | Unset = UNSET
    kill_warning_signal: str | Unset = UNSET
    kill_warning_delay: SlurmV0041PostJobSubmitBodyJobKillWarningDelay | Unset = UNSET
    ...
    memory_per_cpu: SlurmV0041PostJobSubmitBodyJobMemoryPerCpu | Unset = UNSET
    memory_per_node: SlurmV0041PostJobSubmitBodyJobMemoryPerNode | Unset = UNSET
    temporary_disk_per_node: int | Unset = UNSET
    selinux_context: str | Unset = UNSET
    required_switches: SlurmV0041PostJobSubmitBodyJobRequiredSwitches | Unset = UNSET
    segment_size: SlurmV0041PostJobSubmitBodyJobSegmentSize | Unset = UNSET
    ...
    x11: list[SlurmV0041PostJobSubmitBodyJobX11Item] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.slurm_v0041_post_job_submit_body_job_memory_per_cpu import (
        ...
        begin_time: SlurmV0041PostJobSubmitBodyJobBeginTime | Unset
        if isinstance(_begin_time, Unset):
            begin_time = UNSET
        else:
            begin_time = SlurmV0041PostJobSubmitBodyJobBeginTime.from_dict(_begin_time)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = SlurmV0041PostJobSubmitBodyJobFlagsItem(flags_item_data)
        ...
        if _cpu_binding_flags is not UNSET:
            ...
            for cpu_binding_flags_item_data in _cpu_binding_flags:
                cpu_binding_flags_item = SlurmV0041PostJobSubmitBodyJobCpuBindingFlagsItem(cpu_binding_flags_item_data)
        ...
        crontab: SlurmV0041PostJobSubmitBodyJobCrontab | Unset
        if isinstance(_crontab, Unset):
            crontab = UNSET
        else:
            crontab = SlurmV0041PostJobSubmitBodyJobCrontab.from_dict(_crontab)
        ...
        if isinstance(_rlimits, Unset):
            ...
            rlimits = SlurmV0041PostJobSubmitBodyJobRlimits.from_dict(_rlimits)
        ...
        if _mail_type is not UNSET:
            ...
            for mail_type_item_data in _mail_type:
                mail_type_item = SlurmV0041PostJobSubmitBodyJobMailTypeItem(mail_type_item_data)
        ...
        if _memory_binding_type is not UNSET:
            ...
            for memory_binding_type_item_data in _memory_binding_type:
                memory_binding_type_item = SlurmV0041PostJobSubmitBodyJobMemoryBindingTypeItem(
        ...
        if _open_mode is not UNSET:
            ...
            for open_mode_item_data in _open_mode:
                open_mode_item = SlurmV0041PostJobSubmitBodyJobOpenModeItem(open_mode_item_data)
        ...
        distribution_plane_size: SlurmV0041PostJobSubmitBodyJobDistributionPlaneSize | Unset
        if isinstance(_distribution_plane_size, Unset):
            distribution_plane_size = UNSET
        else:
            distribution_plane_size = SlurmV0041PostJobSubmitBodyJobDistributionPlaneSize.from_dict(
        ...
        priority: SlurmV0041PostJobSubmitBodyJobPriority | Unset
        if isinstance(_priority, Unset):
            priority = UNSET
        else:
            priority = SlurmV0041PostJobSubmitBodyJobPriority.from_dict(_priority)
        ...
        if _profile is not UNSET:
            ...
            for profile_item_data in _profile:
                profile_item = SlurmV0041PostJobSubmitBodyJobProfileItem(profile_item_data)
        ...
        if _shared is not UNSET:
            ...
            for shared_item_data in _shared:
                shared_item = SlurmV0041PostJobSubmitBodyJobSharedItem(shared_item_data)
        ...
        if _exclusive is not UNSET:
            ...
            for exclusive_item_data in _exclusive:
                exclusive_item = SlurmV0041PostJobSubmitBodyJobExclusiveItem(exclusive_item_data)
        ...
        time_limit: SlurmV0041PostJobSubmitBodyJobTimeLimit | Unset
        if isinstance(_time_limit, Unset):
            time_limit = UNSET
        else:
            time_limit = SlurmV0041PostJobSubmitBodyJobTimeLimit.from_dict(_time_limit)

        _time_minimum = d.pop("time_minimum", UNSET)
        time_minimum: SlurmV0041PostJobSubmitBodyJobTimeMinimum | Unset
        if isinstance(_time_minimum, Unset):
            time_minimum = UNSET
        else:
            time_minimum = SlurmV0041PostJobSubmitBodyJobTimeMinimum.from_dict(_time_minimum)
        ...
        if _kill_warning_flags is not UNSET:
            ...
            for kill_warning_flags_item_data in _kill_warning_flags:
                kill_warning_flags_item = SlurmV0041PostJobSubmitBodyJobKillWarningFlagsItem(
        ...
        kill_warning_delay: SlurmV0041PostJobSubmitBodyJobKillWarningDelay | Unset
        if isinstance(_kill_warning_delay, Unset):
            kill_warning_delay = UNSET
        else:
            kill_warning_delay = SlurmV0041PostJobSubmitBodyJobKillWarningDelay.from_dict(_kill_warning_delay)
        ...
        memory_per_cpu: SlurmV0041PostJobSubmitBodyJobMemoryPerCpu | Unset
        if isinstance(_memory_per_cpu, Unset):
            memory_per_cpu = UNSET
        else:
            memory_per_cpu = SlurmV0041PostJobSubmitBodyJobMemoryPerCpu.from_dict(_memory_per_cpu)

        _memory_per_node = d.pop("memory_per_node", UNSET)
        memory_per_node: SlurmV0041PostJobSubmitBodyJobMemoryPerNode | Unset
        if isinstance(_memory_per_node, Unset):
            memory_per_node = UNSET
        else:
            memory_per_node = SlurmV0041PostJobSubmitBodyJobMemoryPerNode.from_dict(_memory_per_node)
        ...
        required_switches: SlurmV0041PostJobSubmitBodyJobRequiredSwitches | Unset
        if isinstance(_required_switches, Unset):
            required_switches = UNSET
        else:
            required_switches = SlurmV0041PostJobSubmitBodyJobRequiredSwitches.from_dict(_required_switches)

        _segment_size = d.pop("segment_size", UNSET)
        segment_size: SlurmV0041PostJobSubmitBodyJobSegmentSize | Unset
        if isinstance(_segment_size, Unset):
            segment_size = UNSET
        else:
            segment_size = SlurmV0041PostJobSubmitBodyJobSegmentSize.from_dict(_segment_size)
        ...
        if _x11 is not UNSET:
            ...
            for x11_item_data in _x11:
                x11_item = SlurmV0041PostJobSubmitBodyJobX11Item(x11_item_data)
        ...
        slurm_v0041_post_job_submit_body_job = cls(
            account=account,
        ...
        slurm_v0041_post_job_submit_body_job.additional_properties = d
        return slurm_v0041_post_job_submit_body_job
