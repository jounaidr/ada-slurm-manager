...
def _get_kwargs(
    *,
    ...
    flags: SlurmV0043GetJobsFlags | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0043OpenapiJobInfoResp:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (SlurmV0043GetJobsFlags | Unset):
