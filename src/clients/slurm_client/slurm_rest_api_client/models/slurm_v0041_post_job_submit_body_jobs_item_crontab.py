...
from ..models.slurm_v0041_post_job_submit_body_jobs_item_crontab_flags_item import (
    SlurmV0041PostJobSubmitBodyJobsItemCrontabFlagsItem,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_crontab_line import (
        SlurmV0041PostJobSubmitBodyJobsItemCrontabLine,
    )


T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJobsItemCrontab")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJobsItemCrontab:
    """Specification for scrontab job

    Attributes:
        flags (list[SlurmV0041PostJobSubmitBodyJobsItemCrontabFlagsItem] | Unset): Flags
        ...
        line (SlurmV0041PostJobSubmitBodyJobsItemCrontabLine | Unset):
    """

    flags: list[SlurmV0041PostJobSubmitBodyJobsItemCrontabFlagsItem] | Unset = UNSET
    ...
    line: SlurmV0041PostJobSubmitBodyJobsItemCrontabLine | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = SlurmV0041PostJobSubmitBodyJobsItemCrontabFlagsItem(flags_item_data)
        ...
        if isinstance(_line, Unset):
            ...
            line = SlurmV0041PostJobSubmitBodyJobsItemCrontabLine.from_dict(_line)

        slurm_v0041_post_job_submit_body_jobs_item_crontab = cls(
            flags=flags,
            minute=minute,
            hour=hour,
        ...
        slurm_v0041_post_job_submit_body_jobs_item_crontab.additional_properties = d
        return slurm_v0041_post_job_submit_body_jobs_item_crontab
