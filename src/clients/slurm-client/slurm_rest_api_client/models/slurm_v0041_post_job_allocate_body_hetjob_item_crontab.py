...
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_crontab_flags_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemCrontabFlagsItem,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_crontab_line import (
        SlurmV0041PostJobAllocateBodyHetjobItemCrontabLine,
    )


T = TypeVar("T", bound="SlurmV0041PostJobAllocateBodyHetjobItemCrontab")


@_attrs_define
class SlurmV0041PostJobAllocateBodyHetjobItemCrontab:
    """Specification for scrontab job

    Attributes:
        flags (list[SlurmV0041PostJobAllocateBodyHetjobItemCrontabFlagsItem] | Unset): Flags
        ...
        line (SlurmV0041PostJobAllocateBodyHetjobItemCrontabLine | Unset):
    """

    flags: list[SlurmV0041PostJobAllocateBodyHetjobItemCrontabFlagsItem] | Unset = UNSET
    ...
    line: SlurmV0041PostJobAllocateBodyHetjobItemCrontabLine | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = SlurmV0041PostJobAllocateBodyHetjobItemCrontabFlagsItem(flags_item_data)
        ...
        if isinstance(_line, Unset):
            ...
            line = SlurmV0041PostJobAllocateBodyHetjobItemCrontabLine.from_dict(_line)

        slurm_v0041_post_job_allocate_body_hetjob_item_crontab = cls(
            flags=flags,
            minute=minute,
            hour=hour,
        ...
        slurm_v0041_post_job_allocate_body_hetjob_item_crontab.additional_properties = d
        return slurm_v0041_post_job_allocate_body_hetjob_item_crontab
