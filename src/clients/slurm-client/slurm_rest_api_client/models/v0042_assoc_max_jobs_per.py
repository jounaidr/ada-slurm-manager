...
class V0042AssocMaxJobsPer:
    ...
    Attributes:
        ...
        submitted (V0042Uint32NoValStruct | Unset):
        wall_clock (V0042Uint32NoValStruct | Unset):
    """

    count: V0042Uint32NoValStruct | Unset = UNSET
    accruing: V0042Uint32NoValStruct | Unset = UNSET
    submitted: V0042Uint32NoValStruct | Unset = UNSET
    wall_clock: V0042Uint32NoValStruct | Unset = UNSET
