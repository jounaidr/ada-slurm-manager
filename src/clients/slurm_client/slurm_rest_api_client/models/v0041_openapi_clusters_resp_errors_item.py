...
T = TypeVar("T", bound="V0041OpenapiClustersRespErrorsItem")


@_attrs_define
class V0041OpenapiClustersRespErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_clusters_resp_errors_item = cls(
        ...
        v0041_openapi_clusters_resp_errors_item.additional_properties = d
        return v0041_openapi_clusters_resp_errors_item
