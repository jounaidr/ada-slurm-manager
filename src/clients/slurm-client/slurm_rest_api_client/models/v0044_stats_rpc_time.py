...
T = TypeVar("T", bound="V0044StatsRpcTime")


@_attrs_define
class V0044StatsRpcTime:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_stats_rpc_time = cls(
            average=average,
            total=total,
        )

        v0044_stats_rpc_time.additional_properties = d
        return v0044_stats_rpc_time
