...
def _get_kwargs(
    *,
    ...
    flags: SlurmV0042GetPartitionsFlags | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiPartitionResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiPartitionResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiPartitionResp.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (SlurmV0042GetPartitionsFlags | Unset):
