...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdQosRespQosItemPreemptExemptTime")


@_attrs_define
class V0041OpenapiSlurmdbdQosRespQosItemPreemptExemptTime:
    """PreemptExemptTime
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_qos_resp_qos_item_preempt_exempt_time = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_qos_resp_qos_item_preempt_exempt_time.additional_properties = d
        return v0041_openapi_slurmdbd_qos_resp_qos_item_preempt_exempt_time
