...
class V0042RollupStats:
    """
    Attributes:
        hourly (V0042RollupStatsHourly | Unset):
        daily (V0042RollupStatsDaily | Unset):
        monthly (V0042RollupStatsMonthly | Unset):
    """

    hourly: V0042RollupStatsHourly | Unset = UNSET
    daily: V0042RollupStatsDaily | Unset = UNSET
    monthly: V0042RollupStatsMonthly | Unset = UNSET
