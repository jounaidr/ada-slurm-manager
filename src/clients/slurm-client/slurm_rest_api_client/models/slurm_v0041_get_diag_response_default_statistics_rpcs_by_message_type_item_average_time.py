...
T = TypeVar("T", bound="SlurmV0041GetDiagResponseDefaultStatisticsRpcsByMessageTypeItemAverageTime")


@_attrs_define
class SlurmV0041GetDiagResponseDefaultStatisticsRpcsByMessageTypeItemAverageTime:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_diag_response_default_statistics_rpcs_by_message_type_item_average_time = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_get_diag_response_default_statistics_rpcs_by_message_type_item_average_time.additional_properties = d
        return slurm_v0041_get_diag_response_default_statistics_rpcs_by_message_type_item_average_time
