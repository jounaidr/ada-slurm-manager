...
T = TypeVar("T", bound="Dbv0038AccountInfo")
...
class Dbv0038AccountInfo:
    ...
    Attributes:
        ...
        accounts (list[Dbv0038Account] | Unset): List of accounts
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_account_info = cls(
            meta=meta,
            errors=errors,
            accounts=accounts,
        )

        dbv_0038_account_info.additional_properties = d
        return dbv_0038_account_info
