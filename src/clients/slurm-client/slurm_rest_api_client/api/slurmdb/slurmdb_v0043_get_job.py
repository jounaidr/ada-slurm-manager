...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/slurmdb/v0.0.43/job/{job_id}".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0043OpenapiSlurmdbdJobsResp:
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> V0043OpenapiSlurmdbdJobsResp | None:
    """Get job info
