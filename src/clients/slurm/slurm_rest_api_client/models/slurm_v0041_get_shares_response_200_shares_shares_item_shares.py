...
T = TypeVar("T", bound="SlurmV0041GetSharesResponse200SharesSharesItemShares")


@_attrs_define
class SlurmV0041GetSharesResponse200SharesSharesItemShares:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_shares_response_200_shares_shares_item_shares = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_get_shares_response_200_shares_shares_item_shares.additional_properties = d
        return slurm_v0041_get_shares_response_200_shares_shares_item_shares
