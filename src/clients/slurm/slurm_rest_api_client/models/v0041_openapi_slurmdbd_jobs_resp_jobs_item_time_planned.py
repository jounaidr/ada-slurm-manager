...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItemTimePlanned")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItemTimePlanned:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item_time_planned = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_jobs_resp_jobs_item_time_planned.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item_time_planned
