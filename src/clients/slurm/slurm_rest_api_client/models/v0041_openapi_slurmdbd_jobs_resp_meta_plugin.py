...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespMetaPlugin")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespMetaPlugin:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_meta_plugin = cls(
            type_=type_,
            name=name,
        ...
        v0041_openapi_slurmdbd_jobs_resp_meta_plugin.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_meta_plugin
