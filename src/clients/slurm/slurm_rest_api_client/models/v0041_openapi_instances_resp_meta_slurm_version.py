...
T = TypeVar("T", bound="V0041OpenapiInstancesRespMetaSlurmVersion")


@_attrs_define
class V0041OpenapiInstancesRespMetaSlurmVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_instances_resp_meta_slurm_version = cls(
            major=major,
            micro=micro,
            minor=minor,
        )

        v0041_openapi_instances_resp_meta_slurm_version.additional_properties = d
        return v0041_openapi_instances_resp_meta_slurm_version
