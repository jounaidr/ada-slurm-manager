...
T = TypeVar("T", bound="SlurmV0041PostJobBodyRlimitsStack")


@_attrs_define
class SlurmV0041PostJobBodyRlimitsStack:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_body_rlimits_stack = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_body_rlimits_stack.additional_properties = d
        return slurm_v0041_post_job_body_rlimits_stack
