...
T = TypeVar("T", bound="SlurmV0041GetDiagResponse200StatisticsScheduleExit")


@_attrs_define
class SlurmV0041GetDiagResponse200StatisticsScheduleExit:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_diag_response_200_statistics_schedule_exit = cls(
        ...
        slurm_v0041_get_diag_response_200_statistics_schedule_exit.additional_properties = d
        return slurm_v0041_get_diag_response_200_statistics_schedule_exit
