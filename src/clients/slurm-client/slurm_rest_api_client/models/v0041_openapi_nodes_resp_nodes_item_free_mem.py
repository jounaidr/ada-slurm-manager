...
T = TypeVar("T", bound="V0041OpenapiNodesRespNodesItemFreeMem")


@_attrs_define
class V0041OpenapiNodesRespNodesItemFreeMem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_nodes_resp_nodes_item_free_mem = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_nodes_resp_nodes_item_free_mem.additional_properties = d
        return v0041_openapi_nodes_resp_nodes_item_free_mem
