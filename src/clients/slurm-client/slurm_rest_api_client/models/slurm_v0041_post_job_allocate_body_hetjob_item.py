...
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_cpu_binding_flags_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemCpuBindingFlagsItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_exclusive_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemExclusiveItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_flags_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemFlagsItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_kill_warning_flags_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemKillWarningFlagsItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_mail_type_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemMailTypeItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_memory_binding_type_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemMemoryBindingTypeItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_open_mode_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemOpenModeItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_profile_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemProfileItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_shared_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemSharedItem,
)
from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_x11_item import (
    SlurmV0041PostJobAllocateBodyHetjobItemX11Item,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_begin_time import (
        SlurmV0041PostJobAllocateBodyHetjobItemBeginTime,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_crontab import (
        SlurmV0041PostJobAllocateBodyHetjobItemCrontab,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_distribution_plane_size import (
        SlurmV0041PostJobAllocateBodyHetjobItemDistributionPlaneSize,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_kill_warning_delay import (
        SlurmV0041PostJobAllocateBodyHetjobItemKillWarningDelay,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_memory_per_cpu import (
        SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerCpu,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_memory_per_node import (
        SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerNode,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_priority import (
        SlurmV0041PostJobAllocateBodyHetjobItemPriority,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_required_switches import (
        SlurmV0041PostJobAllocateBodyHetjobItemRequiredSwitches,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_rlimits import (
        SlurmV0041PostJobAllocateBodyHetjobItemRlimits,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_segment_size import (
        SlurmV0041PostJobAllocateBodyHetjobItemSegmentSize,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_time_limit import (
        SlurmV0041PostJobAllocateBodyHetjobItemTimeLimit,
    )
    from ..models.slurm_v0041_post_job_allocate_body_hetjob_item_time_minimum import (
        SlurmV0041PostJobAllocateBodyHetjobItemTimeMinimum,
    )


T = TypeVar("T", bound="SlurmV0041PostJobAllocateBodyHetjobItem")


@_attrs_define
class SlurmV0041PostJobAllocateBodyHetjobItem:
    """
    Attributes:
        ...
        begin_time (SlurmV0041PostJobAllocateBodyHetjobItemBeginTime | Unset): Defer the allocation of the job until the
            specified time (UNIX timestamp)
        flags (list[SlurmV0041PostJobAllocateBodyHetjobItemFlagsItem] | Unset): Job flags
        ...
        cpu_binding_flags (list[SlurmV0041PostJobAllocateBodyHetjobItemCpuBindingFlagsItem] | Unset): Flags for CPU
            binding
        ...
        crontab (SlurmV0041PostJobAllocateBodyHetjobItemCrontab | Unset): Specification for scrontab job
        ...
        rlimits (SlurmV0041PostJobAllocateBodyHetjobItemRlimits | Unset):
        ...
        mail_type (list[SlurmV0041PostJobAllocateBodyHetjobItemMailTypeItem] | Unset): Mail event type(s)
        ...
        memory_binding_type (list[SlurmV0041PostJobAllocateBodyHetjobItemMemoryBindingTypeItem] | Unset): Method for
            binding tasks to memory
        ...
        open_mode (list[SlurmV0041PostJobAllocateBodyHetjobItemOpenModeItem] | Unset): Open mode used for stdout and
            stderr files
        ...
        distribution_plane_size (SlurmV0041PostJobAllocateBodyHetjobItemDistributionPlaneSize | Unset): Plane size
            specification when distribution specifies plane
        ...
        priority (SlurmV0041PostJobAllocateBodyHetjobItemPriority | Unset): Request specific job priority
        profile (list[SlurmV0041PostJobAllocateBodyHetjobItemProfileItem] | Unset): Profile used by the
        ...
        shared (list[SlurmV0041PostJobAllocateBodyHetjobItemSharedItem] | Unset): How the job can share resources with
            other jobs, if at all
        exclusive (list[SlurmV0041PostJobAllocateBodyHetjobItemExclusiveItem] | Unset):
        ...
        time_limit (SlurmV0041PostJobAllocateBodyHetjobItemTimeLimit | Unset): Maximum run time in minutes
        time_minimum (SlurmV0041PostJobAllocateBodyHetjobItemTimeMinimum | Unset): Minimum run time in minutes
        ...
        kill_warning_flags (list[SlurmV0041PostJobAllocateBodyHetjobItemKillWarningFlagsItem] | Unset): Flags related to
            job signals
        kill_warning_signal (str | Unset): Signal to send when approaching end time (e.g. "10" or "USR1")
        kill_warning_delay (SlurmV0041PostJobAllocateBodyHetjobItemKillWarningDelay | Unset): Number of seconds before
            end time to send the warning signal
        ...
        memory_per_cpu (SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerCpu | Unset): Minimum memory in megabytes per
            allocated CPU
        memory_per_node (SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerNode | Unset): Minimum memory in megabytes per
            allocated CPU
        temporary_disk_per_node (int | Unset): Minimum tmp disk space required per node
        selinux_context (str | Unset): SELinux context
        required_switches (SlurmV0041PostJobAllocateBodyHetjobItemRequiredSwitches | Unset): Maximum number of switches
        segment_size (SlurmV0041PostJobAllocateBodyHetjobItemSegmentSize | Unset): Segment size for topology/block
        ...
        x11 (list[SlurmV0041PostJobAllocateBodyHetjobItemX11Item] | Unset): X11 forwarding options
    ...
    begin_time: SlurmV0041PostJobAllocateBodyHetjobItemBeginTime | Unset = UNSET
    flags: list[SlurmV0041PostJobAllocateBodyHetjobItemFlagsItem] | Unset = UNSET
    ...
    cpu_binding_flags: list[SlurmV0041PostJobAllocateBodyHetjobItemCpuBindingFlagsItem] | Unset = UNSET
    cpu_frequency: str | Unset = UNSET
    cpus_per_tres: str | Unset = UNSET
    crontab: SlurmV0041PostJobAllocateBodyHetjobItemCrontab | Unset = UNSET
    ...
    rlimits: SlurmV0041PostJobAllocateBodyHetjobItemRlimits | Unset = UNSET
    ...
    mail_type: list[SlurmV0041PostJobAllocateBodyHetjobItemMailTypeItem] | Unset = UNSET
    mail_user: str | Unset = UNSET
    mcs_label: str | Unset = UNSET
    memory_binding: str | Unset = UNSET
    memory_binding_type: list[SlurmV0041PostJobAllocateBodyHetjobItemMemoryBindingTypeItem] | Unset = UNSET
    memory_per_tres: str | Unset = UNSET
    name: str | Unset = UNSET
    network: str | Unset = UNSET
    nice: int | Unset = UNSET
    tasks: int | Unset = UNSET
    open_mode: list[SlurmV0041PostJobAllocateBodyHetjobItemOpenModeItem] | Unset = UNSET
    reserve_ports: int | Unset = UNSET
    overcommit: bool | Unset = UNSET
    partition: str | Unset = UNSET
    distribution_plane_size: SlurmV0041PostJobAllocateBodyHetjobItemDistributionPlaneSize | Unset = UNSET
    power_flags: list[Any] | Unset = UNSET
    prefer: str | Unset = UNSET
    hold: bool | Unset = UNSET
    priority: SlurmV0041PostJobAllocateBodyHetjobItemPriority | Unset = UNSET
    profile: list[SlurmV0041PostJobAllocateBodyHetjobItemProfileItem] | Unset = UNSET
    qos: str | Unset = UNSET
    ...
    shared: list[SlurmV0041PostJobAllocateBodyHetjobItemSharedItem] | Unset = UNSET
    exclusive: list[SlurmV0041PostJobAllocateBodyHetjobItemExclusiveItem] | Unset = UNSET
    ...
    time_limit: SlurmV0041PostJobAllocateBodyHetjobItemTimeLimit | Unset = UNSET
    time_minimum: SlurmV0041PostJobAllocateBodyHetjobItemTimeMinimum | Unset = UNSET
    ...
    kill_warning_flags: list[SlurmV0041PostJobAllocateBodyHetjobItemKillWarningFlagsItem] | Unset = UNSET
    kill_warning_signal: str | Unset = UNSET
    kill_warning_delay: SlurmV0041PostJobAllocateBodyHetjobItemKillWarningDelay | Unset = UNSET
    ...
    memory_per_cpu: SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerCpu | Unset = UNSET
    memory_per_node: SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerNode | Unset = UNSET
    temporary_disk_per_node: int | Unset = UNSET
    selinux_context: str | Unset = UNSET
    required_switches: SlurmV0041PostJobAllocateBodyHetjobItemRequiredSwitches | Unset = UNSET
    segment_size: SlurmV0041PostJobAllocateBodyHetjobItemSegmentSize | Unset = UNSET
    ...
    x11: list[SlurmV0041PostJobAllocateBodyHetjobItemX11Item] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        begin_time: SlurmV0041PostJobAllocateBodyHetjobItemBeginTime | Unset
        if isinstance(_begin_time, Unset):
            begin_time = UNSET
        else:
            begin_time = SlurmV0041PostJobAllocateBodyHetjobItemBeginTime.from_dict(_begin_time)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = SlurmV0041PostJobAllocateBodyHetjobItemFlagsItem(flags_item_data)
        ...
        if _cpu_binding_flags is not UNSET:
            ...
            for cpu_binding_flags_item_data in _cpu_binding_flags:
                cpu_binding_flags_item = SlurmV0041PostJobAllocateBodyHetjobItemCpuBindingFlagsItem(
                    cpu_binding_flags_item_data
                )
        ...
        crontab: SlurmV0041PostJobAllocateBodyHetjobItemCrontab | Unset
        if isinstance(_crontab, Unset):
            crontab = UNSET
        else:
            crontab = SlurmV0041PostJobAllocateBodyHetjobItemCrontab.from_dict(_crontab)
        ...
        if isinstance(_rlimits, Unset):
            ...
            rlimits = SlurmV0041PostJobAllocateBodyHetjobItemRlimits.from_dict(_rlimits)
        ...
        if _mail_type is not UNSET:
            ...
            for mail_type_item_data in _mail_type:
                mail_type_item = SlurmV0041PostJobAllocateBodyHetjobItemMailTypeItem(mail_type_item_data)
        ...
        if _memory_binding_type is not UNSET:
            ...
            for memory_binding_type_item_data in _memory_binding_type:
                memory_binding_type_item = SlurmV0041PostJobAllocateBodyHetjobItemMemoryBindingTypeItem(
                    memory_binding_type_item_data
                )
        ...
        if _open_mode is not UNSET:
            ...
            for open_mode_item_data in _open_mode:
                open_mode_item = SlurmV0041PostJobAllocateBodyHetjobItemOpenModeItem(open_mode_item_data)
        ...
        distribution_plane_size: SlurmV0041PostJobAllocateBodyHetjobItemDistributionPlaneSize | Unset
        if isinstance(_distribution_plane_size, Unset):
            distribution_plane_size = UNSET
        else:
            distribution_plane_size = SlurmV0041PostJobAllocateBodyHetjobItemDistributionPlaneSize.from_dict(
                _distribution_plane_size
            )
        ...
        priority: SlurmV0041PostJobAllocateBodyHetjobItemPriority | Unset
        if isinstance(_priority, Unset):
            priority = UNSET
        else:
            priority = SlurmV0041PostJobAllocateBodyHetjobItemPriority.from_dict(_priority)
        ...
        if _profile is not UNSET:
            ...
            for profile_item_data in _profile:
                profile_item = SlurmV0041PostJobAllocateBodyHetjobItemProfileItem(profile_item_data)
        ...
        if _shared is not UNSET:
            ...
            for shared_item_data in _shared:
                shared_item = SlurmV0041PostJobAllocateBodyHetjobItemSharedItem(shared_item_data)
        ...
        if _exclusive is not UNSET:
            ...
            for exclusive_item_data in _exclusive:
                exclusive_item = SlurmV0041PostJobAllocateBodyHetjobItemExclusiveItem(exclusive_item_data)
        ...
        time_limit: SlurmV0041PostJobAllocateBodyHetjobItemTimeLimit | Unset
        if isinstance(_time_limit, Unset):
            time_limit = UNSET
        else:
            time_limit = SlurmV0041PostJobAllocateBodyHetjobItemTimeLimit.from_dict(_time_limit)

        _time_minimum = d.pop("time_minimum", UNSET)
        time_minimum: SlurmV0041PostJobAllocateBodyHetjobItemTimeMinimum | Unset
        if isinstance(_time_minimum, Unset):
            time_minimum = UNSET
        else:
            time_minimum = SlurmV0041PostJobAllocateBodyHetjobItemTimeMinimum.from_dict(_time_minimum)
        ...
        if _kill_warning_flags is not UNSET:
            ...
            for kill_warning_flags_item_data in _kill_warning_flags:
                kill_warning_flags_item = SlurmV0041PostJobAllocateBodyHetjobItemKillWarningFlagsItem(
                    kill_warning_flags_item_data
                )
        ...
        kill_warning_delay: SlurmV0041PostJobAllocateBodyHetjobItemKillWarningDelay | Unset
        if isinstance(_kill_warning_delay, Unset):
            kill_warning_delay = UNSET
        else:
            kill_warning_delay = SlurmV0041PostJobAllocateBodyHetjobItemKillWarningDelay.from_dict(_kill_warning_delay)
        ...
        memory_per_cpu: SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerCpu | Unset
        if isinstance(_memory_per_cpu, Unset):
            memory_per_cpu = UNSET
        else:
            memory_per_cpu = SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerCpu.from_dict(_memory_per_cpu)

        _memory_per_node = d.pop("memory_per_node", UNSET)
        memory_per_node: SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerNode | Unset
        if isinstance(_memory_per_node, Unset):
            memory_per_node = UNSET
        else:
            memory_per_node = SlurmV0041PostJobAllocateBodyHetjobItemMemoryPerNode.from_dict(_memory_per_node)
        ...
        required_switches: SlurmV0041PostJobAllocateBodyHetjobItemRequiredSwitches | Unset
        if isinstance(_required_switches, Unset):
            required_switches = UNSET
        else:
            required_switches = SlurmV0041PostJobAllocateBodyHetjobItemRequiredSwitches.from_dict(_required_switches)

        _segment_size = d.pop("segment_size", UNSET)
        segment_size: SlurmV0041PostJobAllocateBodyHetjobItemSegmentSize | Unset
        if isinstance(_segment_size, Unset):
            segment_size = UNSET
        else:
            segment_size = SlurmV0041PostJobAllocateBodyHetjobItemSegmentSize.from_dict(_segment_size)
        ...
        if _x11 is not UNSET:
            ...
            for x11_item_data in _x11:
                x11_item = SlurmV0041PostJobAllocateBodyHetjobItemX11Item(x11_item_data)
        ...
        slurm_v0041_post_job_allocate_body_hetjob_item = cls(
            account=account,
        ...
        slurm_v0041_post_job_allocate_body_hetjob_item.additional_properties = d
        return slurm_v0041_post_job_allocate_body_hetjob_item
