...
from ..models.v0044_reservation_desc_msg_flags_item import V0044ReservationDescMsgFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_reservation_desc_msg_purge_completed import V0044ReservationDescMsgPurgeCompleted
...
T = TypeVar("T", bound="V0044ReservationDescMsg")


@_attrs_define
class V0044ReservationDescMsg:
    """
    Attributes:
        accounts (list[str] | Unset):
        burst_buffer (str | Unset): BurstBuffer
        comment (str | Unset): Arbitrary string
        core_count (V0044Uint32NoValStruct | Unset):
        duration (V0044Uint32NoValStruct | Unset):
        ...
        features (str | Unset): Requested node features. Multiple values may be "&" separated if all features are
            ...
            features.
        flags (list[V0044ReservationDescMsgFlagsItem] | Unset): Flags associated with this reservation. Note, to remove
            flags use "NO_" prefixed flag excluding NO_HOLD_JOBS_AFTER_END
        groups (list[str] | Unset):
        licenses (list[str] | Unset):
        max_start_delay (V0044Uint32NoValStruct | Unset):
        ...
        purge_completed (V0044ReservationDescMsgPurgeCompleted | Unset):
    ...
    core_count: V0044Uint32NoValStruct | Unset = UNSET
    duration: V0044Uint32NoValStruct | Unset = UNSET
    end_time: V0044Uint64NoValStruct | Unset = UNSET
    features: str | Unset = UNSET
    flags: list[V0044ReservationDescMsgFlagsItem] | Unset = UNSET
    groups: list[str] | Unset = UNSET
    licenses: list[str] | Unset = UNSET
    max_start_delay: V0044Uint32NoValStruct | Unset = UNSET
    name: str | Unset = UNSET
    node_count: V0044Uint32NoValStruct | Unset = UNSET
    node_list: list[str] | Unset = UNSET
    partition: str | Unset = UNSET
    purge_completed: V0044ReservationDescMsgPurgeCompleted | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_core_count, Unset):
            ...
            core_count = V0044Uint32NoValStruct.from_dict(_core_count)
        ...
        if isinstance(_duration, Unset):
            ...
            duration = V0044Uint32NoValStruct.from_dict(_duration)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044ReservationDescMsgFlagsItem(flags_item_data)
        ...
        if isinstance(_max_start_delay, Unset):
            ...
            max_start_delay = V0044Uint32NoValStruct.from_dict(_max_start_delay)
        ...
        if isinstance(_purge_completed, Unset):
            ...
            purge_completed = V0044ReservationDescMsgPurgeCompleted.from_dict(_purge_completed)
        ...
        v0044_reservation_desc_msg = cls(
            accounts=accounts,
        ...
        v0044_reservation_desc_msg.additional_properties = d
        return v0044_reservation_desc_msg
