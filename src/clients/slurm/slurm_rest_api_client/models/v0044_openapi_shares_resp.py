...
if TYPE_CHECKING:
    ...
    from ..models.v0044_shares_resp_msg import V0044SharesRespMsg


T = TypeVar("T", bound="V0044OpenapiSharesResp")


@_attrs_define
class V0044OpenapiSharesResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        shares = V0044SharesRespMsg.from_dict(d.pop("shares"))
        ...
        v0044_openapi_shares_resp.additional_properties = d
        return v0044_openapi_shares_resp
