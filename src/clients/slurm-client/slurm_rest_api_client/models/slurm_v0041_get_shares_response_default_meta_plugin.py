...
T = TypeVar("T", bound="SlurmV0041GetSharesResponseDefaultMetaPlugin")


@_attrs_define
class SlurmV0041GetSharesResponseDefaultMetaPlugin:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_shares_response_default_meta_plugin = cls(
            type_=type_,
            name=name,
        ...
        slurm_v0041_get_shares_response_default_meta_plugin.additional_properties = d
        return slurm_v0041_get_shares_response_default_meta_plugin
