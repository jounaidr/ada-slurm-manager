...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespAssociationsItemMinPriorityThreshold")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespAssociationsItemMinPriorityThreshold:
    """MinPrioThreshold
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_associations_item_min_priority_threshold = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_associations_item_min_priority_threshold.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_associations_item_min_priority_threshold
