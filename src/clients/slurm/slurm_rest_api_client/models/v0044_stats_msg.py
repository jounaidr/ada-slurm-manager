...
if TYPE_CHECKING:
    from ..models.v0044_bf_exit_fields import V0044BfExitFields
    from ..models.v0044_schedule_exit_fields import V0044ScheduleExitFields
    from ..models.v0044_stats_msg_rpc_dump import V0044StatsMsgRpcDump
    from ..models.v0044_stats_msg_rpc_queue import V0044StatsMsgRpcQueue
    from ..models.v0044_stats_msg_rpc_type import V0044StatsMsgRpcType
    from ..models.v0044_stats_msg_rpc_user import V0044StatsMsgRpcUser
    from ..models.v0044_uint_64_no_val_struct import V0044Uint64NoValStruct


T = TypeVar("T", bound="V0044StatsMsg")
...
class V0044StatsMsg:
    ...
    Attributes:
        ...
        req_time (V0044Uint64NoValStruct | Unset):
        req_time_start (V0044Uint64NoValStruct | Unset):
        ...
        schedule_exit (V0044ScheduleExitFields | Unset):
        ...
        job_states_ts (V0044Uint64NoValStruct | Unset):
        ...
        bf_exit (V0044BfExitFields | Unset):
        ...
        bf_when_last_cycle (V0044Uint64NoValStruct | Unset):
        bf_active (bool | Unset): Backfill scheduler currently running
        rpcs_by_message_type (list[V0044StatsMsgRpcType] | Unset): RPCs by type
        rpcs_by_user (list[V0044StatsMsgRpcUser] | Unset): RPCs by user
        pending_rpcs (list[V0044StatsMsgRpcQueue] | Unset): Pending RPCs
        pending_rpcs_by_hostlist (list[V0044StatsMsgRpcDump] | Unset): Pending RPCs by hostlist
    """

    parts_packed: int | Unset = UNSET
    req_time: V0044Uint64NoValStruct | Unset = UNSET
    req_time_start: V0044Uint64NoValStruct | Unset = UNSET
    ...
    schedule_exit: V0044ScheduleExitFields | Unset = UNSET
    ...
    job_states_ts: V0044Uint64NoValStruct | Unset = UNSET
    ...
    bf_exit: V0044BfExitFields | Unset = UNSET
    ...
    bf_when_last_cycle: V0044Uint64NoValStruct | Unset = UNSET
    bf_active: bool | Unset = UNSET
    rpcs_by_message_type: list[V0044StatsMsgRpcType] | Unset = UNSET
    rpcs_by_user: list[V0044StatsMsgRpcUser] | Unset = UNSET
    pending_rpcs: list[V0044StatsMsgRpcQueue] | Unset = UNSET
    pending_rpcs_by_hostlist: list[V0044StatsMsgRpcDump] | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.rpcs_by_message_type, Unset):
            ...
            for componentsschemasv0_0_44_stats_msg_rpcs_by_type_item_data in self.rpcs_by_message_type:
                componentsschemasv0_0_44_stats_msg_rpcs_by_type_item = (
                    componentsschemasv0_0_44_stats_msg_rpcs_by_type_item_data.to_dict()
                )
                rpcs_by_message_type.append(componentsschemasv0_0_44_stats_msg_rpcs_by_type_item)

        rpcs_by_user: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.rpcs_by_user, Unset):
            rpcs_by_user = []
            for componentsschemasv0_0_44_stats_msg_rpcs_by_user_item_data in self.rpcs_by_user:
                componentsschemasv0_0_44_stats_msg_rpcs_by_user_item = (
                    componentsschemasv0_0_44_stats_msg_rpcs_by_user_item_data.to_dict()
                )
                rpcs_by_user.append(componentsschemasv0_0_44_stats_msg_rpcs_by_user_item)

        pending_rpcs: list[dict[str, Any]] | Unset = UNSET
        if not isinstance(self.pending_rpcs, Unset):
            pending_rpcs = []
            for componentsschemasv0_0_44_stats_msg_rpcs_queue_item_data in self.pending_rpcs:
                componentsschemasv0_0_44_stats_msg_rpcs_queue_item = (
                    componentsschemasv0_0_44_stats_msg_rpcs_queue_item_data.to_dict()
                )
                pending_rpcs.append(componentsschemasv0_0_44_stats_msg_rpcs_queue_item)
        ...
        if not isinstance(self.pending_rpcs_by_hostlist, Unset):
            ...
            for componentsschemasv0_0_44_stats_msg_rpcs_dump_item_data in self.pending_rpcs_by_hostlist:
                componentsschemasv0_0_44_stats_msg_rpcs_dump_item = (
                    componentsschemasv0_0_44_stats_msg_rpcs_dump_item_data.to_dict()
                )
                pending_rpcs_by_hostlist.append(componentsschemasv0_0_44_stats_msg_rpcs_dump_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_req_time, Unset):
            ...
            req_time = V0044Uint64NoValStruct.from_dict(_req_time)
        ...
        if isinstance(_req_time_start, Unset):
            ...
            req_time_start = V0044Uint64NoValStruct.from_dict(_req_time_start)
        ...
        if isinstance(_schedule_exit, Unset):
            ...
            schedule_exit = V0044ScheduleExitFields.from_dict(_schedule_exit)
        ...
        if isinstance(_job_states_ts, Unset):
            ...
            job_states_ts = V0044Uint64NoValStruct.from_dict(_job_states_ts)
        ...
        if isinstance(_bf_exit, Unset):
            ...
            bf_exit = V0044BfExitFields.from_dict(_bf_exit)
        ...
        if isinstance(_bf_when_last_cycle, Unset):
            ...
            bf_when_last_cycle = V0044Uint64NoValStruct.from_dict(_bf_when_last_cycle)
        ...
        if _rpcs_by_message_type is not UNSET:
            rpcs_by_message_type = []
            for componentsschemasv0_0_44_stats_msg_rpcs_by_type_item_data in _rpcs_by_message_type:
                componentsschemasv0_0_44_stats_msg_rpcs_by_type_item = V0044StatsMsgRpcType.from_dict(
                    componentsschemasv0_0_44_stats_msg_rpcs_by_type_item_data
                )
        ...
        if _rpcs_by_user is not UNSET:
            rpcs_by_user = []
            for componentsschemasv0_0_44_stats_msg_rpcs_by_user_item_data in _rpcs_by_user:
                componentsschemasv0_0_44_stats_msg_rpcs_by_user_item = V0044StatsMsgRpcUser.from_dict(
                    componentsschemasv0_0_44_stats_msg_rpcs_by_user_item_data
                )
        ...
        if _pending_rpcs is not UNSET:
            pending_rpcs = []
            for componentsschemasv0_0_44_stats_msg_rpcs_queue_item_data in _pending_rpcs:
                componentsschemasv0_0_44_stats_msg_rpcs_queue_item = V0044StatsMsgRpcQueue.from_dict(
                    componentsschemasv0_0_44_stats_msg_rpcs_queue_item_data
                )
        ...
        if _pending_rpcs_by_hostlist is not UNSET:
            pending_rpcs_by_hostlist = []
            for componentsschemasv0_0_44_stats_msg_rpcs_dump_item_data in _pending_rpcs_by_hostlist:
                componentsschemasv0_0_44_stats_msg_rpcs_dump_item = V0044StatsMsgRpcDump.from_dict(
                    componentsschemasv0_0_44_stats_msg_rpcs_dump_item_data
                )
        ...
        v0044_stats_msg.additional_properties = d
        return v0044_stats_msg
