...
T = TypeVar("T", bound="V0044OpenapiInstancesResp")


@_attrs_define
class V0044OpenapiInstancesResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_instances_resp = cls(
            instances=instances,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_instances_resp.additional_properties = d
        return v0044_openapi_instances_resp
