...
class V0043AssocMaxJobs:
    """
    Attributes:
        per (V0043AssocMaxJobsPer | Unset):
        active (V0043Uint32NoValStruct | Unset):
        accruing (V0043Uint32NoValStruct | Unset):
        total (V0043Uint32NoValStruct | Unset):
    """

    per: V0043AssocMaxJobsPer | Unset = UNSET
    active: V0043Uint32NoValStruct | Unset = UNSET
    accruing: V0043Uint32NoValStruct | Unset = UNSET
    total: V0043Uint32NoValStruct | Unset = UNSET
