...
from ..models.v0037_ping_ping import V0037PingPing
from ..types import UNSET, Unset

T = TypeVar("T", bound="V0037Ping")
...
class V0037Ping:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        ping: V0037PingPing | Unset
        if isinstance(_ping, Unset):
            ping = UNSET
        else:
            ping = V0037PingPing(_ping)
        ...
        v0037_ping.additional_properties = d
        return v0037_ping
