...
T = TypeVar("T", bound="V0039MetaSlurmVersion")


@_attrs_define
class V0039MetaSlurmVersion:
    """
    Attributes:
        major (int | Unset):
        micro (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0039_meta_slurm_version = cls(
            major=major,
            micro=micro,
            minor=minor,
        )

        v0039_meta_slurm_version.additional_properties = d
        return v0039_meta_slurm_version
