...
T = TypeVar("T", bound="V0041OpenapiPartitionRespPartitionsItemTimeoutsResume")


@_attrs_define
class V0041OpenapiPartitionRespPartitionsItemTimeoutsResume:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_partition_resp_partitions_item_timeouts_resume = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_partition_resp_partitions_item_timeouts_resume.additional_properties = d
        return v0041_openapi_partition_resp_partitions_item_timeouts_resume
