...
class V0043AssocMaxTresGroup:
    """
    Attributes:
        minutes (list[V0043Tres] | Unset):
        active (list[V0043Tres] | Unset):
    """

    minutes: list[V0043Tres] | Unset = UNSET
    active: list[V0043Tres] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _minutes is not UNSET:
            minutes = []
            for componentsschemasv0_0_43_tres_list_item_data in _minutes:
        ...
        if _active is not UNSET:
            active = []
            for componentsschemasv0_0_43_tres_list_item_data in _active:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
