...
from ..models.v0039_rollup_stats_ptr_item_type import V0039RollupStatsPtrItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="V0039RollupStatsPtrItem")


@_attrs_define
class V0039RollupStatsPtrItem:
    """recorded rollup statistics

    Attributes:
        type_ (V0039RollupStatsPtrItemType | Unset): type
    ...
    type_: V0039RollupStatsPtrItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: V0039RollupStatsPtrItemType | Unset
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = V0039RollupStatsPtrItemType(_type_)
        ...
        v0039_rollup_stats_ptr_item = cls(
            type_=type_,
            last_run=last_run,
            max_cycle=max_cycle,
        ...
        v0039_rollup_stats_ptr_item.additional_properties = d
        return v0039_rollup_stats_ptr_item
