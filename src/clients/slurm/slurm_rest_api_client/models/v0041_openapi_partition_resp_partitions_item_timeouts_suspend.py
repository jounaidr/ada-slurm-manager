...
T = TypeVar("T", bound="V0041OpenapiPartitionRespPartitionsItemTimeoutsSuspend")


@_attrs_define
class V0041OpenapiPartitionRespPartitionsItemTimeoutsSuspend:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_partition_resp_partitions_item_timeouts_suspend = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_partition_resp_partitions_item_timeouts_suspend.additional_properties = d
        return v0041_openapi_partition_resp_partitions_item_timeouts_suspend
