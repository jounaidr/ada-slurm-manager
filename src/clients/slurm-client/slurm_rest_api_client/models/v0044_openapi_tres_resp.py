...
T = TypeVar("T", bound="V0044OpenapiTresResp")


@_attrs_define
class V0044OpenapiTresResp:
    """
    Attributes:
        tres (list[V0044Tres]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_44_tres_list_item_data in _tres:
            componentsschemasv0_0_44_tres_list_item = V0044Tres.from_dict(componentsschemasv0_0_44_tres_list_item_data)
        ...
        v0044_openapi_tres_resp.additional_properties = d
        return v0044_openapi_tres_resp
