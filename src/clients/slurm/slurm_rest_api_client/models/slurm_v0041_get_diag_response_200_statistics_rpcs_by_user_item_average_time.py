...
T = TypeVar("T", bound="SlurmV0041GetDiagResponse200StatisticsRpcsByUserItemAverageTime")


@_attrs_define
class SlurmV0041GetDiagResponse200StatisticsRpcsByUserItemAverageTime:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_diag_response_200_statistics_rpcs_by_user_item_average_time = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_get_diag_response_200_statistics_rpcs_by_user_item_average_time.additional_properties = d
        return slurm_v0041_get_diag_response_200_statistics_rpcs_by_user_item_average_time
