...
T = TypeVar("T", bound="Dbv0038AssociationMaxTresMinutesPer")


@_attrs_define
class Dbv0038AssociationMaxTresMinutesPer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_association_max_tres_minutes_per = cls(
            job=job,
        )

        dbv_0038_association_max_tres_minutes_per.additional_properties = d
        return dbv_0038_association_max_tres_minutes_per
