...
from ..models.v0044_cluster_rec_flags_item import V0044ClusterRecFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_cluster_rec_associations import V0044ClusterRecAssociations
    from ..models.v0044_cluster_rec_controller import V0044ClusterRecController
    from ..models.v0044_tres import V0044Tres


T = TypeVar("T", bound="V0044ClusterRec")


@_attrs_define
class V0044ClusterRec:
    """
    Attributes:
        controller (V0044ClusterRecController | Unset):
        flags (list[V0044ClusterRecFlagsItem] | Unset): Flags
        name (str | Unset): ClusterName
        nodes (str | Unset): Node names
        select_plugin (str | Unset):
        associations (V0044ClusterRecAssociations | Unset):
        rpc_version (int | Unset): RPC version used in the cluster
        tres (list[V0044Tres] | Unset):
    """

    controller: V0044ClusterRecController | Unset = UNSET
    flags: list[V0044ClusterRecFlagsItem] | Unset = UNSET
    name: str | Unset = UNSET
    nodes: str | Unset = UNSET
    select_plugin: str | Unset = UNSET
    associations: V0044ClusterRecAssociations | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_controller, Unset):
            ...
            controller = V0044ClusterRecController.from_dict(_controller)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044ClusterRecFlagsItem(flags_item_data)
        ...
        if isinstance(_associations, Unset):
            ...
            associations = V0044ClusterRecAssociations.from_dict(_associations)
        ...
        v0044_cluster_rec.additional_properties = d
        return v0044_cluster_rec
