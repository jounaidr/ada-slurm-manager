...
from ...models.slurmdb_v0041_get_users_admin_level import SlurmdbV0041GetUsersAdminLevel
from ...models.v0041_openapi_users_resp import V0041OpenapiUsersResp
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    admin_level: SlurmdbV0041GetUsersAdminLevel | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0041OpenapiUsersResp:
    if response.status_code == 200:
        response_200 = V0041OpenapiUsersResp.from_dict(response.json())

        return response_200

    response_default = V0041OpenapiUsersResp.from_dict(response.json())
...
) -> Response[V0041OpenapiUsersResp]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        admin_level (SlurmdbV0041GetUsersAdminLevel | Unset):
