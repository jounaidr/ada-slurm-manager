...
def _get_kwargs(
    ...
    *,
    ...
    flags: SlurmV0043GetPartitionFlags | Unset = UNSET,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/slurm/v0.0.43/partition/{partition_name}".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0043OpenapiPartitionResp:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        flags (SlurmV0043GetPartitionFlags | Unset):
...
def sync(
    ...
    *,
    ...
    update_time: str | Unset = UNSET,
    flags: SlurmV0043GetPartitionFlags | Unset = UNSET,
) -> V0043OpenapiPartitionResp | None:
    """get partition info
