...
class V0043AssocMax:
    """
    Attributes:
        jobs (V0043AssocMaxJobs | Unset):
        tres (V0043AssocMaxTres | Unset):
        per (V0043AssocMaxPer | Unset):
    """

    jobs: V0043AssocMaxJobs | Unset = UNSET
    tres: V0043AssocMaxTres | Unset = UNSET
    per: V0043AssocMaxPer | Unset = UNSET
