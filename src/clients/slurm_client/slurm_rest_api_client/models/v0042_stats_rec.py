...
class V0042StatsRec:
    ...
    Attributes:
        ...
        rollups (V0042RollupStats | Unset):
        rp_cs (list[V0042StatsRpc] | Unset):
        users (list[V0042StatsUser] | Unset):
    """

    time_start: int | Unset = UNSET
    rollups: V0042RollupStats | Unset = UNSET
    rp_cs: list[V0042StatsRpc] | Unset = UNSET
    users: list[V0042StatsUser] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _rp_cs is not UNSET:
            rp_cs = []
            for componentsschemasv0_0_42_stats_rpc_list_item_data in _rp_cs:
        ...
        if _users is not UNSET:
            users = []
            for componentsschemasv0_0_42_stats_user_list_item_data in _users:
