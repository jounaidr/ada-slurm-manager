...
class V0042Accounting:
    """
    Attributes:
        allocated (V0042AccountingAllocated | Unset):
        id (int | Unset): Association ID or Workload characterization key ID
        id_alt (int | Unset): Alternate ID (not currently used)
        start (int | Unset): When the record was started (UNIX timestamp)
        tres (V0042Tres | Unset):
    """

    allocated: V0042AccountingAllocated | Unset = UNSET
    id: int | Unset = UNSET
    id_alt: int | Unset = UNSET
    start: int | Unset = UNSET
    tres: V0042Tres | Unset = UNSET
