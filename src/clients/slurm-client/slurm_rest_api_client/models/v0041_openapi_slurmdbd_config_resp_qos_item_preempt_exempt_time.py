...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespQosItemPreemptExemptTime")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespQosItemPreemptExemptTime:
    """PreemptExemptTime
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_qos_item_preempt_exempt_time = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_qos_item_preempt_exempt_time.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_qos_item_preempt_exempt_time
