...
T = TypeVar("T", bound="V0044JobArrayResponseMsgEntry")


@_attrs_define
class V0044JobArrayResponseMsgEntry:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_job_array_response_msg_entry = cls(
            job_id=job_id,
            step_id=step_id,
            error=error,
        ...
        v0044_job_array_response_msg_entry.additional_properties = d
        return v0044_job_array_response_msg_entry
