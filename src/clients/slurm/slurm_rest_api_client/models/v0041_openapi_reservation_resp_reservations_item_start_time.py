...
T = TypeVar("T", bound="V0041OpenapiReservationRespReservationsItemStartTime")


@_attrs_define
class V0041OpenapiReservationRespReservationsItemStartTime:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_reservation_resp_reservations_item_start_time = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_reservation_resp_reservations_item_start_time.additional_properties = d
        return v0041_openapi_reservation_resp_reservations_item_start_time
