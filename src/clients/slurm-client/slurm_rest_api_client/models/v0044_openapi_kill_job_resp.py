...
T = TypeVar("T", bound="V0044OpenapiKillJobResp")


@_attrs_define
class V0044OpenapiKillJobResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_kill_job_resp = cls(
            status=status,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_kill_job_resp.additional_properties = d
        return v0044_openapi_kill_job_resp
