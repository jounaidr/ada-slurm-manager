...
T = TypeVar("T", bound="SlurmV0041GetDiagResponseDefaultStatisticsJobStatesTs")


@_attrs_define
class SlurmV0041GetDiagResponseDefaultStatisticsJobStatesTs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_diag_response_default_statistics_job_states_ts = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_get_diag_response_default_statistics_job_states_ts.additional_properties = d
        return slurm_v0041_get_diag_response_default_statistics_job_states_ts
