...
class V0043QosLimitsMaxJobsActiveJobsPer:
    """
    Attributes:
        account (V0043Uint32NoValStruct | Unset):
        user (V0043Uint32NoValStruct | Unset):
    """

    account: V0043Uint32NoValStruct | Unset = UNSET
    user: V0043Uint32NoValStruct | Unset = UNSET
