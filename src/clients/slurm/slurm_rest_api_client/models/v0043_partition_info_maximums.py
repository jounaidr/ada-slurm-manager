...
class V0043PartitionInfoMaximums:
    """
    Attributes:
        cpus_per_node (V0043Uint32NoValStruct | Unset):
        cpus_per_socket (V0043Uint32NoValStruct | Unset):
        memory_per_cpu (int | Unset): Raw value for MaxMemPerCPU or MaxMemPerNode
        partition_memory_per_cpu (V0043Uint64NoValStruct | Unset):
        partition_memory_per_node (V0043Uint64NoValStruct | Unset):
        nodes (V0043Uint32NoValStruct | Unset):
        ...
        oversubscribe (V0043PartitionInfoMaximumsOversubscribe | Unset):
        time (V0043Uint32NoValStruct | Unset):
        over_time_limit (V0043Uint16NoValStruct | Unset):
    """

    cpus_per_node: V0043Uint32NoValStruct | Unset = UNSET
    cpus_per_socket: V0043Uint32NoValStruct | Unset = UNSET
    memory_per_cpu: int | Unset = UNSET
    partition_memory_per_cpu: V0043Uint64NoValStruct | Unset = UNSET
    partition_memory_per_node: V0043Uint64NoValStruct | Unset = UNSET
    nodes: V0043Uint32NoValStruct | Unset = UNSET
    shares: int | Unset = UNSET
    oversubscribe: V0043PartitionInfoMaximumsOversubscribe | Unset = UNSET
    time: V0043Uint32NoValStruct | Unset = UNSET
    over_time_limit: V0043Uint16NoValStruct | Unset = UNSET
