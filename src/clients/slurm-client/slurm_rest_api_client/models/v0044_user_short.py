...
from ..models.v0044_user_short_adminlevel_item import V0044UserShortAdminlevelItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="V0044UserShort")


@_attrs_define
class V0044UserShort:
    """
    Attributes:
        adminlevel (list[V0044UserShortAdminlevelItem] | Unset): AdminLevel granted to the user
        defaultqos (int | Unset): Default QOS
        defaultaccount (str | Unset): Default account
        defaultwckey (str | Unset): Default WCKey
    """

    adminlevel: list[V0044UserShortAdminlevelItem] | Unset = UNSET
    defaultqos: int | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _adminlevel is not UNSET:
            ...
            for adminlevel_item_data in _adminlevel:
                adminlevel_item = V0044UserShortAdminlevelItem(adminlevel_item_data)
        ...
        v0044_user_short.additional_properties = d
        return v0044_user_short
