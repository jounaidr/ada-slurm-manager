...
from ...models.v0038_jobs_response import V0038JobsResponse
...
) -> V0038JobsResponse | list[V0038Error]:
    if response.status_code == 200:
        response_200 = V0038JobsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[V0038JobsResponse | list[V0038Error]]:
    return Response(
...
def sync(
    *,
    client: AuthenticatedClient | Client,
    update_time: int | Unset = UNSET,
) -> V0038JobsResponse | list[V0038Error] | None:
    """get list of jobs
