...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdQosRespQosItemLimitsMaxJobsPerAccount")


@_attrs_define
class V0041OpenapiSlurmdbdQosRespQosItemLimitsMaxJobsPerAccount:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_qos_resp_qos_item_limits_max_jobs_per_account = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_qos_resp_qos_item_limits_max_jobs_per_account.additional_properties = d
        return v0041_openapi_slurmdbd_qos_resp_qos_item_limits_max_jobs_per_account
