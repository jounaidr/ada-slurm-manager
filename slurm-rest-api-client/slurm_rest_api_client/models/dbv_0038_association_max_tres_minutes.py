...
if TYPE_CHECKING:
    from ..models.dbv_0038_association_max_tres_minutes_per import Dbv0038AssociationMaxTresMinutesPer
    from ..models.dbv_0038_tres_list_item import Dbv0038TresListItem


T = TypeVar("T", bound="Dbv0038AssociationMaxTresMinutes")


@_attrs_define
class Dbv0038AssociationMaxTresMinutes:
    """Max TRES minutes settings

    Attributes:
        per (Dbv0038AssociationMaxTresMinutesPer | Unset): Max TRES minutes per settings
        total (list[Dbv0038TresListItem] | Unset): TRES list of attributes
    """

    per: Dbv0038AssociationMaxTresMinutesPer | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        per: Dbv0038AssociationMaxTresMinutesPer | Unset
        if isinstance(_per, Unset):
            per = UNSET
        else:
            per = Dbv0038AssociationMaxTresMinutesPer.from_dict(_per)
        ...
        dbv_0038_association_max_tres_minutes = cls(
            per=per,
            total=total,
        )

        dbv_0038_association_max_tres_minutes.additional_properties = d
        return dbv_0038_association_max_tres_minutes
