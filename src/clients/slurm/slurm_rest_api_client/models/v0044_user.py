...
from ..models.v0044_user_administrator_level_item import V0044UserAdministratorLevelItem
from ..models.v0044_user_flags_item import V0044UserFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_assoc_short import V0044AssocShort
    from ..models.v0044_coord import V0044Coord
    from ..models.v0044_user_default import V0044UserDefault
    from ..models.v0044_wckey import V0044Wckey


T = TypeVar("T", bound="V0044User")
...
class V0044User:
    ...
    Attributes:
        name (str): User name
        administrator_level (list[V0044UserAdministratorLevelItem] | Unset): AdminLevel granted to the user
        associations (list[V0044AssocShort] | Unset):
        coordinators (list[V0044Coord] | Unset):
        default (V0044UserDefault | Unset):
        flags (list[V0044UserFlagsItem] | Unset): Flags associated with this user
        old_name (str | Unset): Previous user name
        wckeys (list[V0044Wckey] | Unset):
    """

    name: str
    administrator_level: list[V0044UserAdministratorLevelItem] | Unset = UNSET
    associations: list[V0044AssocShort] | Unset = UNSET
    coordinators: list[V0044Coord] | Unset = UNSET
    default: V0044UserDefault | Unset = UNSET
    flags: list[V0044UserFlagsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _administrator_level is not UNSET:
            ...
            for administrator_level_item_data in _administrator_level:
                administrator_level_item = V0044UserAdministratorLevelItem(administrator_level_item_data)
        ...
        if isinstance(_default, Unset):
            ...
            default = V0044UserDefault.from_dict(_default)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044UserFlagsItem(flags_item_data)
        ...
        v0044_user.additional_properties = d
        return v0044_user
