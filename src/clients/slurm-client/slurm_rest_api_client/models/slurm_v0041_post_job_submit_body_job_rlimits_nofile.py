...
T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJobRlimitsNofile")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJobRlimitsNofile:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_submit_body_job_rlimits_nofile = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_submit_body_job_rlimits_nofile.additional_properties = d
        return slurm_v0041_post_job_submit_body_job_rlimits_nofile
