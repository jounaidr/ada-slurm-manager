...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItemRequiredMemoryPerCpu")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItemRequiredMemoryPerCpu:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item_required_memory_per_cpu = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_jobs_resp_jobs_item_required_memory_per_cpu.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item_required_memory_per_cpu
