...
class V0043Qos:
    ...
    Attributes:
        ...
        flags (list[V0043QosFlagsItem] | Unset): Flags, to avoid modifying current values specify NOT_SET
        id (int | Unset): Unique ID
        limits (V0043QosLimits | Unset):
        name (str | Unset): Name
        preempt (V0043QosPreempt | Unset):
        priority (V0043Uint32NoValStruct | Unset):
        usage_factor (V0043Float64NoValStruct | Unset):
        usage_threshold (V0043Float64NoValStruct | Unset):
    """

    description: str | Unset = UNSET
    flags: list[V0043QosFlagsItem] | Unset = UNSET
    id: int | Unset = UNSET
    limits: V0043QosLimits | Unset = UNSET
    name: str | Unset = UNSET
    preempt: V0043QosPreempt | Unset = UNSET
    priority: V0043Uint32NoValStruct | Unset = UNSET
    usage_factor: V0043Float64NoValStruct | Unset = UNSET
    usage_threshold: V0043Float64NoValStruct | Unset = UNSET
