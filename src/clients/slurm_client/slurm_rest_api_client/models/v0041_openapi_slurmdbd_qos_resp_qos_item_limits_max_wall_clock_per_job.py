...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdQosRespQosItemLimitsMaxWallClockPerJob")


@_attrs_define
class V0041OpenapiSlurmdbdQosRespQosItemLimitsMaxWallClockPerJob:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_qos_resp_qos_item_limits_max_wall_clock_per_job = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_qos_resp_qos_item_limits_max_wall_clock_per_job.additional_properties = d
        return v0041_openapi_slurmdbd_qos_resp_qos_item_limits_max_wall_clock_per_job
