...
T = TypeVar("T", bound="Dbv0038CoordinatorInfo")
...
class Dbv0038CoordinatorInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_coordinator_info = cls(
            name=name,
            direct=direct,
        )

        dbv_0038_coordinator_info.additional_properties = d
        return dbv_0038_coordinator_info
