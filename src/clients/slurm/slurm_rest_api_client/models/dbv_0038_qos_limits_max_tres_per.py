...
T = TypeVar("T", bound="Dbv0038QosLimitsMaxTresPer")


@_attrs_define
class Dbv0038QosLimitsMaxTresPer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_qos_limits_max_tres_per = cls(
            account=account,
            job=job,
            node=node,
            user=user,
        ...
        dbv_0038_qos_limits_max_tres_per.additional_properties = d
        return dbv_0038_qos_limits_max_tres_per
