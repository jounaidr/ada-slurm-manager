...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/slurmdb/v0.0.43/wckey/{id}".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0043OpenapiWckeyRemovedResp:
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> V0043OpenapiWckeyRemovedResp | None:
    """Delete wckey
