...
T = TypeVar("T", bound="V0044Float64NoValStruct")


@_attrs_define
class V0044Float64NoValStruct:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_float_64_no_val_struct = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0044_float_64_no_val_struct.additional_properties = d
        return v0044_float_64_no_val_struct
