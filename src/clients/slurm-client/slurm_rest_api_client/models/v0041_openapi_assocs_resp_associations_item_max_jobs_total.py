...
T = TypeVar("T", bound="V0041OpenapiAssocsRespAssociationsItemMaxJobsTotal")


@_attrs_define
class V0041OpenapiAssocsRespAssociationsItemMaxJobsTotal:
    """MaxSubmitJobs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_assocs_resp_associations_item_max_jobs_total = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_assocs_resp_associations_item_max_jobs_total.additional_properties = d
        return v0041_openapi_assocs_resp_associations_item_max_jobs_total
