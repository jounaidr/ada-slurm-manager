...
from ...models.slurmdb_v0041_get_cluster_classification import SlurmdbV0041GetClusterClassification
from ...models.slurmdb_v0041_get_cluster_flags import SlurmdbV0041GetClusterFlags
from ...models.v0041_openapi_clusters_resp import V0041OpenapiClustersResp
...
def _get_kwargs(
    cluster_name: str,
    *,
    classification: SlurmdbV0041GetClusterClassification | Unset = UNSET,
    cluster: str | Unset = UNSET,
    federation: str | Unset = UNSET,
    flags: SlurmdbV0041GetClusterFlags | Unset = UNSET,
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0041OpenapiClustersResp:
    if response.status_code == 200:
        response_200 = V0041OpenapiClustersResp.from_dict(response.json())

        return response_200

    response_default = V0041OpenapiClustersResp.from_dict(response.json())
...
) -> Response[V0041OpenapiClustersResp]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_name (str):
        classification (SlurmdbV0041GetClusterClassification | Unset):
        cluster (str | Unset):
        federation (str | Unset):
        flags (SlurmdbV0041GetClusterFlags | Unset):
        format_ (str | Unset):
