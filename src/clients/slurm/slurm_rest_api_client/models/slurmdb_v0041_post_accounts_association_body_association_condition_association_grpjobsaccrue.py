...
T = TypeVar("T", bound="SlurmdbV0041PostAccountsAssociationBodyAssociationConditionAssociationGrpjobsaccrue")


@_attrs_define
class SlurmdbV0041PostAccountsAssociationBodyAssociationConditionAssociationGrpjobsaccrue:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_post_accounts_association_body_association_condition_association_grpjobsaccrue = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurmdb_v0041_post_accounts_association_body_association_condition_association_grpjobsaccrue.additional_properties = d
        return slurmdb_v0041_post_accounts_association_body_association_condition_association_grpjobsaccrue
