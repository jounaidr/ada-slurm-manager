...
if TYPE_CHECKING:
    ...
    from ..models.v0044_stats_rec import V0044StatsRec


T = TypeVar("T", bound="V0044OpenapiSlurmdbdStatsResp")


@_attrs_define
class V0044OpenapiSlurmdbdStatsResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        statistics = V0044StatsRec.from_dict(d.pop("statistics"))
        ...
        v0044_openapi_slurmdbd_stats_resp = cls(
            statistics=statistics,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_slurmdbd_stats_resp.additional_properties = d
        return v0044_openapi_slurmdbd_stats_resp
