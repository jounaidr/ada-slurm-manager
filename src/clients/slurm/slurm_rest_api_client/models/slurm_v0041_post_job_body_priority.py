...
T = TypeVar("T", bound="SlurmV0041PostJobBodyPriority")


@_attrs_define
class SlurmV0041PostJobBodyPriority:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_body_priority = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_body_priority.additional_properties = d
        return slurm_v0041_post_job_body_priority
