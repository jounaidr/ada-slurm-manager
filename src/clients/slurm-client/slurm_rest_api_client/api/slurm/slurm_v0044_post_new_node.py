...
from ...models.v0044_openapi_create_node_req import V0044OpenapiCreateNodeReq
...
def _get_kwargs(
    *,
    body: V0044OpenapiCreateNodeReq | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/slurm/v0.0.44/new/node/",
    }
...
def sync_detailed(
    *,
    ...
    Args:
        body (V0044OpenapiCreateNodeReq | Unset):
