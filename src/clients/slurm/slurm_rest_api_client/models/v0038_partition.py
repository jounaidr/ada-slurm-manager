...
T = TypeVar("T", bound="V0038Partition")
...
class V0038Partition:
    ...
    Attributes:
        ...
        maximum_memory_per_node (int | Unset): maximum memory per allocated node (MiB)
        ...
        maximum_memory_per_cpu (int | Unset): maximum memory per allocated CPU (MiB)
        default_memory_per_node (int | Unset): default MB memory per allocated node
    """
    ...
    maximum_memory_per_cpu: int | Unset = UNSET
    default_memory_per_node: int | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        maximum_memory_per_cpu = self.maximum_memory_per_cpu

        default_memory_per_node = self.default_memory_per_node
        ...
        if maximum_memory_per_cpu is not UNSET:
            field_dict["maximum_memory_per_cpu"] = maximum_memory_per_cpu
        if default_memory_per_node is not UNSET:
            field_dict["default_memory_per_node"] = default_memory_per_node
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        maximum_memory_per_cpu = d.pop("maximum_memory_per_cpu", UNSET)

        default_memory_per_node = d.pop("default_memory_per_node", UNSET)
        ...
        v0038_partition.additional_properties = d
        return v0038_partition
