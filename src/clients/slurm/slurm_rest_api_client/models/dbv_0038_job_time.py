...
if TYPE_CHECKING:
    from ..models.dbv_0038_job_time_system import Dbv0038JobTimeSystem
    from ..models.dbv_0038_job_time_total import Dbv0038JobTimeTotal
    from ..models.dbv_0038_job_time_user import Dbv0038JobTimeUser


T = TypeVar("T", bound="Dbv0038JobTime")


@_attrs_define
class Dbv0038JobTime:
    """Time properties
    ...
    Attributes:
        ...
        system (Dbv0038JobTimeSystem | Unset): System time values
        total (Dbv0038JobTimeTotal | Unset): System time values
        user (Dbv0038JobTimeUser | Unset): User land time values
    ...
    system: Dbv0038JobTimeSystem | Unset = UNSET
    total: Dbv0038JobTimeTotal | Unset = UNSET
    user: Dbv0038JobTimeUser | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        system: Dbv0038JobTimeSystem | Unset
        if isinstance(_system, Unset):
            system = UNSET
        else:
            system = Dbv0038JobTimeSystem.from_dict(_system)

        _total = d.pop("total", UNSET)
        total: Dbv0038JobTimeTotal | Unset
        if isinstance(_total, Unset):
            total = UNSET
        else:
            total = Dbv0038JobTimeTotal.from_dict(_total)

        _user = d.pop("user", UNSET)
        user: Dbv0038JobTimeUser | Unset
        if isinstance(_user, Unset):
            user = UNSET
        else:
            user = Dbv0038JobTimeUser.from_dict(_user)

        limit = d.pop("limit", UNSET)

        dbv_0038_job_time = cls(
            elapsed=elapsed,
            eligible=eligible,
            end=end,
            start=start,
        ...
        dbv_0038_job_time.additional_properties = d
        return dbv_0038_job_time
