...
from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_flags_item import V0041OpenapiSlurmdbdJobsRespJobsItemFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_array import V0041OpenapiSlurmdbdJobsRespJobsItemArray
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_association import (
        V0041OpenapiSlurmdbdJobsRespJobsItemAssociation,
    )
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_comment import V0041OpenapiSlurmdbdJobsRespJobsItemComment
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_derived_exit_code import (
        V0041OpenapiSlurmdbdJobsRespJobsItemDerivedExitCode,
    )
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_exit_code import (
        V0041OpenapiSlurmdbdJobsRespJobsItemExitCode,
    )
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_het import V0041OpenapiSlurmdbdJobsRespJobsItemHet
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_mcs import V0041OpenapiSlurmdbdJobsRespJobsItemMcs
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_priority import (
        V0041OpenapiSlurmdbdJobsRespJobsItemPriority,
    )
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_required import (
        V0041OpenapiSlurmdbdJobsRespJobsItemRequired,
    )
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_reservation import (
        V0041OpenapiSlurmdbdJobsRespJobsItemReservation,
    )
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_state import V0041OpenapiSlurmdbdJobsRespJobsItemState
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item import (
        V0041OpenapiSlurmdbdJobsRespJobsItemStepsItem,
    )
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_time import V0041OpenapiSlurmdbdJobsRespJobsItemTime
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_tres import V0041OpenapiSlurmdbdJobsRespJobsItemTres
    from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_wckey import V0041OpenapiSlurmdbdJobsRespJobsItemWckey


T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItem")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItem:
    """
    Attributes:
        account (str | Unset): Account the job ran under
        comment (V0041OpenapiSlurmdbdJobsRespJobsItemComment | Unset):
        allocation_nodes (int | Unset): List of nodes allocated to the job
        array (V0041OpenapiSlurmdbdJobsRespJobsItemArray | Unset):
        association (V0041OpenapiSlurmdbdJobsRespJobsItemAssociation | Unset): Unique identifier for the association
        ...
        derived_exit_code (V0041OpenapiSlurmdbdJobsRespJobsItemDerivedExitCode | Unset): Highest exit code of all job
            steps
        time (V0041OpenapiSlurmdbdJobsRespJobsItemTime | Unset):
        exit_code (V0041OpenapiSlurmdbdJobsRespJobsItemExitCode | Unset): Exit code
        ...
        flags (list[V0041OpenapiSlurmdbdJobsRespJobsItemFlagsItem] | Unset): Flags associated with the job
        group (str | Unset): Group ID of the user that owns the job
        het (V0041OpenapiSlurmdbdJobsRespJobsItemHet | Unset):
        job_id (int | Unset): Job ID
        name (str | Unset): Job name
        licenses (str | Unset): License(s) required by the job
        mcs (V0041OpenapiSlurmdbdJobsRespJobsItemMcs | Unset):
        ...
        priority (V0041OpenapiSlurmdbdJobsRespJobsItemPriority | Unset): Request specific job priority
        qos (str | Unset): Quality of Service assigned to the job
        required (V0041OpenapiSlurmdbdJobsRespJobsItemRequired | Unset):
        kill_request_user (str | Unset): User ID that requested termination of the job
        reservation (V0041OpenapiSlurmdbdJobsRespJobsItemReservation | Unset):
        ...
        state (V0041OpenapiSlurmdbdJobsRespJobsItemState | Unset):
        steps (list[V0041OpenapiSlurmdbdJobsRespJobsItemStepsItem] | Unset): Individual steps in the job
        submit_line (str | Unset): Command used to submit the job
        tres (V0041OpenapiSlurmdbdJobsRespJobsItemTres | Unset):
        used_gres (str | Unset): Generic resources used by job
        user (str | Unset): User that owns the job
        wckey (V0041OpenapiSlurmdbdJobsRespJobsItemWckey | Unset): Workload characterization key
        working_directory (str | Unset): Path to current working directory
    """

    account: str | Unset = UNSET
    comment: V0041OpenapiSlurmdbdJobsRespJobsItemComment | Unset = UNSET
    allocation_nodes: int | Unset = UNSET
    array: V0041OpenapiSlurmdbdJobsRespJobsItemArray | Unset = UNSET
    association: V0041OpenapiSlurmdbdJobsRespJobsItemAssociation | Unset = UNSET
    block: str | Unset = UNSET
    cluster: str | Unset = UNSET
    constraints: str | Unset = UNSET
    container: str | Unset = UNSET
    derived_exit_code: V0041OpenapiSlurmdbdJobsRespJobsItemDerivedExitCode | Unset = UNSET
    time: V0041OpenapiSlurmdbdJobsRespJobsItemTime | Unset = UNSET
    exit_code: V0041OpenapiSlurmdbdJobsRespJobsItemExitCode | Unset = UNSET
    extra: str | Unset = UNSET
    failed_node: str | Unset = UNSET
    flags: list[V0041OpenapiSlurmdbdJobsRespJobsItemFlagsItem] | Unset = UNSET
    group: str | Unset = UNSET
    het: V0041OpenapiSlurmdbdJobsRespJobsItemHet | Unset = UNSET
    job_id: int | Unset = UNSET
    name: str | Unset = UNSET
    licenses: str | Unset = UNSET
    mcs: V0041OpenapiSlurmdbdJobsRespJobsItemMcs | Unset = UNSET
    nodes: str | Unset = UNSET
    partition: str | Unset = UNSET
    hold: bool | Unset = UNSET
    priority: V0041OpenapiSlurmdbdJobsRespJobsItemPriority | Unset = UNSET
    qos: str | Unset = UNSET
    required: V0041OpenapiSlurmdbdJobsRespJobsItemRequired | Unset = UNSET
    kill_request_user: str | Unset = UNSET
    reservation: V0041OpenapiSlurmdbdJobsRespJobsItemReservation | Unset = UNSET
    ...
    state: V0041OpenapiSlurmdbdJobsRespJobsItemState | Unset = UNSET
    steps: list[V0041OpenapiSlurmdbdJobsRespJobsItemStepsItem] | Unset = UNSET
    submit_line: str | Unset = UNSET
    tres: V0041OpenapiSlurmdbdJobsRespJobsItemTres | Unset = UNSET
    used_gres: str | Unset = UNSET
    user: str | Unset = UNSET
    wckey: V0041OpenapiSlurmdbdJobsRespJobsItemWckey | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.v0041_openapi_slurmdbd_jobs_resp_jobs_item_comment import (
        ...
        if isinstance(_comment, Unset):
            ...
            comment = V0041OpenapiSlurmdbdJobsRespJobsItemComment.from_dict(_comment)
        ...
        if isinstance(_array, Unset):
            ...
            array = V0041OpenapiSlurmdbdJobsRespJobsItemArray.from_dict(_array)

        _association = d.pop("association", UNSET)
        association: V0041OpenapiSlurmdbdJobsRespJobsItemAssociation | Unset
        if isinstance(_association, Unset):
            association = UNSET
        else:
            association = V0041OpenapiSlurmdbdJobsRespJobsItemAssociation.from_dict(_association)
        ...
        derived_exit_code: V0041OpenapiSlurmdbdJobsRespJobsItemDerivedExitCode | Unset
        if isinstance(_derived_exit_code, Unset):
            derived_exit_code = UNSET
        else:
            derived_exit_code = V0041OpenapiSlurmdbdJobsRespJobsItemDerivedExitCode.from_dict(_derived_exit_code)
        ...
        if isinstance(_time, Unset):
            ...
            time = V0041OpenapiSlurmdbdJobsRespJobsItemTime.from_dict(_time)

        _exit_code = d.pop("exit_code", UNSET)
        exit_code: V0041OpenapiSlurmdbdJobsRespJobsItemExitCode | Unset
        if isinstance(_exit_code, Unset):
            exit_code = UNSET
        else:
            exit_code = V0041OpenapiSlurmdbdJobsRespJobsItemExitCode.from_dict(_exit_code)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0041OpenapiSlurmdbdJobsRespJobsItemFlagsItem(flags_item_data)
        ...
        if isinstance(_het, Unset):
            ...
            het = V0041OpenapiSlurmdbdJobsRespJobsItemHet.from_dict(_het)
        ...
        if isinstance(_mcs, Unset):
            ...
            mcs = V0041OpenapiSlurmdbdJobsRespJobsItemMcs.from_dict(_mcs)
        ...
        priority: V0041OpenapiSlurmdbdJobsRespJobsItemPriority | Unset
        if isinstance(_priority, Unset):
            priority = UNSET
        else:
            priority = V0041OpenapiSlurmdbdJobsRespJobsItemPriority.from_dict(_priority)
        ...
        if isinstance(_required, Unset):
            ...
            required = V0041OpenapiSlurmdbdJobsRespJobsItemRequired.from_dict(_required)
        ...
        if isinstance(_reservation, Unset):
            ...
            reservation = V0041OpenapiSlurmdbdJobsRespJobsItemReservation.from_dict(_reservation)
        ...
        if isinstance(_state, Unset):
            ...
            state = V0041OpenapiSlurmdbdJobsRespJobsItemState.from_dict(_state)
        ...
        if _steps is not UNSET:
            ...
            for steps_item_data in _steps:
                steps_item = V0041OpenapiSlurmdbdJobsRespJobsItemStepsItem.from_dict(steps_item_data)
        ...
        if isinstance(_tres, Unset):
            ...
            tres = V0041OpenapiSlurmdbdJobsRespJobsItemTres.from_dict(_tres)
        ...
        wckey: V0041OpenapiSlurmdbdJobsRespJobsItemWckey | Unset
        if isinstance(_wckey, Unset):
            wckey = UNSET
        else:
            wckey = V0041OpenapiSlurmdbdJobsRespJobsItemWckey.from_dict(_wckey)

        working_directory = d.pop("working_directory", UNSET)

        v0041_openapi_slurmdbd_jobs_resp_jobs_item = cls(
            account=account,
            comment=comment,
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item
