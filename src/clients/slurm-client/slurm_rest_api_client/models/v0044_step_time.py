...
if TYPE_CHECKING:
    from ..models.v0044_step_time_system import V0044StepTimeSystem
    from ..models.v0044_step_time_total import V0044StepTimeTotal
    from ..models.v0044_step_time_user import V0044StepTimeUser
...
T = TypeVar("T", bound="V0044StepTime")
...
class V0044StepTime:
    ...
    Attributes:
        ...
        end (V0044Uint64NoValStruct | Unset):
        start (V0044Uint64NoValStruct | Unset):
        suspended (int | Unset): Total time in suspended state in seconds
        system (V0044StepTimeSystem | Unset):
        limit (V0044Uint32NoValStruct | Unset):
        total (V0044StepTimeTotal | Unset):
        user (V0044StepTimeUser | Unset):
    """

    elapsed: int | Unset = UNSET
    end: V0044Uint64NoValStruct | Unset = UNSET
    start: V0044Uint64NoValStruct | Unset = UNSET
    suspended: int | Unset = UNSET
    system: V0044StepTimeSystem | Unset = UNSET
    limit: V0044Uint32NoValStruct | Unset = UNSET
    total: V0044StepTimeTotal | Unset = UNSET
    user: V0044StepTimeUser | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_end, Unset):
            ...
            end = V0044Uint64NoValStruct.from_dict(_end)
        ...
        if isinstance(_start, Unset):
            ...
            start = V0044Uint64NoValStruct.from_dict(_start)
        ...
        if isinstance(_system, Unset):
            ...
            system = V0044StepTimeSystem.from_dict(_system)
        ...
        if isinstance(_total, Unset):
            ...
            total = V0044StepTimeTotal.from_dict(_total)
        ...
        if isinstance(_user, Unset):
            ...
            user = V0044StepTimeUser.from_dict(_user)
        ...
        v0044_step_time.additional_properties = d
        return v0044_step_time
