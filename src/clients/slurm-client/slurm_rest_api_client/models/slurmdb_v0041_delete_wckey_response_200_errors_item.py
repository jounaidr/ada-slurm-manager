...
T = TypeVar("T", bound="SlurmdbV0041DeleteWckeyResponse200ErrorsItem")


@_attrs_define
class SlurmdbV0041DeleteWckeyResponse200ErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_delete_wckey_response_200_errors_item = cls(
        ...
        slurmdb_v0041_delete_wckey_response_200_errors_item.additional_properties = d
        return slurmdb_v0041_delete_wckey_response_200_errors_item
