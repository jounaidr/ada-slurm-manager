...
if TYPE_CHECKING:
    from ..models.dbv_0037_qos_limits import Dbv0037QosLimits
    from ..models.dbv_0037_qos_preempt import Dbv0037QosPreempt


T = TypeVar("T", bound="Dbv0037Qos")
...
class Dbv0037Qos:
    ...
    Attributes:
        ...
        limits (Dbv0037QosLimits | Unset): Assigned limits
        preempt (Dbv0037QosPreempt | Unset): Preemption settings
    ...
    id: str | Unset = UNSET
    limits: Dbv0037QosLimits | Unset = UNSET
    preempt: Dbv0037QosPreempt | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        limits: Dbv0037QosLimits | Unset
        if isinstance(_limits, Unset):
            limits = UNSET
        else:
            limits = Dbv0037QosLimits.from_dict(_limits)

        _preempt = d.pop("preempt", UNSET)
        preempt: Dbv0037QosPreempt | Unset
        if isinstance(_preempt, Unset):
            preempt = UNSET
        else:
            preempt = Dbv0037QosPreempt.from_dict(_preempt)
        ...
        dbv_0037_qos.additional_properties = d
        return dbv_0037_qos
