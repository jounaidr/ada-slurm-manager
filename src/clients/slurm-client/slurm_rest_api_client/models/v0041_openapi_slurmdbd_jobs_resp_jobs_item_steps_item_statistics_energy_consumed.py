...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItemStepsItemStatisticsEnergyConsumed")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItemStepsItemStatisticsEnergyConsumed:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_statistics_energy_consumed = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_statistics_energy_consumed.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_statistics_energy_consumed
