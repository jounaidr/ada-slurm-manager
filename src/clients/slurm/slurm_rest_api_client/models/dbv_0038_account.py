...
T = TypeVar("T", bound="Dbv0038Account")
...
class Dbv0038Account:
    ...
    Attributes:
        associations (list[Dbv0038AssociationShortInfo] | Unset): List of assigned associations
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_account.additional_properties = d
        return dbv_0038_account
