...
T = TypeVar("T", bound="V0037JobSubmissionResponse")
...
class V0037JobSubmissionResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0037_job_submission_response = cls(
            errors=errors,
            job_id=job_id,
            step_id=step_id,
        ...
        v0037_job_submission_response.additional_properties = d
        return v0037_job_submission_response
