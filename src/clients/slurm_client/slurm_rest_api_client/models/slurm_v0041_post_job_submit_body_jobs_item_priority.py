...
T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJobsItemPriority")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJobsItemPriority:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_submit_body_jobs_item_priority = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_submit_body_jobs_item_priority.additional_properties = d
        return slurm_v0041_post_job_submit_body_jobs_item_priority
