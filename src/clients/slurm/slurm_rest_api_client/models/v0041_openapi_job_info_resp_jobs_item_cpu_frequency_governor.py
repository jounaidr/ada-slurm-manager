...
T = TypeVar("T", bound="V0041OpenapiJobInfoRespJobsItemCpuFrequencyGovernor")


@_attrs_define
class V0041OpenapiJobInfoRespJobsItemCpuFrequencyGovernor:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_job_info_resp_jobs_item_cpu_frequency_governor = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_job_info_resp_jobs_item_cpu_frequency_governor.additional_properties = d
        return v0041_openapi_job_info_resp_jobs_item_cpu_frequency_governor
