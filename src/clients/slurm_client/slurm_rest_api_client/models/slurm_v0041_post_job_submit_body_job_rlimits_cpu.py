...
T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJobRlimitsCpu")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJobRlimitsCpu:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_submit_body_job_rlimits_cpu = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_submit_body_job_rlimits_cpu.additional_properties = d
        return slurm_v0041_post_job_submit_body_job_rlimits_cpu
