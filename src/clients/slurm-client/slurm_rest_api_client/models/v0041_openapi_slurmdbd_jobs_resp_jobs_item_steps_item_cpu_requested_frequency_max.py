...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItemStepsItemCPURequestedFrequencyMax")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItemStepsItemCPURequestedFrequencyMax:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_cpu_requested_frequency_max = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_cpu_requested_frequency_max.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_cpu_requested_frequency_max
