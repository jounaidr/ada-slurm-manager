...
T = TypeVar("T", bound="SlurmV0041PostJobSubmitResponseDefaultMetaPlugin")


@_attrs_define
class SlurmV0041PostJobSubmitResponseDefaultMetaPlugin:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_submit_response_default_meta_plugin = cls(
            type_=type_,
            name=name,
        ...
        slurm_v0041_post_job_submit_response_default_meta_plugin.additional_properties = d
        return slurm_v0041_post_job_submit_response_default_meta_plugin
