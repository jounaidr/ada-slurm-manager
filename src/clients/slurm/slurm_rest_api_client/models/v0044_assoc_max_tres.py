...
if TYPE_CHECKING:
    from ..models.v0044_assoc_max_tres_group import V0044AssocMaxTresGroup
    from ..models.v0044_assoc_max_tres_minutes import V0044AssocMaxTresMinutes
    from ..models.v0044_assoc_max_tres_per import V0044AssocMaxTresPer
    from ..models.v0044_tres import V0044Tres


T = TypeVar("T", bound="V0044AssocMaxTres")


@_attrs_define
class V0044AssocMaxTres:
    """
    Attributes:
        total (list[V0044Tres] | Unset):
        group (V0044AssocMaxTresGroup | Unset):
        minutes (V0044AssocMaxTresMinutes | Unset):
        per (V0044AssocMaxTresPer | Unset):
    """

    total: list[V0044Tres] | Unset = UNSET
    group: V0044AssocMaxTresGroup | Unset = UNSET
    minutes: V0044AssocMaxTresMinutes | Unset = UNSET
    per: V0044AssocMaxTresPer | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_group, Unset):
            ...
            group = V0044AssocMaxTresGroup.from_dict(_group)
        ...
        if isinstance(_minutes, Unset):
            ...
            minutes = V0044AssocMaxTresMinutes.from_dict(_minutes)
        ...
        if isinstance(_per, Unset):
            ...
            per = V0044AssocMaxTresPer.from_dict(_per)

        v0044_assoc_max_tres = cls(
            total=total,
            group=group,
            minutes=minutes,
            per=per,
        ...
        v0044_assoc_max_tres.additional_properties = d
        return v0044_assoc_max_tres
