...
if TYPE_CHECKING:
    ...
    from ..models.v0039_stats_rec_ptr import V0039StatsRecPtr


T = TypeVar("T", bound="Dbv0039Diag")
...
class Dbv0039Diag:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_statistics, Unset):
            ...
            statistics = V0039StatsRecPtr.from_dict(_statistics)
        ...
        dbv_0039_diag.additional_properties = d
        return dbv_0039_diag
