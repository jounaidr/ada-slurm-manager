...
T = TypeVar("T", bound="V0041OpenapiReservationRespReservationsItemWatts")


@_attrs_define
class V0041OpenapiReservationRespReservationsItemWatts:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_reservation_resp_reservations_item_watts = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_reservation_resp_reservations_item_watts.additional_properties = d
        return v0041_openapi_reservation_resp_reservations_item_watts
