...
from ...models.dbv_0038_config_info import Dbv0038ConfigInfo
...
) -> Dbv0038ConfigInfo | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038ConfigInfo.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038ConfigInfo | list[Dbv0038Error]]:
    return Response(
...
def sync(
    *,
    client: AuthenticatedClient | Client,
) -> Dbv0038ConfigInfo | list[Dbv0038Error] | None:
    """Dump all configuration information
