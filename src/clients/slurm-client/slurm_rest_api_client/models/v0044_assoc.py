...
from ..models.v0044_assoc_flags_item import V0044AssocFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_accounting import V0044Accounting
    from ..models.v0044_assoc_default import V0044AssocDefault
    from ..models.v0044_assoc_max import V0044AssocMax
    from ..models.v0044_assoc_min import V0044AssocMin
    from ..models.v0044_uint_32_no_val_struct import V0044Uint32NoValStruct


T = TypeVar("T", bound="V0044Assoc")
...
class V0044Assoc:
    ...
    Attributes:
        ...
        default (V0044AssocDefault | Unset):
        flags (list[V0044AssocFlagsItem] | Unset): Flags on the association
        max_ (V0044AssocMax | Unset):
        id (int | Unset): Unique ID (Association ID)
    ...
    default: V0044AssocDefault | Unset = UNSET
    flags: list[V0044AssocFlagsItem] | Unset = UNSET
    max_: V0044AssocMax | Unset = UNSET
    id: int | Unset = UNSET
    is_default: bool | Unset = UNSET
    lineage: str | Unset = UNSET
    min_: V0044AssocMin | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_default, Unset):
            ...
            default = V0044AssocDefault.from_dict(_default)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044AssocFlagsItem(flags_item_data)
        ...
        if isinstance(_max_, Unset):
            ...
            max_ = V0044AssocMax.from_dict(_max_)
        ...
        if isinstance(_min_, Unset):
            ...
            min_ = V0044AssocMin.from_dict(_min_)
        ...
        v0044_assoc.additional_properties = d
        return v0044_assoc
