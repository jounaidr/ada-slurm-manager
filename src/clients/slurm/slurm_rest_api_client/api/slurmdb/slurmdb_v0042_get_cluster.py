...
def _get_kwargs(
    cluster_name: str,
    *,
    classification: SlurmdbV0042GetClusterClassification | Unset = UNSET,
    cluster: str | Unset = UNSET,
    federation: str | Unset = UNSET,
    flags: SlurmdbV0042GetClusterFlags | Unset = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/slurmdb/v0.0.42/cluster/{cluster_name}".format(
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiClustersResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiClustersResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiClustersResp.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_name (str):
        classification (SlurmdbV0042GetClusterClassification | Unset):
        cluster (str | Unset):
        federation (str | Unset):
        flags (SlurmdbV0042GetClusterFlags | Unset):
        format_ (str | Unset):
