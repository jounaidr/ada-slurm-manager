...
T = TypeVar("T", bound="V0044OpenapiMetaPlugin")


@_attrs_define
class V0044OpenapiMetaPlugin:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_meta_plugin.additional_properties = d
        return v0044_openapi_meta_plugin
