...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItemStepsItemExitCodeReturnCode")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItemStepsItemExitCodeReturnCode:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_exit_code_return_code = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_exit_code_return_code.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_exit_code_return_code
