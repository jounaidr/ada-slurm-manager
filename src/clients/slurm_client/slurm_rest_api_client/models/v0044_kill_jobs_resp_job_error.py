...
T = TypeVar("T", bound="V0044KillJobsRespJobError")


@_attrs_define
class V0044KillJobsRespJobError:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_kill_jobs_resp_job_error = cls(
            string=string,
            code=code,
            message=message,
        )

        v0044_kill_jobs_resp_job_error.additional_properties = d
        return v0044_kill_jobs_resp_job_error
