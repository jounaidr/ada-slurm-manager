...
class V0042OpenapiSlurmdbdConfigResp:
    """
    Attributes:
        clusters (list[V0042ClusterRec] | Unset):
        tres (list[V0042Tres] | Unset):
        accounts (list[V0042Account] | Unset):
        users (list[V0042User] | Unset):
        qos (list[V0042Qos] | Unset):
        wckeys (list[V0042Wckey] | Unset):
        associations (list[V0042Assoc] | Unset):
        instances (list[V0042Instance] | Unset):
        meta (V0042OpenapiMeta | Unset):
        errors (list[V0042OpenapiError] | Unset):
        warnings (list[V0042OpenapiWarning] | Unset):
    """

    clusters: list[V0042ClusterRec] | Unset = UNSET
    tres: list[V0042Tres] | Unset = UNSET
    accounts: list[V0042Account] | Unset = UNSET
    users: list[V0042User] | Unset = UNSET
    qos: list[V0042Qos] | Unset = UNSET
    wckeys: list[V0042Wckey] | Unset = UNSET
    associations: list[V0042Assoc] | Unset = UNSET
    instances: list[V0042Instance] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _users is not UNSET:
            ...
            for componentsschemasv0_0_42_user_list_item_data in _users:
                componentsschemasv0_0_42_user_list_item = V0042User.from_dict(
                    componentsschemasv0_0_42_user_list_item_data
                )
