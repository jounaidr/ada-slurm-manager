...
class V0043AssocMaxJobsPer:
    ...
    Attributes:
        ...
        submitted (V0043Uint32NoValStruct | Unset):
        wall_clock (V0043Uint32NoValStruct | Unset):
    """

    count: V0043Uint32NoValStruct | Unset = UNSET
    accruing: V0043Uint32NoValStruct | Unset = UNSET
    submitted: V0043Uint32NoValStruct | Unset = UNSET
    wall_clock: V0043Uint32NoValStruct | Unset = UNSET
