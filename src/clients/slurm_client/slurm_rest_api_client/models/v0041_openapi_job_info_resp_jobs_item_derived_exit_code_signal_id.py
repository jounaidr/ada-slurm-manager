...
T = TypeVar("T", bound="V0041OpenapiJobInfoRespJobsItemDerivedExitCodeSignalId")


@_attrs_define
class V0041OpenapiJobInfoRespJobsItemDerivedExitCodeSignalId:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_job_info_resp_jobs_item_derived_exit_code_signal_id = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_job_info_resp_jobs_item_derived_exit_code_signal_id.additional_properties = d
        return v0041_openapi_job_info_resp_jobs_item_derived_exit_code_signal_id
