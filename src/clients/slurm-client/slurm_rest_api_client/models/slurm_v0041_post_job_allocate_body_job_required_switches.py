...
T = TypeVar("T", bound="SlurmV0041PostJobAllocateBodyJobRequiredSwitches")


@_attrs_define
class SlurmV0041PostJobAllocateBodyJobRequiredSwitches:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_allocate_body_job_required_switches = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_allocate_body_job_required_switches.additional_properties = d
        return slurm_v0041_post_job_allocate_body_job_required_switches
