...
T = TypeVar("T", bound="V0044StatsUserTime")


@_attrs_define
class V0044StatsUserTime:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_stats_user_time = cls(
            average=average,
            total=total,
        )

        v0044_stats_user_time.additional_properties = d
        return v0044_stats_user_time
