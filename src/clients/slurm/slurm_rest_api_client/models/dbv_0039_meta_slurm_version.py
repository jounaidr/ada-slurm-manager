...
T = TypeVar("T", bound="Dbv0039MetaSlurmVersion")


@_attrs_define
class Dbv0039MetaSlurmVersion:
    """
    Attributes:
        major (int | Unset):
        micro (int | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0039_meta_slurm_version = cls(
            major=major,
            micro=micro,
            minor=minor,
        )

        dbv_0039_meta_slurm_version.additional_properties = d
        return dbv_0039_meta_slurm_version
