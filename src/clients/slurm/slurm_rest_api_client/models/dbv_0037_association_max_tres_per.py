...
T = TypeVar("T", bound="Dbv0037AssociationMaxTresPer")


@_attrs_define
class Dbv0037AssociationMaxTresPer:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0037_association_max_tres_per = cls(
            job=job,
            node=node,
        )

        dbv_0037_association_max_tres_per.additional_properties = d
        return dbv_0037_association_max_tres_per
