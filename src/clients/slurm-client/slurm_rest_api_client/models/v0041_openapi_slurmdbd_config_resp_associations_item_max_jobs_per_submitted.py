...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdConfigRespAssociationsItemMaxJobsPerSubmitted")


@_attrs_define
class V0041OpenapiSlurmdbdConfigRespAssociationsItemMaxJobsPerSubmitted:
    """GrpSubmitJobs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_per_submitted = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_per_submitted.additional_properties = d
        return v0041_openapi_slurmdbd_config_resp_associations_item_max_jobs_per_submitted
