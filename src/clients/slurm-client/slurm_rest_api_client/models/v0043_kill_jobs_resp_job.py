...
class V0043KillJobsRespJob:
    ...
    Attributes:
        ...
        error (V0043KillJobsRespJobError | Unset):
        federation (V0043KillJobsRespJobFederation | Unset):
    """

    step_id: str
    job_id: V0043Uint32NoValStruct
    error: V0043KillJobsRespJobError | Unset = UNSET
    federation: V0043KillJobsRespJobFederation | Unset = UNSET
