...
T = TypeVar("T", bound="Dbv0038ResponseUserUpdate")
...
class Dbv0038ResponseUserUpdate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_response_user_update = cls(
            meta=meta,
            errors=errors,
        )

        dbv_0038_response_user_update.additional_properties = d
        return dbv_0038_response_user_update
