...
T = TypeVar("T", bound="Dbv0037UserAssociations")


@_attrs_define
class Dbv0037UserAssociations:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0037_user_associations = cls(
            root=root,
        )

        dbv_0037_user_associations.additional_properties = d
        return dbv_0037_user_associations
