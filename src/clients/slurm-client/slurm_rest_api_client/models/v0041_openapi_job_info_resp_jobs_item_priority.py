...
T = TypeVar("T", bound="V0041OpenapiJobInfoRespJobsItemPriority")


@_attrs_define
class V0041OpenapiJobInfoRespJobsItemPriority:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_job_info_resp_jobs_item_priority = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_job_info_resp_jobs_item_priority.additional_properties = d
        return v0041_openapi_job_info_resp_jobs_item_priority
