...
if TYPE_CHECKING:
    ...
    from ..models.v0044_partition_info import V0044PartitionInfo
    from ..models.v0044_uint_64_no_val_struct import V0044Uint64NoValStruct


T = TypeVar("T", bound="V0044OpenapiPartitionResp")


@_attrs_define
class V0044OpenapiPartitionResp:
    """
    Attributes:
    ...
    def to_dict(self) -> dict[str, Any]:
        partitions = []
        for componentsschemasv0_0_44_partition_info_msg_item_data in self.partitions:
            componentsschemasv0_0_44_partition_info_msg_item = (
                componentsschemasv0_0_44_partition_info_msg_item_data.to_dict()
            )
            partitions.append(componentsschemasv0_0_44_partition_info_msg_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for componentsschemasv0_0_44_partition_info_msg_item_data in _partitions:
            componentsschemasv0_0_44_partition_info_msg_item = V0044PartitionInfo.from_dict(
                componentsschemasv0_0_44_partition_info_msg_item_data
            )
        ...
        v0044_openapi_partition_resp = cls(
            partitions=partitions,
            last_update=last_update,
            meta=meta,
            errors=errors,
        ...
        v0044_openapi_partition_resp.additional_properties = d
        return v0044_openapi_partition_resp
