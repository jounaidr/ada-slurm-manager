...
if TYPE_CHECKING:
    from ..models.v0038_node_allocation import V0038NodeAllocation


T = TypeVar("T", bound="V0038JobResources")
...
class V0038JobResources:
    ...
    Attributes:
        ...
        allocated_nodes (list[V0038NodeAllocation] | Unset): array of allocated nodes
    """

    nodes: str | Unset = UNSET
    allocated_cpus: int | Unset = UNSET
    allocated_hosts: int | Unset = UNSET
    allocated_nodes: list[V0038NodeAllocation] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _allocated_nodes is not UNSET:
            ...
            for allocated_nodes_item_data in _allocated_nodes:
                allocated_nodes_item = V0038NodeAllocation.from_dict(allocated_nodes_item_data)

                allocated_nodes.append(allocated_nodes_item)

        v0038_job_resources = cls(
            nodes=nodes,
        ...
        v0038_job_resources.additional_properties = d
        return v0038_job_resources
