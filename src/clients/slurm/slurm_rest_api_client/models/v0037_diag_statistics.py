...
T = TypeVar("T", bound="V0037DiagStatistics")


@_attrs_define
class V0037DiagStatistics:
    """Slurm statistics
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0037_diag_statistics.additional_properties = d
        return v0037_diag_statistics
