...
from ...models.slurmdb_v0044_get_users_admin_level import SlurmdbV0044GetUsersAdminLevel
...
def _get_kwargs(
    *,
    admin_level: SlurmdbV0044GetUsersAdminLevel | Unset = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        admin_level (SlurmdbV0044GetUsersAdminLevel | Unset):
