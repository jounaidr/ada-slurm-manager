...
T = TypeVar("T", bound="V0044OpenapiJobModifyResp")


@_attrs_define
class V0044OpenapiJobModifyResp:
    """
    Attributes:
        results (list[str]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_job_modify_resp = cls(
            results=results,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_job_modify_resp.additional_properties = d
        return v0044_openapi_job_modify_resp
