...
T = TypeVar("T", bound="Dbv0037AssociationUsage")


@_attrs_define
class Dbv0037AssociationUsage:
    """Association usage
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0037_association_usage = cls(
        ...
        dbv_0037_association_usage.additional_properties = d
        return dbv_0037_association_usage
