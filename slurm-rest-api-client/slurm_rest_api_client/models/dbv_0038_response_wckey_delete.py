...
T = TypeVar("T", bound="Dbv0038ResponseWckeyDelete")
...
class Dbv0038ResponseWckeyDelete:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_response_wckey_delete = cls(
            meta=meta,
            errors=errors,
        )

        dbv_0038_response_wckey_delete.additional_properties = d
        return dbv_0038_response_wckey_delete
