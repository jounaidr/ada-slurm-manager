...
T = TypeVar("T", bound="SlurmV0041PostJobAllocateResponseDefaultErrorsItem")


@_attrs_define
class SlurmV0041PostJobAllocateResponseDefaultErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_allocate_response_default_errors_item = cls(
        ...
        slurm_v0041_post_job_allocate_response_default_errors_item.additional_properties = d
        return slurm_v0041_post_job_allocate_response_default_errors_item
