...
from ..models.v0044_cron_entry_flags_item import V0044CronEntryFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_cron_entry_line import V0044CronEntryLine


T = TypeVar("T", bound="V0044CronEntry")


@_attrs_define
class V0044CronEntry:
    """
    Attributes:
        flags (list[V0044CronEntryFlagsItem] | Unset): Flags
        ...
        line (V0044CronEntryLine | Unset):
    """

    flags: list[V0044CronEntryFlagsItem] | Unset = UNSET
    ...
    line: V0044CronEntryLine | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0044CronEntryFlagsItem(flags_item_data)
        ...
        if isinstance(_line, Unset):
            ...
            line = V0044CronEntryLine.from_dict(_line)

        v0044_cron_entry = cls(
            flags=flags,
            minute=minute,
            hour=hour,
        ...
        v0044_cron_entry.additional_properties = d
        return v0044_cron_entry
