...
if TYPE_CHECKING:
    from ..models.v0044_job import V0044Job
...
T = TypeVar("T", bound="V0044OpenapiSlurmdbdJobsResp")


@_attrs_define
class V0044OpenapiSlurmdbdJobsResp:
    """
    Attributes:
        jobs (list[V0044Job]):
    ...
    def to_dict(self) -> dict[str, Any]:
        jobs = []
        for componentsschemasv0_0_44_job_list_item_data in self.jobs:
            componentsschemasv0_0_44_job_list_item = componentsschemasv0_0_44_job_list_item_data.to_dict()
            jobs.append(componentsschemasv0_0_44_job_list_item)
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs = []
        _jobs = d.pop("jobs")
        for componentsschemasv0_0_44_job_list_item_data in _jobs:
            componentsschemasv0_0_44_job_list_item = V0044Job.from_dict(componentsschemasv0_0_44_job_list_item_data)
        ...
        v0044_openapi_slurmdbd_jobs_resp = cls(
            jobs=jobs,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_slurmdbd_jobs_resp.additional_properties = d
        return v0044_openapi_slurmdbd_jobs_resp
