...
from ..models.v0044_assoc_shares_obj_wrap_type_item import V0044AssocSharesObjWrapTypeItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0044_assoc_shares_obj_wrap_fairshare import V0044AssocSharesObjWrapFairshare
    from ..models.v0044_assoc_shares_obj_wrap_tres import V0044AssocSharesObjWrapTres
...
T = TypeVar("T", bound="V0044AssocSharesObjWrap")


@_attrs_define
class V0044AssocSharesObjWrap:
    """
    Attributes:
        ...
        shares_normalized (V0044Float64NoValStruct | Unset):
        shares (V0044Uint32NoValStruct | Unset):
        tres (V0044AssocSharesObjWrapTres | Unset):
        effective_usage (V0044Float64NoValStruct | Unset):
        usage_normalized (V0044Float64NoValStruct | Unset):
        usage (int | Unset): Measure of tresbillableunits usage
        fairshare (V0044AssocSharesObjWrapFairshare | Unset):
        type_ (list[V0044AssocSharesObjWrapTypeItem] | Unset): User or account association
    """
    ...
    shares_normalized: V0044Float64NoValStruct | Unset = UNSET
    shares: V0044Uint32NoValStruct | Unset = UNSET
    tres: V0044AssocSharesObjWrapTres | Unset = UNSET
    effective_usage: V0044Float64NoValStruct | Unset = UNSET
    usage_normalized: V0044Float64NoValStruct | Unset = UNSET
    usage: int | Unset = UNSET
    fairshare: V0044AssocSharesObjWrapFairshare | Unset = UNSET
    type_: list[V0044AssocSharesObjWrapTypeItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_shares_normalized, Unset):
            ...
            shares_normalized = V0044Float64NoValStruct.from_dict(_shares_normalized)
        ...
        if isinstance(_shares, Unset):
            ...
            shares = V0044Uint32NoValStruct.from_dict(_shares)
        ...
        if isinstance(_tres, Unset):
            ...
            tres = V0044AssocSharesObjWrapTres.from_dict(_tres)
        ...
        if isinstance(_effective_usage, Unset):
            ...
            effective_usage = V0044Float64NoValStruct.from_dict(_effective_usage)
        ...
        if isinstance(_usage_normalized, Unset):
            ...
            usage_normalized = V0044Float64NoValStruct.from_dict(_usage_normalized)
        ...
        if isinstance(_fairshare, Unset):
            ...
            fairshare = V0044AssocSharesObjWrapFairshare.from_dict(_fairshare)
        ...
        if _type_ is not UNSET:
            ...
            for type_item_data in _type_:
                type_item = V0044AssocSharesObjWrapTypeItem(type_item_data)

                type_.append(type_item)

        v0044_assoc_shares_obj_wrap = cls(
            id=id,
            cluster=cluster,
            name=name,
            parent=parent,
        ...
        v0044_assoc_shares_obj_wrap.additional_properties = d
        return v0044_assoc_shares_obj_wrap
