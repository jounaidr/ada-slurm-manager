...
if TYPE_CHECKING:
    ...
    from ..models.v0044_user_short import V0044UserShort
    from ..models.v0044_users_add_cond import V0044UsersAddCond


T = TypeVar("T", bound="V0044OpenapiUsersAddCondResp")


@_attrs_define
class V0044OpenapiUsersAddCondResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        association_condition = V0044UsersAddCond.from_dict(d.pop("association_condition"))

        user = V0044UserShort.from_dict(d.pop("user"))
        ...
        v0044_openapi_users_add_cond_resp = cls(
            association_condition=association_condition,
            user=user,
            meta=meta,
            errors=errors,
        ...
        v0044_openapi_users_add_cond_resp.additional_properties = d
        return v0044_openapi_users_add_cond_resp
