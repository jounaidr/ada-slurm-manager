...
from ...models.slurmdb_v0044_delete_cluster_classification import SlurmdbV0044DeleteClusterClassification
from ...models.slurmdb_v0044_delete_cluster_flags import SlurmdbV0044DeleteClusterFlags
from ...models.v0044_openapi_clusters_removed_resp import V0044OpenapiClustersRemovedResp
...
def _get_kwargs(
    cluster_name: str,
    *,
    classification: SlurmdbV0044DeleteClusterClassification | Unset = UNSET,
    cluster: str | Unset = UNSET,
    federation: str | Unset = UNSET,
    flags: SlurmdbV0044DeleteClusterFlags | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = V0044OpenapiClustersRemovedResp.from_dict(response.json())

        return response_200

    response_default = V0044OpenapiClustersRemovedResp.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[V0044OpenapiClustersRemovedResp]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_name (str):
        classification (SlurmdbV0044DeleteClusterClassification | Unset):
        cluster (str | Unset):
        federation (str | Unset):
        flags (SlurmdbV0044DeleteClusterFlags | Unset):
        format_ (str | Unset):
...
def sync(
    ...
    *,
    ...
    with_deleted: str | Unset = UNSET,
    with_usage: str | Unset = UNSET,
) -> V0044OpenapiClustersRemovedResp | None:
    """Delete cluster
