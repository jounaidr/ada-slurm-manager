...
from ..models.slurm_v0041_post_job_submit_body_jobs_item_cpu_binding_flags_item import (
    SlurmV0041PostJobSubmitBodyJobsItemCpuBindingFlagsItem,
)
from ..models.slurm_v0041_post_job_submit_body_jobs_item_exclusive_item import (
    SlurmV0041PostJobSubmitBodyJobsItemExclusiveItem,
)
from ..models.slurm_v0041_post_job_submit_body_jobs_item_flags_item import SlurmV0041PostJobSubmitBodyJobsItemFlagsItem
from ..models.slurm_v0041_post_job_submit_body_jobs_item_kill_warning_flags_item import (
    SlurmV0041PostJobSubmitBodyJobsItemKillWarningFlagsItem,
)
from ..models.slurm_v0041_post_job_submit_body_jobs_item_mail_type_item import (
    SlurmV0041PostJobSubmitBodyJobsItemMailTypeItem,
)
from ..models.slurm_v0041_post_job_submit_body_jobs_item_memory_binding_type_item import (
    SlurmV0041PostJobSubmitBodyJobsItemMemoryBindingTypeItem,
)
from ..models.slurm_v0041_post_job_submit_body_jobs_item_open_mode_item import (
    SlurmV0041PostJobSubmitBodyJobsItemOpenModeItem,
)
from ..models.slurm_v0041_post_job_submit_body_jobs_item_profile_item import (
    SlurmV0041PostJobSubmitBodyJobsItemProfileItem,
)
from ..models.slurm_v0041_post_job_submit_body_jobs_item_shared_item import (
    SlurmV0041PostJobSubmitBodyJobsItemSharedItem,
)
from ..models.slurm_v0041_post_job_submit_body_jobs_item_x11_item import SlurmV0041PostJobSubmitBodyJobsItemX11Item
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_begin_time import (
        SlurmV0041PostJobSubmitBodyJobsItemBeginTime,
    )
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_crontab import SlurmV0041PostJobSubmitBodyJobsItemCrontab
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_distribution_plane_size import (
        SlurmV0041PostJobSubmitBodyJobsItemDistributionPlaneSize,
    )
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_kill_warning_delay import (
        SlurmV0041PostJobSubmitBodyJobsItemKillWarningDelay,
    )
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_memory_per_cpu import (
        SlurmV0041PostJobSubmitBodyJobsItemMemoryPerCpu,
    )
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_memory_per_node import (
        SlurmV0041PostJobSubmitBodyJobsItemMemoryPerNode,
    )
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_priority import SlurmV0041PostJobSubmitBodyJobsItemPriority
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_required_switches import (
        SlurmV0041PostJobSubmitBodyJobsItemRequiredSwitches,
    )
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_rlimits import SlurmV0041PostJobSubmitBodyJobsItemRlimits
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_segment_size import (
        SlurmV0041PostJobSubmitBodyJobsItemSegmentSize,
    )
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_time_limit import (
        SlurmV0041PostJobSubmitBodyJobsItemTimeLimit,
    )
    from ..models.slurm_v0041_post_job_submit_body_jobs_item_time_minimum import (
        SlurmV0041PostJobSubmitBodyJobsItemTimeMinimum,
    )


T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJobsItem")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJobsItem:
    """
    Attributes:
        ...
        begin_time (SlurmV0041PostJobSubmitBodyJobsItemBeginTime | Unset): Defer the allocation of the job until the
            specified time (UNIX timestamp)
        flags (list[SlurmV0041PostJobSubmitBodyJobsItemFlagsItem] | Unset): Job flags
        ...
        cpu_binding_flags (list[SlurmV0041PostJobSubmitBodyJobsItemCpuBindingFlagsItem] | Unset): Flags for CPU binding
        ...
        crontab (SlurmV0041PostJobSubmitBodyJobsItemCrontab | Unset): Specification for scrontab job
        ...
        rlimits (SlurmV0041PostJobSubmitBodyJobsItemRlimits | Unset):
        ...
        mail_type (list[SlurmV0041PostJobSubmitBodyJobsItemMailTypeItem] | Unset): Mail event type(s)
        ...
        memory_binding_type (list[SlurmV0041PostJobSubmitBodyJobsItemMemoryBindingTypeItem] | Unset): Method for binding
            tasks to memory
        ...
        open_mode (list[SlurmV0041PostJobSubmitBodyJobsItemOpenModeItem] | Unset): Open mode used for stdout and stderr
            files
        ...
        distribution_plane_size (SlurmV0041PostJobSubmitBodyJobsItemDistributionPlaneSize | Unset): Plane size
        ...
        priority (SlurmV0041PostJobSubmitBodyJobsItemPriority | Unset): Request specific job priority
        profile (list[SlurmV0041PostJobSubmitBodyJobsItemProfileItem] | Unset): Profile used by the acct_gather_profile
            plugin
        ...
        shared (list[SlurmV0041PostJobSubmitBodyJobsItemSharedItem] | Unset): How the job can share resources with other
            jobs, if at all
        exclusive (list[SlurmV0041PostJobSubmitBodyJobsItemExclusiveItem] | Unset):
        ...
        time_limit (SlurmV0041PostJobSubmitBodyJobsItemTimeLimit | Unset): Maximum run time in minutes
        time_minimum (SlurmV0041PostJobSubmitBodyJobsItemTimeMinimum | Unset): Minimum run time in minutes
        ...
        kill_warning_flags (list[SlurmV0041PostJobSubmitBodyJobsItemKillWarningFlagsItem] | Unset): Flags related to job
            signals
        kill_warning_signal (str | Unset): Signal to send when approaching end time (e.g. "10" or "USR1")
        kill_warning_delay (SlurmV0041PostJobSubmitBodyJobsItemKillWarningDelay | Unset): Number of seconds before end
            time to send the warning signal
        ...
        memory_per_cpu (SlurmV0041PostJobSubmitBodyJobsItemMemoryPerCpu | Unset): Minimum memory in megabytes per
            allocated CPU
        memory_per_node (SlurmV0041PostJobSubmitBodyJobsItemMemoryPerNode | Unset): Minimum memory in megabytes per
            allocated CPU
        temporary_disk_per_node (int | Unset): Minimum tmp disk space required per node
        selinux_context (str | Unset): SELinux context
        required_switches (SlurmV0041PostJobSubmitBodyJobsItemRequiredSwitches | Unset): Maximum number of switches
        segment_size (SlurmV0041PostJobSubmitBodyJobsItemSegmentSize | Unset): Segment size for topology/block
        ...
        x11 (list[SlurmV0041PostJobSubmitBodyJobsItemX11Item] | Unset): X11 forwarding options
    ...
    begin_time: SlurmV0041PostJobSubmitBodyJobsItemBeginTime | Unset = UNSET
    flags: list[SlurmV0041PostJobSubmitBodyJobsItemFlagsItem] | Unset = UNSET
    ...
    cpu_binding_flags: list[SlurmV0041PostJobSubmitBodyJobsItemCpuBindingFlagsItem] | Unset = UNSET
    cpu_frequency: str | Unset = UNSET
    cpus_per_tres: str | Unset = UNSET
    crontab: SlurmV0041PostJobSubmitBodyJobsItemCrontab | Unset = UNSET
    ...
    rlimits: SlurmV0041PostJobSubmitBodyJobsItemRlimits | Unset = UNSET
    ...
    mail_type: list[SlurmV0041PostJobSubmitBodyJobsItemMailTypeItem] | Unset = UNSET
    mail_user: str | Unset = UNSET
    mcs_label: str | Unset = UNSET
    memory_binding: str | Unset = UNSET
    memory_binding_type: list[SlurmV0041PostJobSubmitBodyJobsItemMemoryBindingTypeItem] | Unset = UNSET
    memory_per_tres: str | Unset = UNSET
    name: str | Unset = UNSET
    network: str | Unset = UNSET
    nice: int | Unset = UNSET
    tasks: int | Unset = UNSET
    open_mode: list[SlurmV0041PostJobSubmitBodyJobsItemOpenModeItem] | Unset = UNSET
    reserve_ports: int | Unset = UNSET
    overcommit: bool | Unset = UNSET
    partition: str | Unset = UNSET
    distribution_plane_size: SlurmV0041PostJobSubmitBodyJobsItemDistributionPlaneSize | Unset = UNSET
    power_flags: list[Any] | Unset = UNSET
    prefer: str | Unset = UNSET
    hold: bool | Unset = UNSET
    priority: SlurmV0041PostJobSubmitBodyJobsItemPriority | Unset = UNSET
    profile: list[SlurmV0041PostJobSubmitBodyJobsItemProfileItem] | Unset = UNSET
    qos: str | Unset = UNSET
    ...
    shared: list[SlurmV0041PostJobSubmitBodyJobsItemSharedItem] | Unset = UNSET
    exclusive: list[SlurmV0041PostJobSubmitBodyJobsItemExclusiveItem] | Unset = UNSET
    ...
    time_limit: SlurmV0041PostJobSubmitBodyJobsItemTimeLimit | Unset = UNSET
    time_minimum: SlurmV0041PostJobSubmitBodyJobsItemTimeMinimum | Unset = UNSET
    ...
    kill_warning_flags: list[SlurmV0041PostJobSubmitBodyJobsItemKillWarningFlagsItem] | Unset = UNSET
    kill_warning_signal: str | Unset = UNSET
    kill_warning_delay: SlurmV0041PostJobSubmitBodyJobsItemKillWarningDelay | Unset = UNSET
    ...
    memory_per_cpu: SlurmV0041PostJobSubmitBodyJobsItemMemoryPerCpu | Unset = UNSET
    memory_per_node: SlurmV0041PostJobSubmitBodyJobsItemMemoryPerNode | Unset = UNSET
    temporary_disk_per_node: int | Unset = UNSET
    selinux_context: str | Unset = UNSET
    required_switches: SlurmV0041PostJobSubmitBodyJobsItemRequiredSwitches | Unset = UNSET
    segment_size: SlurmV0041PostJobSubmitBodyJobsItemSegmentSize | Unset = UNSET
    ...
    x11: list[SlurmV0041PostJobSubmitBodyJobsItemX11Item] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        from ..models.slurm_v0041_post_job_submit_body_jobs_item_crontab import (
        ...
        from ..models.slurm_v0041_post_job_submit_body_jobs_item_priority import (
            SlurmV0041PostJobSubmitBodyJobsItemPriority,
        )
        from ..models.slurm_v0041_post_job_submit_body_jobs_item_required_switches import (
            SlurmV0041PostJobSubmitBodyJobsItemRequiredSwitches,
        )
        from ..models.slurm_v0041_post_job_submit_body_jobs_item_rlimits import (
        ...
        begin_time: SlurmV0041PostJobSubmitBodyJobsItemBeginTime | Unset
        if isinstance(_begin_time, Unset):
            begin_time = UNSET
        else:
            begin_time = SlurmV0041PostJobSubmitBodyJobsItemBeginTime.from_dict(_begin_time)
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = SlurmV0041PostJobSubmitBodyJobsItemFlagsItem(flags_item_data)
        ...
        if _cpu_binding_flags is not UNSET:
            ...
            for cpu_binding_flags_item_data in _cpu_binding_flags:
                cpu_binding_flags_item = SlurmV0041PostJobSubmitBodyJobsItemCpuBindingFlagsItem(
        ...
        crontab: SlurmV0041PostJobSubmitBodyJobsItemCrontab | Unset
        if isinstance(_crontab, Unset):
            crontab = UNSET
        else:
            crontab = SlurmV0041PostJobSubmitBodyJobsItemCrontab.from_dict(_crontab)
        ...
        if isinstance(_rlimits, Unset):
            ...
            rlimits = SlurmV0041PostJobSubmitBodyJobsItemRlimits.from_dict(_rlimits)
        ...
        if _mail_type is not UNSET:
            ...
            for mail_type_item_data in _mail_type:
                mail_type_item = SlurmV0041PostJobSubmitBodyJobsItemMailTypeItem(mail_type_item_data)
        ...
        if _memory_binding_type is not UNSET:
            ...
            for memory_binding_type_item_data in _memory_binding_type:
                memory_binding_type_item = SlurmV0041PostJobSubmitBodyJobsItemMemoryBindingTypeItem(
        ...
        if _open_mode is not UNSET:
            ...
            for open_mode_item_data in _open_mode:
                open_mode_item = SlurmV0041PostJobSubmitBodyJobsItemOpenModeItem(open_mode_item_data)
        ...
        distribution_plane_size: SlurmV0041PostJobSubmitBodyJobsItemDistributionPlaneSize | Unset
        if isinstance(_distribution_plane_size, Unset):
            distribution_plane_size = UNSET
        else:
            distribution_plane_size = SlurmV0041PostJobSubmitBodyJobsItemDistributionPlaneSize.from_dict(
        ...
        priority: SlurmV0041PostJobSubmitBodyJobsItemPriority | Unset
        if isinstance(_priority, Unset):
            priority = UNSET
        else:
            priority = SlurmV0041PostJobSubmitBodyJobsItemPriority.from_dict(_priority)
        ...
        if _profile is not UNSET:
            ...
            for profile_item_data in _profile:
                profile_item = SlurmV0041PostJobSubmitBodyJobsItemProfileItem(profile_item_data)
        ...
        if _shared is not UNSET:
            ...
            for shared_item_data in _shared:
                shared_item = SlurmV0041PostJobSubmitBodyJobsItemSharedItem(shared_item_data)
        ...
        if _exclusive is not UNSET:
            ...
            for exclusive_item_data in _exclusive:
                exclusive_item = SlurmV0041PostJobSubmitBodyJobsItemExclusiveItem(exclusive_item_data)
        ...
        time_limit: SlurmV0041PostJobSubmitBodyJobsItemTimeLimit | Unset
        if isinstance(_time_limit, Unset):
            time_limit = UNSET
        else:
            time_limit = SlurmV0041PostJobSubmitBodyJobsItemTimeLimit.from_dict(_time_limit)

        _time_minimum = d.pop("time_minimum", UNSET)
        time_minimum: SlurmV0041PostJobSubmitBodyJobsItemTimeMinimum | Unset
        if isinstance(_time_minimum, Unset):
            time_minimum = UNSET
        else:
            time_minimum = SlurmV0041PostJobSubmitBodyJobsItemTimeMinimum.from_dict(_time_minimum)
        ...
        if _kill_warning_flags is not UNSET:
            ...
            for kill_warning_flags_item_data in _kill_warning_flags:
                kill_warning_flags_item = SlurmV0041PostJobSubmitBodyJobsItemKillWarningFlagsItem(
        ...
        kill_warning_delay: SlurmV0041PostJobSubmitBodyJobsItemKillWarningDelay | Unset
        if isinstance(_kill_warning_delay, Unset):
            kill_warning_delay = UNSET
        else:
            kill_warning_delay = SlurmV0041PostJobSubmitBodyJobsItemKillWarningDelay.from_dict(_kill_warning_delay)
        ...
        memory_per_cpu: SlurmV0041PostJobSubmitBodyJobsItemMemoryPerCpu | Unset
        if isinstance(_memory_per_cpu, Unset):
            memory_per_cpu = UNSET
        else:
            memory_per_cpu = SlurmV0041PostJobSubmitBodyJobsItemMemoryPerCpu.from_dict(_memory_per_cpu)

        _memory_per_node = d.pop("memory_per_node", UNSET)
        memory_per_node: SlurmV0041PostJobSubmitBodyJobsItemMemoryPerNode | Unset
        if isinstance(_memory_per_node, Unset):
            memory_per_node = UNSET
        else:
            memory_per_node = SlurmV0041PostJobSubmitBodyJobsItemMemoryPerNode.from_dict(_memory_per_node)
        ...
        required_switches: SlurmV0041PostJobSubmitBodyJobsItemRequiredSwitches | Unset
        if isinstance(_required_switches, Unset):
            required_switches = UNSET
        else:
            required_switches = SlurmV0041PostJobSubmitBodyJobsItemRequiredSwitches.from_dict(_required_switches)

        _segment_size = d.pop("segment_size", UNSET)
        segment_size: SlurmV0041PostJobSubmitBodyJobsItemSegmentSize | Unset
        if isinstance(_segment_size, Unset):
            segment_size = UNSET
        else:
            segment_size = SlurmV0041PostJobSubmitBodyJobsItemSegmentSize.from_dict(_segment_size)
        ...
        if _x11 is not UNSET:
            ...
            for x11_item_data in _x11:
                x11_item = SlurmV0041PostJobSubmitBodyJobsItemX11Item(x11_item_data)
        ...
        slurm_v0041_post_job_submit_body_jobs_item = cls(
            account=account,
        ...
        slurm_v0041_post_job_submit_body_jobs_item.additional_properties = d
        return slurm_v0041_post_job_submit_body_jobs_item
