...
T = TypeVar("T", bound="Dbv0038UserDefault")


@_attrs_define
class Dbv0038UserDefault:
    """Default settings
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_user_default = cls(
            account=account,
            wckey=wckey,
        )

        dbv_0038_user_default.additional_properties = d
        return dbv_0038_user_default
