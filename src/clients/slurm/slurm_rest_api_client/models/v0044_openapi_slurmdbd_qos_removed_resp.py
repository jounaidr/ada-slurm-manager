...
T = TypeVar("T", bound="V0044OpenapiSlurmdbdQosRemovedResp")


@_attrs_define
class V0044OpenapiSlurmdbdQosRemovedResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_slurmdbd_qos_removed_resp = cls(
            removed_qos=removed_qos,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_slurmdbd_qos_removed_resp.additional_properties = d
        return v0044_openapi_slurmdbd_qos_removed_resp
