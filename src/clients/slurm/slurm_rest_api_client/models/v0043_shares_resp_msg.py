...
class V0043SharesRespMsg:
    """
    Attributes:
        shares (list[V0043AssocSharesObjWrap] | Unset):
        total_shares (int | Unset): Total number of shares
    """

    shares: list[V0043AssocSharesObjWrap] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _shares is not UNSET:
            shares = []
            for componentsschemasv0_0_43_assoc_shares_obj_list_item_data in _shares:
