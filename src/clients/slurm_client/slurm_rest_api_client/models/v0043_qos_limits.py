...
class V0043QosLimits:
    ...
    Attributes:
        ...
        max_ (V0043QosLimitsMax | Unset):
        factor (V0043Float64NoValStruct | Unset):
        min_ (V0043QosLimitsMin | Unset):
    """

    grace_time: int | Unset = UNSET
    max_: V0043QosLimitsMax | Unset = UNSET
    factor: V0043Float64NoValStruct | Unset = UNSET
    min_: V0043QosLimitsMin | Unset = UNSET
