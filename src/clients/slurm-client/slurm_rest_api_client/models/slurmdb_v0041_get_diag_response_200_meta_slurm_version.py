...
T = TypeVar("T", bound="SlurmdbV0041GetDiagResponse200MetaSlurmVersion")


@_attrs_define
class SlurmdbV0041GetDiagResponse200MetaSlurmVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_get_diag_response_200_meta_slurm_version = cls(
            major=major,
            micro=micro,
            minor=minor,
        )

        slurmdb_v0041_get_diag_response_200_meta_slurm_version.additional_properties = d
        return slurmdb_v0041_get_diag_response_200_meta_slurm_version
