...
T = TypeVar("T", bound="V0041OpenapiJobInfoRespLastUpdate")


@_attrs_define
class V0041OpenapiJobInfoRespLastUpdate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_job_info_resp_last_update = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_job_info_resp_last_update.additional_properties = d
        return v0041_openapi_job_info_resp_last_update
