...
if TYPE_CHECKING:
    from ..models.v0037_reservation_purge_completed import V0037ReservationPurgeCompleted


T = TypeVar("T", bound="V0037Reservation")
...
class V0037Reservation:
    ...
    Attributes:
        ...
        purge_completed (V0037ReservationPurgeCompleted | Unset): If PURGE_COMP flag is set the amount of seconds this
    ...
    purge_completed: V0037ReservationPurgeCompleted | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        purge_completed: V0037ReservationPurgeCompleted | Unset
        if isinstance(_purge_completed, Unset):
            purge_completed = UNSET
        else:
            purge_completed = V0037ReservationPurgeCompleted.from_dict(_purge_completed)
        ...
        v0037_reservation.additional_properties = d
        return v0037_reservation
