...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItemStepsItemTimeStart")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItemStepsItemTimeStart:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_time_start = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_time_start.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item_steps_item_time_start
