...
T = TypeVar("T", bound="V0041OpenapiPartitionRespPartitionsItemMaximumsOverTimeLimit")


@_attrs_define
class V0041OpenapiPartitionRespPartitionsItemMaximumsOverTimeLimit:
    """OverTimeLimit
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_partition_resp_partitions_item_maximums_over_time_limit = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_partition_resp_partitions_item_maximums_over_time_limit.additional_properties = d
        return v0041_openapi_partition_resp_partitions_item_maximums_over_time_limit
