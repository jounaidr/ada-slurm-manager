...
T = TypeVar("T", bound="V0038MetaSlurmVersion")


@_attrs_define
class V0038MetaSlurmVersion:
    """
    Attributes:
        major (str | Unset):
        micro (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0038_meta_slurm_version = cls(
            major=major,
            micro=micro,
            minor=minor,
        )

        v0038_meta_slurm_version.additional_properties = d
        return v0038_meta_slurm_version
