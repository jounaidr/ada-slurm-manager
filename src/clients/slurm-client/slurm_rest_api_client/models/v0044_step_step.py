...
T = TypeVar("T", bound="V0044StepStep")
...
class V0044StepStep:
    """
    Attributes:
        id (str | Unset): Step ID (Slurm job step ID)
        ...
        stderr_expanded (str | Unset): Step stderr with expanded fields
        stdin_expanded (str | Unset): Step stdin with expanded fields
        stdout_expanded (str | Unset): Step stdout with expanded fields
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_step_step.additional_properties = d
        return v0044_step_step
