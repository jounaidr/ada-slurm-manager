...
T = TypeVar("T", bound="V0044PartitionInfoNodes")


@_attrs_define
class V0044PartitionInfoNodes:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_partition_info_nodes = cls(
            allowed_allocation=allowed_allocation,
            configured=configured,
            total=total,
        )

        v0044_partition_info_nodes.additional_properties = d
        return v0044_partition_info_nodes
