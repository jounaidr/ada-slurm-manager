...
T = TypeVar("T", bound="V0044JobResNodeMemory")


@_attrs_define
class V0044JobResNodeMemory:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_job_res_node_memory = cls(
            used=used,
            allocated=allocated,
        )

        v0044_job_res_node_memory.additional_properties = d
        return v0044_job_res_node_memory
