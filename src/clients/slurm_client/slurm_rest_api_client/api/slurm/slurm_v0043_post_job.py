...
def _get_kwargs(
    job_id: str,
    *,
    body: V0043JobDescMsg | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0043OpenapiJobPostResponse:
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    body: V0043JobDescMsg | Unset = UNSET,
) -> V0043OpenapiJobPostResponse | None:
    """update job
