...
class V0043AssocMaxTres:
    ...
    Attributes:
        ...
        group (V0043AssocMaxTresGroup | Unset):
        minutes (V0043AssocMaxTresMinutes | Unset):
        per (V0043AssocMaxTresPer | Unset):
    """

    total: list[V0043Tres] | Unset = UNSET
    group: V0043AssocMaxTresGroup | Unset = UNSET
    minutes: V0043AssocMaxTresMinutes | Unset = UNSET
    per: V0043AssocMaxTresPer | Unset = UNSET
