...
T = TypeVar("T", bound="V0041OpenapiSlurmdbdJobsRespJobsItemHetJobOffset")


@_attrs_define
class V0041OpenapiSlurmdbdJobsRespJobsItemHetJobOffset:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_slurmdbd_jobs_resp_jobs_item_het_job_offset = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_slurmdbd_jobs_resp_jobs_item_het_job_offset.additional_properties = d
        return v0041_openapi_slurmdbd_jobs_resp_jobs_item_het_job_offset
