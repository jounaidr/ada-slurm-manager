...
T = TypeVar("T", bound="Dbv0038MetaSlurmVersion")


@_attrs_define
class Dbv0038MetaSlurmVersion:
    """
    Attributes:
        major (str | Unset):
        micro (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_meta_slurm_version = cls(
            major=major,
            micro=micro,
            minor=minor,
        )

        dbv_0038_meta_slurm_version.additional_properties = d
        return dbv_0038_meta_slurm_version
