...
def _get_kwargs(
    *,
    ...
    preempt_mode: SlurmdbV0042GetQosPreemptMode | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiSlurmdbdQosResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiSlurmdbdQosResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiSlurmdbdQosResp.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        format_ (str | Unset):
        name (str | Unset):
        preempt_mode (SlurmdbV0042GetQosPreemptMode | Unset):
...
def sync(
    *,
    ...
    name: str | Unset = UNSET,
    preempt_mode: SlurmdbV0042GetQosPreemptMode | Unset = UNSET,
) -> V0042OpenapiSlurmdbdQosResp | None:
    """Get QOS list
