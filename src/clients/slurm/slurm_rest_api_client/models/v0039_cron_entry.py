...
from ..models.v0039_cron_entry_flags_item import V0039CronEntryFlagsItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0039_cron_entry_line import V0039CronEntryLine


T = TypeVar("T", bound="V0039CronEntry")
...
class V0039CronEntry:
    """
    Attributes:
        flags (list[V0039CronEntryFlagsItem] | Unset):
        minute (str | Unset):
        hour (str | Unset):
        ...
        command (str | Unset):
        line (V0039CronEntryLine | Unset):
    """

    flags: list[V0039CronEntryFlagsItem] | Unset = UNSET
    ...
    line: V0039CronEntryLine | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _flags is not UNSET:
            ...
            for flags_item_data in _flags:
                flags_item = V0039CronEntryFlagsItem(flags_item_data)
        ...
        if isinstance(_line, Unset):
            ...
            line = V0039CronEntryLine.from_dict(_line)

        v0039_cron_entry = cls(
            flags=flags,
            minute=minute,
            hour=hour,
        ...
        v0039_cron_entry.additional_properties = d
        return v0039_cron_entry
