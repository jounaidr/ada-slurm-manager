...
T = TypeVar("T", bound="V0041OpenapiPartitionRespErrorsItem")


@_attrs_define
class V0041OpenapiPartitionRespErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_partition_resp_errors_item = cls(
        ...
        v0041_openapi_partition_resp_errors_item.additional_properties = d
        return v0041_openapi_partition_resp_errors_item
