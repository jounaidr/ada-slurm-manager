...
from ...models.v0041_openapi_accounts_resp import V0041OpenapiAccountsResp
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0041OpenapiAccountsResp:
    if response.status_code == 200:
        response_200 = V0041OpenapiAccountsResp.from_dict(response.json())

        return response_200

    response_default = V0041OpenapiAccountsResp.from_dict(response.json())
...
) -> Response[V0041OpenapiAccountsResp]:
    return Response(
