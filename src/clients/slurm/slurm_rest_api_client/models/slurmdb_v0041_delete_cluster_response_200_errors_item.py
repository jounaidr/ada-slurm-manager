...
T = TypeVar("T", bound="SlurmdbV0041DeleteClusterResponse200ErrorsItem")


@_attrs_define
class SlurmdbV0041DeleteClusterResponse200ErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_delete_cluster_response_200_errors_item = cls(
        ...
        slurmdb_v0041_delete_cluster_response_200_errors_item.additional_properties = d
        return slurmdb_v0041_delete_cluster_response_200_errors_item
