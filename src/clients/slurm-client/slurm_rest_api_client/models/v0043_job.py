...
class V0043Job:
    ...
    Attributes:
        ...
        comment (V0043JobComment | Unset):
        allocation_nodes (int | Unset): List of nodes allocated to the job
        array (V0043JobArray | Unset):
        association (V0043AssocShort | Unset):
        ...
        required (V0043JobRequired | Unset):
        ...
        reservation (V0043JobReservation | Unset):
    ...
    required: V0043JobRequired | Unset = UNSET
    kill_request_user: str | Unset = UNSET
    restart_cnt: int | Unset = UNSET
    reservation: V0043JobReservation | Unset = UNSET
    ...
    state: V0043JobState | Unset = UNSET
    steps: list[V0043Step] | Unset = UNSET
    submit_line: str | Unset = UNSET
    tres: V0043JobTres | Unset = UNSET
    used_gres: str | Unset = UNSET
    user: str | Unset = UNSET
    wckey: V0043WckeyTagStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _steps is not UNSET:
            steps = []
            for componentsschemasv0_0_43_step_list_item_data in _steps:
                componentsschemasv0_0_43_step_list_item = V0043Step.from_dict(
                    componentsschemasv0_0_43_step_list_item_data
                )
