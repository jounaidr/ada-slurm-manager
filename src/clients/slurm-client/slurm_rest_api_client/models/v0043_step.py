...
class V0043Step:
    """
    Attributes:
        time (V0043StepTime | Unset):
        exit_code (V0043ProcessExitCodeVerbose | Unset):
        nodes (V0043StepNodes | Unset):
        tasks (V0043StepTasks | Unset):
        pid (str | Unset): Deprecated; Process ID
        cpu (V0043StepCPU | Unset):
        kill_request_user (str | Unset): User ID that requested termination of the step
        state (list[V0043StepStateItem] | Unset): Current state
        statistics (V0043StepStatistics | Unset):
        step (V0043StepStep | Unset):
        task (V0043StepTask | Unset):
        tres (V0043StepTres | Unset):
    """

    time: V0043StepTime | Unset = UNSET
    exit_code: V0043ProcessExitCodeVerbose | Unset = UNSET
    nodes: V0043StepNodes | Unset = UNSET
    tasks: V0043StepTasks | Unset = UNSET
    pid: str | Unset = UNSET
    cpu: V0043StepCPU | Unset = UNSET
    kill_request_user: str | Unset = UNSET
    state: list[V0043StepStateItem] | Unset = UNSET
    statistics: V0043StepStatistics | Unset = UNSET
    step: V0043StepStep | Unset = UNSET
    task: V0043StepTask | Unset = UNSET
    tres: V0043StepTres | Unset = UNSET
