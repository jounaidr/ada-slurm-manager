...
if TYPE_CHECKING:
    from ..models.v0038_diag_statistics import V0038DiagStatistics
    from ..models.v0038_error import V0038Error
    from ..models.v0038_meta import V0038Meta


T = TypeVar("T", bound="V0038Diag")
...
class V0038Diag:
    ...
    Attributes:
        ...
        statistics (V0038DiagStatistics | Unset): Slurm statistics
    """

    meta: V0038Meta | Unset = UNSET
    errors: list[V0038Error] | Unset = UNSET
    statistics: V0038DiagStatistics | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        statistics: V0038DiagStatistics | Unset
        if isinstance(_statistics, Unset):
            statistics = UNSET
        else:
            statistics = V0038DiagStatistics.from_dict(_statistics)
        ...
        v0038_diag.additional_properties = d
        return v0038_diag
