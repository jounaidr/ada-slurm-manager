...
def _get_kwargs(
    cluster_name: str,
    *,
    classification: SlurmdbV0043DeleteClusterClassification | Unset = UNSET,
    cluster: str | Unset = UNSET,
    federation: str | Unset = UNSET,
    flags: SlurmdbV0043DeleteClusterFlags | Unset = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_name (str):
        classification (SlurmdbV0043DeleteClusterClassification | Unset):
        cluster (str | Unset):
        federation (str | Unset):
        flags (SlurmdbV0043DeleteClusterFlags | Unset):
        format_ (str | Unset):
...
def sync(
    ...
    *,
    ...
    with_deleted: str | Unset = UNSET,
    with_usage: str | Unset = UNSET,
) -> V0043OpenapiClustersRemovedResp | None:
    """Delete cluster
