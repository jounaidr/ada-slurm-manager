...
from ..models.v0037_job_properties_exclusive import V0037JobPropertiesExclusive
from ..models.v0037_job_properties_gres_flags import V0037JobPropertiesGresFlags
from ..models.v0037_job_properties_open_mode import V0037JobPropertiesOpenMode
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.v0037_job_properties_environment import V0037JobPropertiesEnvironment


T = TypeVar("T", bound="V0037JobProperties")
...
class V0037JobProperties:
    """
    Attributes:
        environment (V0037JobPropertiesEnvironment): Dictionary of environment entries.
        ...
        exclusive (V0037JobPropertiesExclusive | Unset): The job allocation can share nodes just other users with the
        ...
        gres_flags (V0037JobPropertiesGresFlags | Unset): Specify generic resource task binding options.
        ...
        nice (str | Unset): Run the job with an adjusted scheduling priority within Slurm.
        ...
        open_mode (V0037JobPropertiesOpenMode | Unset): Open the output and error files using append or truncate mode as
            specified. Default: V0037JobPropertiesOpenMode.APPEND.
        ...
        threads_per_core (int | Unset): Restrict node selection to nodes with at least the specified number of threads
            per core.
        time_limit (int | Unset): Step time limit.
    ...
    environment: V0037JobPropertiesEnvironment
    ...
    exclusive: V0037JobPropertiesExclusive | Unset = UNSET
    get_user_environment: bool | Unset = UNSET
    gres: str | Unset = UNSET
    gres_flags: V0037JobPropertiesGresFlags | Unset = UNSET
    ...
    open_mode: V0037JobPropertiesOpenMode | Unset = V0037JobPropertiesOpenMode.APPEND
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        environment = V0037JobPropertiesEnvironment.from_dict(d.pop("environment"))
        ...
        exclusive: V0037JobPropertiesExclusive | Unset
        if isinstance(_exclusive, Unset):
            exclusive = UNSET
        else:
            exclusive = V0037JobPropertiesExclusive(_exclusive)
        ...
        gres_flags: V0037JobPropertiesGresFlags | Unset
        if isinstance(_gres_flags, Unset):
            gres_flags = UNSET
        else:
            gres_flags = V0037JobPropertiesGresFlags(_gres_flags)
        ...
        open_mode: V0037JobPropertiesOpenMode | Unset
        if isinstance(_open_mode, Unset):
            open_mode = UNSET
        else:
            open_mode = V0037JobPropertiesOpenMode(_open_mode)
        ...
        v0037_job_properties.additional_properties = d
        return v0037_job_properties
