...
from ...models.v0041_openapi_wckey_resp import V0041OpenapiWckeyResp
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0041OpenapiWckeyResp:
    if response.status_code == 200:
        response_200 = V0041OpenapiWckeyResp.from_dict(response.json())

        return response_200

    response_default = V0041OpenapiWckeyResp.from_dict(response.json())
...
) -> Response[V0041OpenapiWckeyResp]:
    return Response(
