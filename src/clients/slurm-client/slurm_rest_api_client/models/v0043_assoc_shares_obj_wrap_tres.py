...
class V0043AssocSharesObjWrapTres:
    """
    Attributes:
        run_seconds (list[V0043SharesUint64Tres] | Unset):
        group_minutes (list[V0043SharesUint64Tres] | Unset):
        usage (list[V0043SharesFloat128Tres] | Unset):
    """

    run_seconds: list[V0043SharesUint64Tres] | Unset = UNSET
    group_minutes: list[V0043SharesUint64Tres] | Unset = UNSET
    usage: list[V0043SharesFloat128Tres] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _run_seconds is not UNSET:
            run_seconds = []
            for componentsschemasv0_0_43_shares_uint64_tres_list_item_data in _run_seconds:
        ...
        if _group_minutes is not UNSET:
            group_minutes = []
            for componentsschemasv0_0_43_shares_uint64_tres_list_item_data in _group_minutes:
                componentsschemasv0_0_43_shares_uint64_tres_list_item = V0043SharesUint64Tres.from_dict(
                    componentsschemasv0_0_43_shares_uint64_tres_list_item_data
                )
        ...
        if _usage is not UNSET:
            usage = []
            for componentsschemasv0_0_43_shares_float128_tres_list_item_data in _usage:
