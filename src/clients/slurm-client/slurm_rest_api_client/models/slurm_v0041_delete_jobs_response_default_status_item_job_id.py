...
T = TypeVar("T", bound="SlurmV0041DeleteJobsResponseDefaultStatusItemJobId")


@_attrs_define
class SlurmV0041DeleteJobsResponseDefaultStatusItemJobId:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_delete_jobs_response_default_status_item_job_id = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_delete_jobs_response_default_status_item_job_id.additional_properties = d
        return slurm_v0041_delete_jobs_response_default_status_item_job_id
