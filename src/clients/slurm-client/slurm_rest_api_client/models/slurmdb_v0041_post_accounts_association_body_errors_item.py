...
T = TypeVar("T", bound="SlurmdbV0041PostAccountsAssociationBodyErrorsItem")


@_attrs_define
class SlurmdbV0041PostAccountsAssociationBodyErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurmdb_v0041_post_accounts_association_body_errors_item = cls(
        ...
        slurmdb_v0041_post_accounts_association_body_errors_item.additional_properties = d
        return slurmdb_v0041_post_accounts_association_body_errors_item
