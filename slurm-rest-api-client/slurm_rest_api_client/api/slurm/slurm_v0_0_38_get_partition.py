...
from ...models.v0038_partitions_response import V0038PartitionsResponse
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/slurm/v0.0.38/partition/{partition_name}".format(
...
) -> V0038PartitionsResponse | list[V0038Error]:
    if response.status_code == 200:
        response_200 = V0038PartitionsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[V0038PartitionsResponse | list[V0038Error]]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    update_time: int | Unset = UNSET,
) -> V0038PartitionsResponse | list[V0038Error] | None:
    """get partition info
