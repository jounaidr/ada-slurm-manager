...
def _get_kwargs(
    *,
    body: V0043OpenapiUsersAddCondResp | Unset = UNSET,
    update_time: str | Unset = UNSET,
    flags: SlurmdbV0043PostUsersAssociationFlags | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        flags (SlurmdbV0043PostUsersAssociationFlags | Unset):
        body (V0043OpenapiUsersAddCondResp | Unset):
...
def sync(
    *,
    ...
    update_time: str | Unset = UNSET,
    flags: SlurmdbV0043PostUsersAssociationFlags | Unset = UNSET,
) -> V0043OpenapiUsersAddCondRespStr | None:
    """Add users with conditional association
