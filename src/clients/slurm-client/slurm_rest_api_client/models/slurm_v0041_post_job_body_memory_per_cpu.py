...
T = TypeVar("T", bound="SlurmV0041PostJobBodyMemoryPerCpu")


@_attrs_define
class SlurmV0041PostJobBodyMemoryPerCpu:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_body_memory_per_cpu = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_body_memory_per_cpu.additional_properties = d
        return slurm_v0041_post_job_body_memory_per_cpu
