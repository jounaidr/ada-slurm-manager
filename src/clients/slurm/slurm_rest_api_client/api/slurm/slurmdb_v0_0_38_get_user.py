...
from ...models.dbv_0038_user_info import Dbv0038UserInfo
...
) -> Dbv0038UserInfo | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038UserInfo.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038UserInfo | list[Dbv0038Error]]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
    with_deleted: bool | Unset = UNSET,
) -> Dbv0038UserInfo | list[Dbv0038Error] | None:
    """Get user info
