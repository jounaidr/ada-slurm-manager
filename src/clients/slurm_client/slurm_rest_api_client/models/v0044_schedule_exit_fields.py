...
T = TypeVar("T", bound="V0044ScheduleExitFields")


@_attrs_define
class V0044ScheduleExitFields:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_schedule_exit_fields = cls(
        ...
        v0044_schedule_exit_fields.additional_properties = d
        return v0044_schedule_exit_fields
