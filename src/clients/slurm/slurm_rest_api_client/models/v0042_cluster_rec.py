...
class V0042ClusterRec:
    """
    Attributes:
        controller (V0042ClusterRecController | Unset):
        flags (list[V0042ClusterRecFlagsItem] | Unset):
        name (str | Unset): ClusterName
        nodes (str | Unset): Node names
        select_plugin (str | Unset):
        associations (V0042ClusterRecAssociations | Unset):
        rpc_version (int | Unset): RPC version used in the cluster
        tres (list[V0042Tres] | Unset):
    """

    controller: V0042ClusterRecController | Unset = UNSET
    flags: list[V0042ClusterRecFlagsItem] | Unset = UNSET
    name: str | Unset = UNSET
    nodes: str | Unset = UNSET
    select_plugin: str | Unset = UNSET
    associations: V0042ClusterRecAssociations | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _flags is not UNSET:
            flags = []
            for componentsschemasv0_0_42_cluster_rec_flags_item_data in _flags:
