...
T = TypeVar("T", bound="V0041OpenapiJobInfoRespJobsItemJobResourcesThreadsPerCore")


@_attrs_define
class V0041OpenapiJobInfoRespJobsItemJobResourcesThreadsPerCore:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_job_info_resp_jobs_item_job_resources_threads_per_core = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_openapi_job_info_resp_jobs_item_job_resources_threads_per_core.additional_properties = d
        return v0041_openapi_job_info_resp_jobs_item_job_resources_threads_per_core
