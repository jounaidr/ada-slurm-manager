...
T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJobsItemDistributionPlaneSize")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJobsItemDistributionPlaneSize:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_submit_body_jobs_item_distribution_plane_size = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_submit_body_jobs_item_distribution_plane_size.additional_properties = d
        return slurm_v0041_post_job_submit_body_jobs_item_distribution_plane_size
