...
def _get_kwargs(
    *,
    body: V0043OpenapiSlurmdbdQosResp | Unset = UNSET,
    description: str | Unset = UNSET,
    include_deleted_qos: str | Unset = UNSET,
    id: str | Unset = UNSET,
    format_: str | Unset = UNSET,
    name: str | Unset = UNSET,
    preempt_mode: SlurmdbV0043PostQosPreemptMode | Unset = UNSET,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        format_ (str | Unset):
        name (str | Unset):
        preempt_mode (SlurmdbV0043PostQosPreemptMode | Unset):
        body (V0043OpenapiSlurmdbdQosResp | Unset):
