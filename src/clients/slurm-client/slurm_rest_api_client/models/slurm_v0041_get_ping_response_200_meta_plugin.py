...
T = TypeVar("T", bound="SlurmV0041GetPingResponse200MetaPlugin")


@_attrs_define
class SlurmV0041GetPingResponse200MetaPlugin:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_ping_response_200_meta_plugin = cls(
            type_=type_,
            name=name,
        ...
        slurm_v0041_get_ping_response_200_meta_plugin.additional_properties = d
        return slurm_v0041_get_ping_response_200_meta_plugin
