...
class V0043PartitionInfoTimeouts:
    """
    Attributes:
        resume (V0043Uint16NoValStruct | Unset):
        suspend (V0043Uint16NoValStruct | Unset):
    """

    resume: V0043Uint16NoValStruct | Unset = UNSET
    suspend: V0043Uint16NoValStruct | Unset = UNSET
