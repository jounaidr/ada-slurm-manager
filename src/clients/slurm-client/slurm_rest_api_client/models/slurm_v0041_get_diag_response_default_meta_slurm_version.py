...
T = TypeVar("T", bound="SlurmV0041GetDiagResponseDefaultMetaSlurmVersion")


@_attrs_define
class SlurmV0041GetDiagResponseDefaultMetaSlurmVersion:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_diag_response_default_meta_slurm_version = cls(
            major=major,
            micro=micro,
            minor=minor,
        )

        slurm_v0041_get_diag_response_default_meta_slurm_version.additional_properties = d
        return slurm_v0041_get_diag_response_default_meta_slurm_version
