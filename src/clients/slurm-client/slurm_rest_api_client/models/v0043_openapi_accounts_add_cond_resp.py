...
class V0043OpenapiAccountsAddCondResp:
    """
    Attributes:
        association_condition (V0043AccountsAddCond | Unset):
        account (V0043AccountShort | Unset):
        meta (V0043OpenapiMeta | Unset):
        errors (list[V0043OpenapiError] | Unset):
        warnings (list[V0043OpenapiWarning] | Unset):
    """

    association_condition: V0043AccountsAddCond | Unset = UNSET
    account: V0043AccountShort | Unset = UNSET
