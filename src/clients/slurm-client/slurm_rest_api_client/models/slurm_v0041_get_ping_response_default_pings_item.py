...
T = TypeVar("T", bound="SlurmV0041GetPingResponseDefaultPingsItem")


@_attrs_define
class SlurmV0041GetPingResponseDefaultPingsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_ping_response_default_pings_item = cls(
            hostname=hostname,
            pinged=pinged,
            latency=latency,
            mode=mode,
        ...
        slurm_v0041_get_ping_response_default_pings_item.additional_properties = d
        return slurm_v0041_get_ping_response_default_pings_item
