...
if TYPE_CHECKING:
    from ..models.v0044_job_array_limits import V0044JobArrayLimits
    from ..models.v0044_uint_32_no_val_struct import V0044Uint32NoValStruct


T = TypeVar("T", bound="V0044JobArray")
...
class V0044JobArray:
    ...
    Attributes:
        ...
        limits (V0044JobArrayLimits | Unset):
        task_id (V0044Uint32NoValStruct | Unset):
        task (str | Unset): String expression of task IDs in this record
    """

    job_id: int | Unset = UNSET
    limits: V0044JobArrayLimits | Unset = UNSET
    task_id: V0044Uint32NoValStruct | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_limits, Unset):
            ...
            limits = V0044JobArrayLimits.from_dict(_limits)
        ...
        if isinstance(_task_id, Unset):
            ...
            task_id = V0044Uint32NoValStruct.from_dict(_task_id)
        ...
        v0044_job_array.additional_properties = d
        return v0044_job_array
