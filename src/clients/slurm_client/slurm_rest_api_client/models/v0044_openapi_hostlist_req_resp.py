...
T = TypeVar("T", bound="V0044OpenapiHostlistReqResp")


@_attrs_define
class V0044OpenapiHostlistReqResp:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_hostlist_req_resp = cls(
            hostlist=hostlist,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_hostlist_req_resp.additional_properties = d
        return v0044_openapi_hostlist_req_resp
