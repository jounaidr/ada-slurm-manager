...
from ...models.dbv_0038_response_user_delete import Dbv0038ResponseUserDelete
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/slurmdb/v0.0.38/user/{user_name}".format(
...
) -> Dbv0038ResponseUserDelete | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038ResponseUserDelete.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038ResponseUserDelete | list[Dbv0038Error]]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> Dbv0038ResponseUserDelete | list[Dbv0038Error] | None:
    """Delete user
