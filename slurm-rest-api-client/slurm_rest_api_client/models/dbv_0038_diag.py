...
if TYPE_CHECKING:
    from ..models.dbv_0038_diag_statistics import Dbv0038DiagStatistics
    from ..models.dbv_0038_error import Dbv0038Error
    from ..models.dbv_0038_meta import Dbv0038Meta


T = TypeVar("T", bound="Dbv0038Diag")
...
class Dbv0038Diag:
    ...
    Attributes:
        ...
        statistics (Dbv0038DiagStatistics | Unset):
    """

    meta: Dbv0038Meta | Unset = UNSET
    errors: list[Dbv0038Error] | Unset = UNSET
    statistics: Dbv0038DiagStatistics | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_statistics, Unset):
            ...
            statistics = Dbv0038DiagStatistics.from_dict(_statistics)
        ...
        dbv_0038_diag.additional_properties = d
        return dbv_0038_diag
