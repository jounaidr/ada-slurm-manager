...
class V0043ProcessExitCodeVerbose:
    """
    Attributes:
        status (list[V0043ProcessExitCodeVerboseStatusItem] | Unset): Status given by return code
        return_code (V0043Uint32NoValStruct | Unset):
        signal (V0043ProcessExitCodeVerboseSignal | Unset):
    """

    status: list[V0043ProcessExitCodeVerboseStatusItem] | Unset = UNSET
    return_code: V0043Uint32NoValStruct | Unset = UNSET
    signal: V0043ProcessExitCodeVerboseSignal | Unset = UNSET
