...
T = TypeVar("T", bound="SlurmV0041PostJobSubmitBodyJobRlimitsRss")


@_attrs_define
class SlurmV0041PostJobSubmitBodyJobRlimitsRss:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_post_job_submit_body_job_rlimits_rss = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_post_job_submit_body_job_rlimits_rss.additional_properties = d
        return slurm_v0041_post_job_submit_body_job_rlimits_rss
