...
T = TypeVar("T", bound="Dbv0038AssociationShortInfo")
...
class Dbv0038AssociationShortInfo:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_association_short_info = cls(
            account=account,
            cluster=cluster,
            partition=partition,
            user=user,
        ...
        dbv_0038_association_short_info.additional_properties = d
        return dbv_0038_association_short_info
