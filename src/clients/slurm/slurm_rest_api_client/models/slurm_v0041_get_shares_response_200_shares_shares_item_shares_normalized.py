...
T = TypeVar("T", bound="SlurmV0041GetSharesResponse200SharesSharesItemSharesNormalized")


@_attrs_define
class SlurmV0041GetSharesResponse200SharesSharesItemSharesNormalized:
    """Normalized shares
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        slurm_v0041_get_shares_response_200_shares_shares_item_shares_normalized = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        slurm_v0041_get_shares_response_200_shares_shares_item_shares_normalized.additional_properties = d
        return slurm_v0041_get_shares_response_200_shares_shares_item_shares_normalized
