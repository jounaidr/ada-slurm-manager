...
T = TypeVar("T", bound="V0041OpenapiAssocsRespErrorsItem")


@_attrs_define
class V0041OpenapiAssocsRespErrorsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_openapi_assocs_resp_errors_item = cls(
        ...
        v0041_openapi_assocs_resp_errors_item.additional_properties = d
        return v0041_openapi_assocs_resp_errors_item
