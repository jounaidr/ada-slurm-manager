...
T = TypeVar("T", bound="V0041UpdateNodeMsgWeight")


@_attrs_define
class V0041UpdateNodeMsgWeight:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0041_update_node_msg_weight = cls(
            set_=set_,
            infinite=infinite,
            number=number,
        )

        v0041_update_node_msg_weight.additional_properties = d
        return v0041_update_node_msg_weight
