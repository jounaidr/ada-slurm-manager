...
def _get_kwargs(
    *,
    body: V0043JobSubmitReq | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0043OpenapiJobSubmitResponse:
...
def sync(
    *,
    client: AuthenticatedClient | Client,
    body: V0043JobSubmitReq | Unset = UNSET,
) -> V0043OpenapiJobSubmitResponse | None:
    """submit new job
