...
T = TypeVar("T", bound="V0044OpenapiCreateNodeReq")


@_attrs_define
class V0044OpenapiCreateNodeReq:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_create_node_req = cls(
            node_conf=node_conf,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_create_node_req.additional_properties = d
        return v0044_openapi_create_node_req
