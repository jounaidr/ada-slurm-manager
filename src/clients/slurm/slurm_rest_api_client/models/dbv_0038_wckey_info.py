...
T = TypeVar("T", bound="Dbv0038WckeyInfo")
...
class Dbv0038WckeyInfo:
    ...
    Attributes:
        ...
        wckeys (list[Dbv0038Wckey] | Unset): List of wckeys
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_wckey_info = cls(
            meta=meta,
            errors=errors,
            wckeys=wckeys,
        )

        dbv_0038_wckey_info.additional_properties = d
        return dbv_0038_wckey_info
