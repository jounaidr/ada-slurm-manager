...
T = TypeVar("T", bound="V0044OpenapiSlurmdbdQosResp")


@_attrs_define
class V0044OpenapiSlurmdbdQosResp:
    """
    Attributes:
        qos (list[V0044Qos]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v0044_openapi_slurmdbd_qos_resp = cls(
            qos=qos,
            meta=meta,
            errors=errors,
            warnings=warnings,
        ...
        v0044_openapi_slurmdbd_qos_resp.additional_properties = d
        return v0044_openapi_slurmdbd_qos_resp
