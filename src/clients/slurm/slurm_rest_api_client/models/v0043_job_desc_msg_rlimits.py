...
class V0043JobDescMsgRlimits:
    """
    Attributes:
        cpu (V0043Uint64NoValStruct | Unset):
        fsize (V0043Uint64NoValStruct | Unset):
        data (V0043Uint64NoValStruct | Unset):
        stack (V0043Uint64NoValStruct | Unset):
        core (V0043Uint64NoValStruct | Unset):
        rss (V0043Uint64NoValStruct | Unset):
        nproc (V0043Uint64NoValStruct | Unset):
        nofile (V0043Uint64NoValStruct | Unset):
        memlock (V0043Uint64NoValStruct | Unset):
        as_ (V0043Uint64NoValStruct | Unset):
    """

    cpu: V0043Uint64NoValStruct | Unset = UNSET
    fsize: V0043Uint64NoValStruct | Unset = UNSET
    data: V0043Uint64NoValStruct | Unset = UNSET
    stack: V0043Uint64NoValStruct | Unset = UNSET
    core: V0043Uint64NoValStruct | Unset = UNSET
    rss: V0043Uint64NoValStruct | Unset = UNSET
    nproc: V0043Uint64NoValStruct | Unset = UNSET
    nofile: V0043Uint64NoValStruct | Unset = UNSET
    memlock: V0043Uint64NoValStruct | Unset = UNSET
    as_: V0043Uint64NoValStruct | Unset = UNSET
