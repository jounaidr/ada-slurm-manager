...
def _get_kwargs(
    *,
    ...
    preempt_mode: SlurmdbV0043GetQosPreemptMode | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0043OpenapiSlurmdbdQosResp:
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        format_ (str | Unset):
        name (str | Unset):
        preempt_mode (SlurmdbV0043GetQosPreemptMode | Unset):
...
def sync(
    *,
    ...
    name: str | Unset = UNSET,
    preempt_mode: SlurmdbV0043GetQosPreemptMode | Unset = UNSET,
) -> V0043OpenapiSlurmdbdQosResp | None:
    """Get QOS list
