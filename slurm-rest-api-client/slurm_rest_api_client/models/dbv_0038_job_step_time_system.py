...
T = TypeVar("T", bound="Dbv0038JobStepTimeSystem")


@_attrs_define
class Dbv0038JobStepTimeSystem:
    """System time values
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        dbv_0038_job_step_time_system = cls(
            seconds=seconds,
            microseconds=microseconds,
        )

        dbv_0038_job_step_time_system.additional_properties = d
        return dbv_0038_job_step_time_system
