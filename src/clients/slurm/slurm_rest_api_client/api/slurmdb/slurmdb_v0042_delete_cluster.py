...
def _get_kwargs(
    cluster_name: str,
    *,
    classification: SlurmdbV0042DeleteClusterClassification | Unset = UNSET,
    cluster: str | Unset = UNSET,
    federation: str | Unset = UNSET,
    flags: SlurmdbV0042DeleteClusterFlags | Unset = UNSET,
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    response_default = V0042OpenapiClustersRemovedResp.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        cluster_name (str):
        classification (SlurmdbV0042DeleteClusterClassification | Unset):
        cluster (str | Unset):
        federation (str | Unset):
        flags (SlurmdbV0042DeleteClusterFlags | Unset):
        format_ (str | Unset):
...
def sync(
    ...
    *,
    ...
    with_deleted: str | Unset = UNSET,
    with_usage: str | Unset = UNSET,
) -> V0042OpenapiClustersRemovedResp | None:
    """Delete cluster
