...
def _get_kwargs(
    ...
    *,
    ...
    flags: SlurmV0042DeleteJobFlags | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> V0042OpenapiKillJobResp:
    if response.status_code == 200:
        response_200 = V0042OpenapiKillJobResp.from_dict(response.json())

        return response_200

    response_default = V0042OpenapiKillJobResp.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        job_id (str):
        signal (str | Unset):
        flags (SlurmV0042DeleteJobFlags | Unset):
