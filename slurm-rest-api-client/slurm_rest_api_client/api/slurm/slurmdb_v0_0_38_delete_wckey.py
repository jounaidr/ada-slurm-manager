...
from ...models.dbv_0038_response_wckey_delete import Dbv0038ResponseWckeyDelete
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": "/slurmdb/v0.0.38/wckey/{wckey}".format(
...
) -> Dbv0038ResponseWckeyDelete | list[Dbv0038Error]:
    if response.status_code == 200:
        response_200 = Dbv0038ResponseWckeyDelete.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Dbv0038ResponseWckeyDelete | list[Dbv0038Error]]:
    return Response(
...
def sync(
    ...
    *,
    client: AuthenticatedClient | Client,
) -> Dbv0038ResponseWckeyDelete | list[Dbv0038Error] | None:
    """Delete wckey
