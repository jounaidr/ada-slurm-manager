...
class V0043PartitionInfoMaximumsOversubscribe:
    ...
    Attributes:
        ...
        flags (list[V0043PartitionInfoMaximumsOversubscribeFlagsItem] | Unset): Flags applicable to the OverSubscribe
            setting
    """

    jobs: int | Unset = UNSET
    flags: list[V0043PartitionInfoMaximumsOversubscribeFlagsItem] | Unset = UNSET
