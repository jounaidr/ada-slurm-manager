...
class V0043QosLimitsMaxTresPer:
    """
    Attributes:
        account (list[V0043Tres] | Unset):
        job (list[V0043Tres] | Unset):
        node (list[V0043Tres] | Unset):
        user (list[V0043Tres] | Unset):
    """

    account: list[V0043Tres] | Unset = UNSET
    job: list[V0043Tres] | Unset = UNSET
    node: list[V0043Tres] | Unset = UNSET
    user: list[V0043Tres] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _account is not UNSET:
            account = []
            for componentsschemasv0_0_43_tres_list_item_data in _account:
        ...
        if _job is not UNSET:
            job = []
            for componentsschemasv0_0_43_tres_list_item_data in _job:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
        ...
        if _node is not UNSET:
            node = []
            for componentsschemasv0_0_43_tres_list_item_data in _node:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
        ...
        if _user is not UNSET:
            user = []
            for componentsschemasv0_0_43_tres_list_item_data in _user:
                componentsschemasv0_0_43_tres_list_item = V0043Tres.from_dict(
                    componentsschemasv0_0_43_tres_list_item_data
                )
